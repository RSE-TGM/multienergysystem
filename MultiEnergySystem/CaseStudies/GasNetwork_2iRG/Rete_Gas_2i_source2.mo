...
model Rete_Gas_2i_source2 "immissione 2"
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV sds16(
    n=nV,
    L=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.L,
    H=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.h,
    cm=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.cm,
    rhom=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.rhom,
    lambdam=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.lambdam,
    m_flow_start=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.m_flow_start,
    pin_start=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.pin_start,
    pout_start=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.pout_start,
    kappa=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.kappa,
    k=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.k,
    redeclare model Gas = Medium,
    X_start=X_start,
    Di=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds16.Di,
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV sds17(
    n=nV,
    L=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.L,
    H=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.h,
    cm=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.cm,
    rhom=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.rhom,
    lambdam=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.lambdam,
    m_flow_start=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.m_flow_start,
    pin_start=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.pin_start,
    pout_start=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.pout_start,
    kappa=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.kappa,
    k=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.k,
    redeclare model Gas = Medium,
    X_start=X_start,
    Di=CaseStudies.GasNetwork_2iRG.PipelineData_2i.sds17.Di,
    massFractionDynamicBalance=massFractionDynamicBalance,
    constantFrictionFactor=constantFrictionFactor,
    computeInertialTerm=computeInertialTerm,
    hctype=hctype,

...
model PaperCaseI_NG_H2_A
  ...
  extends H2GasFacility.Tests.SubSystem.PaperCaseI(
...
equation
  ...
  connect(H2_Production.y, sourceH2_A.in_m_flow0) annotation (Line(points={{
          -124,-60},{-119,-60},{-119,-25},{-110,-25},{-110,-35}}, color={0,0,
          127}));
  annotation (

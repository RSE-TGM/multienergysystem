...
//   end if;
  ...
  connect(wall.int, hotside.wall) annotation (Line(
      ...
      thickness=0.5));
  annotation (
    Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-60, -100}, {60, 100}}), graphics={Rectangle(lineColor = {140, 56, 54}, fillColor = {192, 80, 77}, fillPattern = FillPattern.Forward, lineThickness = 0.5, extent = {{-60, 100}, {60, -100}}, radius = 20), Text(textColor = {28, 108, 200}, extent = {{-60, -100}, {60, -140}}, textString = "%name"),                                                                                                                                                                                                 Line(origin={31.29,
              31.9},                                                                                                                                                                                                        points = {{8, 0}, {0, 0}}, color = {255, 49, 52}, pattern = LinePattern.Dash, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 18,
          rotation=90),                                                                                                                                                                                                        Line(origin = {30.22, -8.08}, rotation = 90, points={{-41.92,
              0.22},{-19.92,0.22},{-9.92,16.22},{6.08,-17.78},{24.08,16.22},{40.08,0.22},{60.08,0.22}},                                                                                                                                                                                                        color = {255, 49, 52}, pattern = LinePattern.Dash, arrow = {Arrow.Filled, Arrow.None}, arrowSize = 18,
          thickness=2),                                                                                                                                                                                                        Line(origin = {-29.78, -12.08}, rotation = 90, points={{-39.92,
              0.22},{-19.92,0.22},{-5.92,20.22},{10.08,-11.78},{28.08,20.22},{40.08,0.22},{62.08,0.22}},                                                                                                                                                                                                        color = {76, 0, 227}, pattern = LinePattern.Dash, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 18,
          thickness=2),                                                                                                                                                                                                        Line(origin={-30.73,50.36},
                                                                                                                                                                                                        points = {{8, 0}, {0, 0}}, color = {57, 0, 172}, pattern = LinePattern.Dash, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 18,
          rotation=-90),                                                                                                                                                                                Line(origin={-30.58,-47.45},
                                                                                                                                                                                                        points = {{8, 0}, {16, 0}}, color={57,0,172},      pattern = LinePattern.Dash, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 18,
          rotation=90),                                                                                                                                                                                                        Line(origin={28.22,37.92},      rotation=180,  points={{16.22,
              -0.08},{20.22,-0.08},{24.22,5.92},{28.22,-4.08},{32.22,5.92},{36.22,-0.08},{44.22,-0.08}},                                                                                                                                                                                                      color={0,0,0},                                    arrow = {Arrow.None, Arrow.Filled}, arrowSize = 7,
          thickness=0.8,
          smooth=Smooth.Bezier),                                                                                                                                                                                               Line(origin={28.22,-2.08},      rotation=180,  points={{16.22,
              -0.08},{20.22,-0.08},{24.22,5.92},{28.22,-4.08},{32.22,5.92},{36.22,-0.08},{44.22,-0.08}},                                                                                                                                                                                                      color={0,0,0},                                    arrow = {Arrow.None, Arrow.Filled}, arrowSize = 7,
          thickness=0.8,
          smooth=Smooth.Bezier),                                                                                                                                                                                               Line(origin={28.22,-40.08},     rotation=180,  points={{16.22,
              -0.08},{20.22,-0.08},{24.22,5.92},{28.22,-4.08},{32.22,5.92},{36.22,-0.08},{44.22,-0.08}},                                                                                                                                                                                                      color={0,0,0},                                    arrow = {Arrow.None, Arrow.Filled}, arrowSize = 7,
          thickness=0.8,
          smooth=Smooth.Bezier),                                                                                                                                                                                               Line(origin={28.22,17.92},      rotation=180,  points={{16.22,
              -0.08},{20.22,-0.08},{24.22,5.92},{28.22,-4.08},{32.22,5.92},{36.22,-0.08},{44.22,-0.08}},                                                                                                                                                                                                      color={0,0,0},                                    arrow = {Arrow.None, Arrow.Filled}, arrowSize = 7,
          thickness=0.8,
          smooth=Smooth.Bezier),                                                                                                                                                                                               Line(origin={28.22,-20.08},     rotation=180,  points={{16.22,
              -0.08},{20.22,-0.08},{24.22,5.92},{28.22,-4.08},{32.22,5.92},{36.22,-0.08},{44.22,-0.08}},                                                                                                                                                                                                      color={0,0,0},                                    arrow = {Arrow.None, Arrow.Filled}, arrowSize = 7,
          thickness=0.8,

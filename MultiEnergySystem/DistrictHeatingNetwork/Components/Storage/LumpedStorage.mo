...
model LumpedStorage "Model a perfectly mixed thermal storage with insulation all around. Output temperature in Celsius [°C]"
  ...
  Modelica.Units.SI.Density rho "Density of the fluid in the tank";
  ...
  annotation (
    Icon(graphics={  Rectangle(origin={76,-140},    fillColor={140,56,54},       fillPattern=
          ...
          textColor={140,56,54}),                                                                                                                                                                                                        Rectangle(                  lineColor={140,56,
              ...
              54},                                                                                                                                                                                                        fillColor = {255, 255, 255}, fillPattern = FillPattern.VerticalCylinder, extent = {{-100, 37}, {100, -37}}), Ellipse(origin={0,-101},   lineColor={140,56,

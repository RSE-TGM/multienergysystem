...
record Valve
  ...
  Real q_nom_inm3h(unit = "m3/h") "Nominal volumetric flowrate in m3/h ";
  Modelica.Units.SI.VolumeFlowRate q_nom = q_nom_inm3h/3600 "Nominal Volumetric flow rate at the inlet";

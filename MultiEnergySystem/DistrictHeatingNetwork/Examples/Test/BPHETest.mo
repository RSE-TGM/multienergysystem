...
model BPHETest 
  ...
  Sources.SourcePressure sourceCold_E301(T0 = BPHE.E301.Tin_start_cold, p0 = BPHE.E301.pin_start_cold, use_T = true) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceCold_E501(T0 = BPHE.E501.Tin_start_cold, p0 = BPHE.E501.pin_start_cold, use_T = true) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceHot_E301(T0 = BPHE.E301.Tin_start_hot, p0 = BPHE.E301.pin_start_hot, use_T = true) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceHot_E501(T0 = BPHE.E501.Tin_start_hot, p0 = BPHE.E501.pin_start_hot, use_T = true) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceCold_E601(T0 = BPHE.E601.Tin_start_cold, p0 = BPHE.E601.pin_start_cold, use_T = true) annotation(
    Placement(visible = true, transformation(origin = {30, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceHot_E601(T0 = BPHE.E601.Tin_start_hot, p0 = BPHE.E601.pin_start_hot, use_T = true) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceCold_E701(T0 = BPHE.E701.Tin_start_cold, p0 = BPHE.E701.pin_start_cold, use_T = true) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceHot_E701(T0 = BPHE.E701.Tin_start_hot, p0 = BPHE.E701.pin_start_hot, use_T = true) annotation(

...
model PumpTestBase "Base test model for pumps' tests"
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkPressure sinkP(T0=354.15,        p0 = Pump.P101.pout_start)                annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkPressure sinkPressure(T0 = Pump.P7.Tout_start, p0 = Pump.P7.pout_start)               annotation (
    Placement(visible = true, transformation(origin = {52, -48}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourcePressure(T0 = Pump.P7.Tin_start, p0 = Pump.P7.pin_start)               annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SourcePressure sourceP601(T0 = Pump.P601.Tin_start, p0 = Pump.P601.pin_start)               annotation (
    Placement(visible = true, transformation(origin = {-44, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkPressure sinkP601(T0 = Pump.P601.Tout_start, p0 = Pump.P601.pout_start)               annotation (
...
equation
  connect(P101.outlet, sinkP.inlet) annotation (
    Line(points={{14.6,61},{22,61},{22,62},{29.48,62},{29.48,74},{44,74}}));
  connect(sourceP.outlet, P101.inlet) annotation (
    Line(points={{-34,62},{-12.6,62},{-12.6,61}},    color = {136, 136, 136}));
  connect(sourcePressure.outlet, P7.inlet) annotation (
    Line(points={{-36,-60},{-26,-60},{-26,-61},{-14.6,-61}},        color = {136, 136, 136}));
  connect(P7.outlet, sinkPressure.inlet) annotation (
    Line(points={{12.6,-61},{20,-61},{20,-62},{27.48,-62},{27.48,-48},{42,-48}},
                                                     color = {136, 136, 136}));
  connect(sourceP601.outlet, P601.inlet) annotation (
    Line(points={{-34,0},{-24,0},{-24,-1},{-12.6,-1}},      color = {136, 136, 136}));
  connect(P601.outlet, sinkP601.inlet) annotation (
    Line(points={{14.6,-1},{22,-1},{22,-2},{29.48,-2},{29.48,12},{44,12}},
                                                  color = {136, 136, 136}));
  annotation (

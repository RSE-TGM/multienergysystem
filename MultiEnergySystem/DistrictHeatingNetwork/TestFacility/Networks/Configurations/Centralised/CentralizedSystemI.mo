...
partial model CentralizedSystemI
  ...
  Components.Valves.FlowCoefficientValve
    ...
    q_m3h_start=Pump.P101.qnom_inm3h)
        ...
        rotation=90,
        origin={-240,-140})));
  Components.Pipes.RoundPipe1DFV PL3_S101(
    L=L_S1_PL3,
    t=t_S1,
    pin_start=pout_start_S1,
    ...
    n=n)      annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-240,-230})));
  Components.Pipes.RoundPipe1DFV                                          PL2_S101(
    L=L_S1_PL2,
    t=t_S1,
    ...
    n=n)      annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-276,-232})));
  Components.Pipes.RoundPipe1DFV                                          PL4_S101(
    L=L_S1_PL3,
    t=t_S1,
    pin_start=pout_start_S1,
    Tin_start=Tout_start_S1,
    ...
    n=n)      annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-240,-106})));
  Components.ThermalMachines.ControlledGasBoiler
    GB101(
    Tin_start=Tin_start_S1,
    pin_start=pin_start_S1,
  ...
  Sensors.IdealAbsoluteTemperatureSensor
    TT101(T_start=Tin_start_S1, p_start=pin_start_S1)
      ...
      Placement(transformation(
        ...
        rotation=90,
        origin={-278,-94})));
  Sensors.IdealMassFlowSensor                                          FT101(T_start=
        Tin_start_S1, p_start=pin_start_S1)
    annotation (Placement(transformation(
        extent={{7,-7},{-7,7}},
        rotation=90,
        origin={-279,-195})));
  Components.Pipes.RoundPipe1DFV                                          PL1_S101(
    L=L_S1_PL1,
    t=t_S1,
    pin_start=pin_start_S1,
    Tin_start=Tin_start_S1,
    ...
    n=n)      annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-276,-160})));
  Components.Pipes.RoundPipe1DFV                                          PL_S100_rCD_hot(
    L=L_S1_rCD_hot,
    t=t_S1,
    pin_start=pout_start_S1,
    Tin_start=Tout_start_S1,
    ...
    n=n) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-240,-40})));
  Components.Pipes.RoundPipe1DFV                                          PL_S100_rCD_cold(
    L=L_S1_rCD_cold,
    t=t_S1,
    pin_start=pin_start_S1,
    Tin_start=Tin_start_S1,

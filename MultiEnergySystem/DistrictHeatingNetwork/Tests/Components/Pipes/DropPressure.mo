...
equation
  ...
  connect(wall_FixedT.MultiPort, pipe1.wall) annotation (
    Line(points={{-80,0},{-66,0},{-66,58},{0,58},{0,47.14}},         color = {255, 238, 44}));
  connect(wall_FixedT.MultiPort, pipe2.wall) annotation (
    Line(points={{-80,0},{-66,0},{-66,-30},{0,-30},{0,-32.86}},         color = {255, 238, 44}));
  connect(wall_FixedT.MultiPort, pipe3.wall) annotation (
    Line(points={{-80,0},{-66,0},{-66,-60},{0,-60},{0,-72.86}},         color = {255, 238, 44}));
  connect(pipe4.wall, pipe3.wall) annotation (
    Line(points={{48,-72.86},{48,-60},{0,-60},{0,-72.86}},    color = {255, 238, 44}));
  annotation (

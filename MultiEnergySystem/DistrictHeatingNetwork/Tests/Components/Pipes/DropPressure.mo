...
model DropPressure
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkPressure sinkL(p0(displayUnit = "Pa") = 3e5, use_T = true)  annotation(
    Placement(visible = true, transformation(origin = {40, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkPressure sinkNL(p0 (displayUnit = "Pa")= 3e5, use_T = true)  annotation(
    Placement(visible = true, transformation(origin = {40, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.round1DFV linearpipe(Di = Pipe.S100.Di, L = Pipe.S100.L, Tin_start = Pipe.S100.Tin_start, Tout_start = Pipe.S100.Tout_start, computeLinearPressureDrop = true, h = Pipe.S100.h, hin_start = Pipe.S100.hin_start, k = Pipe.S100.k, kc = 1, m_flow_start = Pipe.S100.m_flow_start, pin_start = Pipe.S100.pin_start, pout_start = Pipe.S100.pout_start, rho_nom = Pipe.S100.rho_nom, u_nom = Pipe.S100.u_nom)  annotation(
    Placement(visible = true, transformation(origin = {1.77636e-15, 28}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
  inner MultiEnergySystem.DistrictHeatingNetwork.System system annotation(
    Placement(visible = true, transformation(origin = {90, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.round1DFV nonlinearpipe(Di = Pipe.S100.Di, L = Pipe.S100.L, Tin_start = Pipe.S100.Tin_start, Tout_start = Pipe.S100.Tout_start, computeLinearPressureDrop = false, h = Pipe.S100.h, hin_start = Pipe.S100.hin_start, k = Pipe.S100.k, kc = 1, m_flow_start = Pipe.S100.m_flow_start, pin_start = Pipe.S100.pin_start, pout_start = Pipe.S100.pout_start, rho_nom = Pipe.S100.rho_nom, u_nom = Pipe.S100.u_nom) annotation(

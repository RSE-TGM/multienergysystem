...
model DropPressure
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkPressure sinkL(T = 75 + 273.15, p0(displayUnit = "Pa") = 300000, use_T = true) annotation(
    Placement(visible = true, transformation(origin = {40, 28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkPressure sinkNL(T = 75 + 273.15, p0(displayUnit = "Pa") = 300000, use_T = true) annotation(
    Placement(visible = true, transformation(origin = {40, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));

...
model E700Test "HX70X test with real data"
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.BrazedPlateHeatExchanger E701(redeclare model Medium = Medium, Di_cold = BPHE.E701.Di_cold, Di_hot = BPHE.E701.Di_hot, L_cold = BPHE.E701.L_cold, L_hot = BPHE.E701.L_hot, MWall = BPHE.E701.MWall, Stot_cold = BPHE.E701.Stot_cold, Stot_hot = BPHE.E701.Stot_hot, Tin_start_cold = BPHE.E701.Tin_start_cold, Tin_start_hot = BPHE.E701.Tin_start_hot, Tout_start_cold = BPHE.E701.Tout_start_cold, Tout_start_hot = BPHE.E701.Tout_start_hot, cpm_cold = BPHE.E701.cpm_cold, cpm_hot = BPHE.E701.cpm_hot, t_cold = BPHE.E701.t_cold, t_hot = BPHE.E701.t_hot, gamma_nom_cold = BPHE.E701.gamma_nom_cold, gamma_nom_hot = BPHE.E701.gamma_nom_hot, h_cold = BPHE.E701.h_cold, h_hot = BPHE.E701.h_hot, hin_start_cold = BPHE.E701.hin_start_cold, hin_start_hot = BPHE.E701.hin_start_hot, k_cold = BPHE.E701.k_cold, k_hot = BPHE.E701.k_hot, kc_cold = 1, kc_hot = 1, lambdam_cold = BPHE.E701.lambdam_cold, lambdam_hot = BPHE.E701.lambdam_hot, m_flow_start_cold = BPHE.E701.m_flow_start_cold, m_flow_start_hot = BPHE.E701.m_flow_start_hot, n = 9, nPipes_cold = BPHE.E701.nPipes_cold, nPipes_hot = BPHE.E701.nPipes_hot, nPlates = BPHE.E701.nPlates, pin_start_cold = BPHE.E701.pin_start_cold, pin_start_hot = BPHE.E701.pin_start_hot, pout_start_cold = BPHE.E701.pout_start_cold, pout_start_hot = BPHE.E701.pout_start_hot, rho_nom_cold = (BPHE.E701.rhoin_nom_cold + BPHE.E701.rhoout_nom_cold)/2, rho_nom_hot = (BPHE.E701.rhoin_nom_hot + BPHE.E701.rhoout_nom_hot)/2, rhom_cold(displayUnit = "kg/m3") = BPHE.E701.rhom_cold, rhom_hot(displayUnit = "g/cm3") = BPHE.E701.rhom_hot, thermalInertia = false, u_nom_cold = BPHE.E701.u_nom_cold, u_nom_hot = BPHE.E701.u_nom_hot) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCV701(redeclare model Medium = Medium, allowFlowReversal = system.allowFlowReversal, Kv = Valve.FCV701.Kv, dp_nom(displayUnit = "Pa") = Valve.FCV701.dp_nom, Tin_start(displayUnit = "K") = BPHE.E701.Tout_start_hot, pin_start = BPHE.E701.pout_start_hot, q_m3h_start = EX701_q_m3h_hot) annotation(
  ...
  Sources.SinkPressure sinkHot_ref(redeclare model Medium = Medium, T0 = BPHE.E701.Tout_start_hot, p0 = BPHE.E701.pout_start_hot, use_in_p0 = false, use_in_T0 = true) annotation(
...
protected
  ...
  final parameter Real m_flow703[dim[1], dim[2]] = FT703*995/3600;
equation
  // Variables
  Tout_hot_ref = sinkHot_ref.fluid.T;
  Tout_cold_ref = sinkCold_ref.fluid.T;
  deltaThot = E701.Tout_hot - Tout_hot_ref;
  deltaTcold = E701.Tout_cold - Tout_cold_ref;
  
  // Connections
  connect(sourceCold_mflow.outlet, E701.incold) annotation(
    Line(points = {{-50, -42}, {-31, -42}, {-31, -32}, {-10, -32}}, color = {140, 56, 54}));
  connect(sourceHot_mflow.outlet, E701.inhot) annotation(
    Line(points = {{50, 28}, {34, 28}, {34, 31}, {6, 31}}, color = {140, 56, 54}));
  ...
  connect(E701.outhot, FCV701.inlet) annotation(
    Line(points = {{6, -32}, {25.5, -32}, {25.5, -40}, {40, -40}}, color = {140, 56, 54}));
  ...
  connect(E701.outcold, sinkCold_p.inlet) annotation(
    Line(points = {{-10, 31}, {-36.25, 31}, {-36.25, 28}, {-50, 28}}, color = {140, 56, 54}));
  ...
  connect(outcold_Tref.y, sinkCold_ref.in_T0) annotation(
    Line(points = {{-28, 90}, {-20, 90}, {-20, 80}}, color = {0, 0, 127}));
  connect(outhot_Tref.y, sinkHot_ref.in_T0) annotation(
    Line(points = {{30, 90}, {20, 90}, {20, 80}}, color = {0, 0, 127}));
  annotation(

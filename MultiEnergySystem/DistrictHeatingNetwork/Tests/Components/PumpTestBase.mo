...
model PumpTestBase "Base test model for pumps' tests"
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.TurboMachines.PrescribedPump P101(Tin_start = Pump.P101.Tin_start, Tout_start = Pump.P101.Tout_start, a = Pump.P101.a, b = Pump.P101.b, dpnom = Pump.P101.dpnom, etaelec = Pump.P101.etaelec, etamech = Pump.P101.etamech, etanom = Pump.P101.etanom, hin_start = Pump.P101.hin_start, m_flow_nom = Pump.P101.m_flow_nom, omeganom = Pump.P101.omeganom, pin_start = Pump.P101.pin_start, pout_start = Pump.P101.pout_start, qnom_inm3h = 15.60340167, rhonom(displayUnit = "kg/m3") = Pump.P101.rhonom, use_in_omega = true) annotation(
  ...
  Modelica.Blocks.Sources.Ramp theta_FCV101(duration = 20, height = 0, offset = 1, startTime = 30) annotation(
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sources.SinkMassFlow sink_P101(T0 = 85 + 273.15, m_flow0 = 4, p0(displayUnit = "Pa") = 4e5, pin_start(displayUnit = "Pa") = 4e5, use_in_m_flow = true)  annotation(
...
equation
  ...
  connect(FCV101.outlet, sink_P101.inlet) annotation(
    Line(points = {{38, 30}, {70, 30}}, color = {140, 56, 54}));
  connect(m_flow_set.y, sink_P101.in_m_flow) annotation(

...
partial model TestBase
  ...
  parameter Types.Length h = 0.0 "Height, positive if outlet is higher than inlet. = 0 ports at same hight";
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve cvalve(redeclare
    ...
    openingChar=MultiEnergySystem.DistrictHeatingNetwork.Components.Types.valveOpeningChar.SquareRoot)                                                                                                      annotation (
...
equation
  connect(inp.y, sourceP.in_p0) annotation (
    Line(points={{-83.6,20},{-74,20},{-74,8.4}},          color = {0, 0, 127}));
  connect(outp.y, sinkP.in_p0) annotation (
    Line(points={{85.6,20},{66,20},{66,8.4}},    color = {0, 0, 127}));

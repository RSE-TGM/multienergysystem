...
model BaseHeatingandCoolingSystem
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV
    ...
    Di=Di_S9)      annotation (Placement(transformation(
        ...
        rotation=0,
        origin={10,200})));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL2L3_hot_HX701(
    L=L_Users,
    t=t_Users,
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV
    ...
    Di=Di_Users)    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={80,200})));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL2L3_cold_HX701(
    L=L_Users,
    t=t_Users,
    m_flow_start=m_flow_start_Users,
  ...
  Modelica.Blocks.Sources.Ramp FCVC02_theta(
    ...
    offset=1,
    startTime=200)
    annotation (Placement(transformation(extent={{451,210},{431,230}})));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientVale
    FCVC01(
    allowFlowReversal=system.allowFlowReversal,
    Kv=Kv_FCVC01,
  ...
  Modelica.Blocks.Continuous.FirstOrder FCVC02_firstOrder(
    ...
    y_start=1)
    annotation (Placement(transformation(extent={{418,210},{398,230}})));
equation
  ...
  connect(FCV731.inlet, EX731.outhot) annotation (Line(
      ...
      color={140,56,54},
      thickness=0.5));
  connect(rackL2L3_cold_HX701.outlet, roundPipe1DFV20.inlet) annotation (Line(
  ...
  connect(roundPipe1DFV40.inlet, roundPipe1DFV39.outlet) annotation (Line(
      ...
      color={140,56,54},
      thickness=0.5));
  connect(rackL2L3_hot_HX701.outlet, EX701.inhot) annotation (Line(
  ...
  connect(roundPipe1DFV35.outlet, EX731.inhot) annotation (Line(
      ...
      color={140,56,54},
      thickness=0.5));
  connect(rackL2L3_hot_HX701.inlet, roundPipe1DFV11.inlet) annotation (Line(
  ...
  connect(roundPipe1DFV33.outlet, roundPipe1DFV35.inlet) annotation (Line(
      ...
      color={140,56,54},
      thickness=0.5));
  connect(rackL2L3_cold_HX701.inlet, FCV701.outlet) annotation (Line(
  ...
  connect(FCVC02_theta.y, FCVC02_firstOrder.u)
    annotation (Line(points={{430,220},{420,220}}, color={0,0,127}));
  connect(FCVC02_firstOrder.y, FCVC02.opening)
    annotation (Line(points={{397,220},{388,220}}, color={0,0,127}));
  annotation (
...
end BaseHeatingandCoolingSystem;

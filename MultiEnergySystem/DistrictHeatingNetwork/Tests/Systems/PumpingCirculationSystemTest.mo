...
model PumpingCirculationSystemTest "Test with real data"
  ...
  Modelica.Blocks.Sources.TimeTable TT902_profile(table=[t,TT_902])
    annotation (Placement(transformation(extent={{-60,-70},{-40,-50}})));
  Modelica.Blocks.Sources.TimeTable PT202_profile(table=[t,PT_202])
    annotation (Placement(transformation(extent={{-60,-100},{-40,-80}})));
  Modelica.Blocks.Sources.TimeTable PT902_profile(table=[t,PT_902])

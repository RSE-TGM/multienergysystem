...
model PlugFlowCore
  ...
  replaceable model Medium =
      H2GasFacility.Media.RealGases.NG6_H2_Papay_ND  constrainedby
      H2GasFacility.Media.BaseClasses.PartialMixture  "Medium model" annotation (
...
// Parameter declaration
  ...
  //H2GasFacility.Types.VolumeFlowRate q = inlet.m_flow / rho_nom "Volume flow rate at inflowing port (positive when flow from port_a to port_b)";

...
model IdealYSensor "Ideal Mass Fraction composition sensor"
  extends
  ...
  parameter Integer element=1;

  parameter Types.MassFlowRate m_flow_start "Start value for mass flow rate" annotation (
    Dialog(group = "Initialisation"));

  Modelica.Blocks.Interfaces.RealOutput Y_meas "Measured Specific Gravity"

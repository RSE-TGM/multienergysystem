...
model SinkMassFlow
  ...
  //Nominal Values
  parameter Types.Pressure pin_start = 8e6
    "Pressure start value of outgoing fluid";
  parameter Types.Pressure p0 = 1e5 
    "Pressure start value of outgoing fluid DIFFERENCE";
  ...
  parameter Types.MassFraction[fluid.nX] X0
  ...
  parameter Boolean use_in_X0 = false 
    "Use connector input for the composition" annotation (

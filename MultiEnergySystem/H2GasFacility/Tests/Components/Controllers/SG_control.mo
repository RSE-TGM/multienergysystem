...
model SG_control "PID with dead zone"
...
equation
  ...
  connect(p_in.y, sinkPressure.in_p0) annotation (Line(points={{-78,-28},{-74,
          -28},{-74,2},{-78,2},{-78,7.6}},
                       color={0,0,127}));
  connect(s1.inlet, idealSGSensor.outlet) annotation (Line(
      points={{-24,16},{-12,16}},
      color={182,109,49},
      thickness=0.5));
  connect(idealSGSensor.inlet, valveLinearOpening.outlet) annotation (Line(
      points={{8,16},{24,16},{24,2},{34,2}},
      color={182,109,49},
      thickness=0.5));
  connect(p_ref.y, aWPIDContinuous.REF) annotation (Line(points={{-16,-22},{-2,
          -22},{-2,-14},{8,-14}}, color={0,0,127}));
  connect(idealSGSensor.SG_meas, aWPIDContinuous.FeedBack) annotation (Line(
        points={{-5.8,23.4},{-10,23.4},{-10,-28},{8,-28},{8,-22}}, color={0,0,
          127}));

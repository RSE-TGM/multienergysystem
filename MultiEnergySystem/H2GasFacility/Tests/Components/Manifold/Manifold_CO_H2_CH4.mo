...
model Manifold_CO_H2_CH4
  extends MultiEnergySystem.H2GasFacility.Tests.Components.Manifold.TestGManifold(
    ...
    source1.X0 = {0.15, 0.25, 0.6},
    source1.T0 = 20 + 273.15,
    source1.p0 = 6e5,
    source1.use_in_T0 = true,
    source1.use_in_X0 = true,
    valve1.X_start = {0.15, 0.25, 0.6}, 
    valve1.A_v = 4.877657e-3,
    valve1.dp_nom = 1e5,
    valve1.pin_start = 6e5,
    source2.X0 = {0.2, 0.2, 0.6},
    source2.T0 = 25 + 273.15,
    source2.p0 = 6e5,
    valve2.X_start = {0.2, 0.2, 0.6},
    valve2.A_v = 4.877657e-3,
    valve2.dp_nom = 1e5,
    valve2.pin_start = 6e5,
    ...
    valveout.X_start = {0.1, 0.4, 0.5},
    valveout.A_v = 4.877657e-3,
    valveout.dp_nom = 1e5,
    valveout.pin_start = 5e5,
    sink.X0 = {0.1, 0.4, 0.5},
    sink.p0 = 4e5,
    opening1.height = 0,
    opening2.height = 0,

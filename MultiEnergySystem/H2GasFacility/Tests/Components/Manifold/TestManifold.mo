...
model TestManifold
  ...
  replaceable MultiEnergySystem.H2GasFacility.Components.Manifold.Manifold2I1O manifold(
    redeclare model MediumIn1 = MediumIn1,
    redeclare model MediumIn2 = MediumIn2,
    redeclare model MediumOut = MediumOut, Xout_start = {0.5, 0.5}, p_start(displayUnit = "Pa") = 49999.99999999999) annotation(
    Placement(visible = true, transformation(origin = {0, 0}, extent = {{-30, -30}, {30, 30}}, rotation = -90)));
  MultiEnergySystem.H2GasFacility.Sources.SourceMassFlow source1(G = 0,redeclare model Medium = MediumIn1, T0 = 15 + 273.15, X0 = {1}, m_flow0 = 0.02, p0(displayUnit = "Pa") = 49999.99999999999) annotation(
    Placement(visible = true, transformation(origin = {12, 60}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  MultiEnergySystem.H2GasFacility.Sources.SourceMassFlow source2(G = 0,redeclare model Medium = MediumIn2, T0 = 15 + 273.15, X0 = {1}, m_flow0 = 0.05, p0(displayUnit = "Pa") = 49999.99999999999) annotation(
    Placement(visible = true, transformation(origin = {-12, 60}, extent = {{10, -10}, {-10, 10}}, rotation = 90)));

...
model TestManifold
  ...
  replaceable MultiEnergySystem.H2GasFacility.Components.Manifold.Manifold2I1O manifold(redeclare model MediumIn1 = MediumIn1, redeclare model MediumIn2 = MediumIn2, redeclare model MediumOut = MediumOut, Xout_start = {0.5, 0.5}, p_start(displayUnit = "Pa") = 49999.99999999999) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Valves.ValveLinearOpening valve2(redeclare model Medium = MediumIn2, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = {1}, dp_nom(displayUnit = "Pa") = 369.9, pin_start(displayUnit = "Pa") = 49999.99999999999) annotation(
    Placement(visible = true, transformation(origin = {-12, 50}, extent = {{-10, 10}, {10, -10}}, rotation = -90)));
  MultiEnergySystem.H2GasFacility.Components.Valves.ValveLinearOpening valve1(redeclare model Medium = MediumIn1, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = {1}, dp_nom(displayUnit = "Pa") = 369.9, pin_start(displayUnit = "Pa") = 49999.99999999999) annotation(
    Placement(visible = true, transformation(origin = {12, 50}, extent = {{10, 10}, {-10, -10}}, rotation = 90)));
  ...
  Modelica.Blocks.Sources.Ramp opening2(duration = 0, height = -0.5, offset = 1, startTime = 100) annotation(
    Placement(visible = true, transformation(origin = {50, 50}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Valves.ValveLinearOpening valveout(redeclare model Medium = MediumOut, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = {0.5, 0.5}, dp_nom(displayUnit = "Pa") = 369.9, pin_start(displayUnit = "Pa") = 49999.99999999999) annotation(

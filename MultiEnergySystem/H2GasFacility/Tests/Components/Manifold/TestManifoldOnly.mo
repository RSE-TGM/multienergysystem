...
model TestManifoldOnly
  ...
  replaceable model MediumIn1 = H2GasFacility.Media.IdealGases.CO_H2_CH4 constrainedby
    H2GasFacility.Media.BaseClasses.PartialMixture;
  replaceable model MediumIn2 = H2GasFacility.Media.IdealGases.CO_H2_CH4 constrainedby
    H2GasFacility.Media.BaseClasses.PartialMixture;
  ...
  MultiEnergySystem.H2GasFacility.Components.Valves.ValveLinearOpening valveout(A_v = A_v, K_v = 0.00003500, redeclare model
            Medium =                                                                                                                  MediumOut, PressureDropLinear = false, Tin_start = 22 + 273, Tout_start = 22 + 273, X_start = {0.15, 0.25, 0.6}, dp_nom( displayUnit = "Pa")= 99999.99999999999, pin_start( displayUnit = "Pa")= 499999.9999999999) annotation (

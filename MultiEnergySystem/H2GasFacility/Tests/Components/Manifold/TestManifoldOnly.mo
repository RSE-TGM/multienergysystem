...
model TestManifoldOnly
  ...
  replaceable MultiEnergySystem.H2GasFacility.Components.Manifold.GManifold2I1O manifold(redeclare model MediumIn1 = MediumIn1, redeclare model MediumIn2 = MediumIn2, redeclare model MediumOut = MediumOut, Tin_start1(displayUnit = "K") = 293, Tin_start2(displayUnit = "K") = 298, Tout_start(displayUnit = "K") = 295, V = 0.15708, Xin_start1 = {0.15, 0.25, 0.6}, Xin_start2 = {0.2, 0.2, 0.6}, Xout_start = {0.15, 0.25, 0.6}, noInitialPressure = false, p_start(displayUnit = "Pa") = 499999.9999999999) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Valves.ValveLinearOpening valveout(A_v = A_v, K_v = 0.00003500, redeclare model Medium = MediumOut, PressureDropLinear = false, Tin_start = 22 + 273, Tout_start = 22 + 273, X_start = {0.15, 0.25, 0.6}, dp_nom (displayUnit = "Pa")= 99999.99999999999, pin_start (displayUnit = "Pa")= 499999.9999999999) annotation(

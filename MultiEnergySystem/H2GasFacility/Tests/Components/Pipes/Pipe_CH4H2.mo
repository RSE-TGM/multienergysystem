...
model Pipe_CH4H2
  extends Components.Pipes.TestSinglePipe_A(
    ...
    p_in.height = 0.5e5*0.05, p_in.offset = 0.5e5, sourceP.p0.displayUnit = "Pa", sink.T0 = 15 + 273.15, sink.p0 = Pipe.pipe1.pout_start, sink.pin_start = Pipe.pipe1.pout_start, sourceP.T0 = 15 + 273.15, sink.G = 0, T_in.duration = 10, m_flow.duration = 10);
equation
  annotation(

...
model Test3Pipes
  ...
  parameter Types.MassFraction Xref[:] = {0.972, 0.018, 0.003, 0.001, 0.001, 0.005, 0}; //Initial mass composition
  parameter Types.MassFlowRate m_flow_start = 0.1 "Initial mass flowrate";
  parameter Integer n = 9 "Number of volumes in the pipe";
  parameter Types.Pressure pin_start = 1.5e5 "Initial pressure";
  parameter Types.Temperature Tin_start = 15+273 "Initial temperature";
  parameter Types.Length kappa = 0.045e-3; //Pipe roughness
  ...
  H2GasFacility.Sources.SourcePressure sourceP(redeclare model Medium =
        MediumBoundaries,                                                                 T0(displayUnit = "K") = 293.15, X0 = Xref, p0 = pin_start,
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe2(Di = Pipe.pipe1.Di, L = Pipe.pipe1.L, redeclare
      model Medium =
        MediumPipes,                                                                                                                           Tin_start = Pipe.pipe1.Tin_start, Tout_start = Pipe.pipe1.Tout_start,
    X_start=Xref,                                                                                                                                                                                                        hin_start = Pipe.pipe1.hin_start, k = Pipe.pipe1.k, kappa = kappa, kc = 1, m_flow_start = Pipe.pipe1.m_flow_start,                      n = n, pin_start = Pipe.pipe1.pin_start, pout_start = Pipe.pipe1.pout_start, rho_nom = Pipe.pipe1.rho_nom,
  ...
  MultiEnergySystem.H2GasFacility.Sources.SourcePressure sourceP1(redeclare
      model Medium =
        MediumBoundaries,
    R=1e-3,                                                                                                         T0(displayUnit = "K") = 293.15,
    X0=Xref,                                                                                                                                                     p0 = pin_start, use_in_T0 = true, use_in_p0 = true) annotation (
  ...
  Modelica.Blocks.Sources.Ramp p_in3(duration = 50,
    height=0*0.5e5,                                                 offset = pin_start, startTime = 150) annotation (

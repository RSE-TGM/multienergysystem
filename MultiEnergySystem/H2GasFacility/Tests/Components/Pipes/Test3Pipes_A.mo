...
model Test3Pipes_A "Base test model of a two pipes (Flow1DFV) in series with a pressure source & mass flowrate sink"
  ...
  H2GasFacility.Sources.SinkMassFlow sink(redeclare model Medium = Medium, G = 0, T0 = 288.15, X0 = Xref, m_flow0 = m_flow_start, p0 = 48000, pin_start = 48000, use_in_m_flow0 = true) annotation(
  ...
  Modelica.Blocks.Sources.Ramp m_flow(duration = 0, height = -m_flow_start*2.5, offset = m_flow_start, startTime = 50) annotation(
...
equation
  ...
  annotation(
    experiment(StopTime = 250, Interval = 0.0350042, Tolerance = 1e-07, StartTime = 0));
end Test3Pipes_A;

...
model TestSinglePipe_A
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV roundPipe(redeclare model Medium = Medium, Di = 0.02, L = 50, Tin_start = 20 + 273.15, Tout_start = 20 + 273.15, X_start = Xref, cf = 0.006, hin_start = -4.27208e6, k = 3341, kc = 1, m_flow_start = 0.26666, n = 7, pin_start = 75e2, pout_start = 66.09e2, rho_nom = 0.05521, u_nom = 17.82146) annotation(
  ...
  H2GasFacility.Sources.SinkMassFlow sink(redeclare model Medium = Medium(v_start = 0.319373), G = 0, T0 = 20 + 273.15, X0 = Xref, m_flow0 = 0.2666, p0 = 66.09e2, pin_start = 66.09e2, use_in_m_flow0 = true) annotation(
    Placement(visible = true, transformation(origin = {52, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  inner MultiEnergySystem.System system annotation(
    Placement(visible = true, transformation(origin = {90, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Ramp m_flow(duration = 0, height = 0.2666*0.2, offset = 0.2666, startTime = 50) annotation(
...
equation
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 350, Tolerance = 1e-06, Interval = 0.035));

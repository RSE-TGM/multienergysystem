...
model TestSinglePipe_A
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV roundPipe(redeclare model Medium = Medium, Di = 0.02, L = 50, Tin_start = 20 + 273.15, Tout_start = 20 + 273.15, X_start = Xref, cf = 0.1, hin_start = -4.27208e6, k = 44500, kc = 1, m_flow_start = m_flow_ref, n = 7, pin_start = 75e2, pout_start = 66.09e2, rho_nom = 0.05521, u_nom = 17.82146) annotation(

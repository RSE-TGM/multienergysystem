...
model Test_H2_injection_manifold
  ...
  Modelica.Blocks.Sources.Ramp pin(
    ...
    startTime=50) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  MultiEnergySystem.H2GasFacility.Components.Manifold.GManifold2I1O
    gManifold2I1O(
    replaceable model MediumIn1 =
      MultiEnergySystem.H2GasFacility.Media.IdealGases.NG6_H2 constrainedby
      MultiEnergySystem.H2GasFacility.Media.BaseClasses.PartialMixture,
    replaceable model MediumIn2 =
      MultiEnergySystem.H2GasFacility.Media.IdealGases.NG6_H2 constrainedby
      MultiEnergySystem.H2GasFacility.Media.BaseClasses.PartialMixture,
    replaceable model MediumOut =
      MultiEnergySystem.H2GasFacility.Media.IdealGases.NG6_H2 constrainedby
      MultiEnergySystem.H2GasFacility.Media.BaseClasses.PartialMixture,
    p_start=Pipe.pipe1.pin_start,
    Tin_start1=Pipe.pipe1.Tin_start,
    Tin_start2=Pipe.pipe1.Tin_start,
...
equation
  ...
  connect(pipe1.outlet, gManifold2I1O.inlet1) annotation (Line(
      points={{-16,8},{-12,8},{-12,10},{-2,10}},
      color={182,109,49},
      thickness=0.5));
  connect(sourceMassFlow1.outlet, gManifold2I1O.inlet2) annotation (Line(
      points={{-42,-72},{-2,-72},{-2,2}},
      color={182,109,49},
      thickness=0.5));
  connect(gManifold2I1O.outlet, pipe2.inlet) annotation (Line(
      points={{14,6},{14,24},{24,24}},
      color={182,109,49},
      thickness=0.5));
  connect(gManifold2I1O.outlet, pipe3.inlet) annotation (Line(
      points={{14,6},{20,6},{20,-6},{24,-6}},
      color={182,109,49},
      thickness=0.5));
...
end Test_H2_injection_manifold;

...
model TestManifold
  ...
  MultiEnergySystem.H2GasFacility.Components.Valves.ValveLinearOpening valve1(A_v = 4.877657e-3, redeclare model Medium = MediumIn1, Tin_start(displayUnit = "K") = 293, Tout_start(displayUnit = "K") = 293, X_start = {0.15, 0.25, 0.6}, dp_nom(displayUnit = "Pa") = 99999.99999999999, pin_start(displayUnit = "Pa") = 49999.99999999999) annotation(

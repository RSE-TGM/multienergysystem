...
model Comparison2FluidVariableP
  ...
  Medium idealGas(T_start = T, p_start = p_min, X_start = X_ref);
...
equation
  ...
  dh_id = Medium_Modelica.specificEnthalpy(Medium_Modelica.setState_pTX(p_min, T, X_ref)) - Medium_Modelica.specificEnthalpy(Medium_Modelica.setState_pTX(p_max, T, X_ref));

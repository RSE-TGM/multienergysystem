...
model TestSourceFlowOnly
  ...
  H2GasFacility.Sources.SourceMassFlow sourceFlow(redeclare model Medium = Medium, G = 1000, X0 = {97.201, 1.862, 0.393, 0, 0, 0, 0.544}/100, computeEnthalpyWithFixedPressure = true) annotation (

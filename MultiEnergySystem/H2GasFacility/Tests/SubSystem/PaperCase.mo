...
<p>This partial model is taken as reference structure and it is extended in the next examples.</p>
  ...
  model PaperCaseI_CH4
    "Extended PaperCaseI with pure CH4 and without H2 injection across the net for S.S. validation"
    extends PaperCase.PaperCaseI(
...
<li>The steady-state validation assumes no transient effects or energy demand.</li>
  ...
  model PaperCaseI_A
    "Same as PaperCaseI with injection of pure hydrogen in node 3"
    extends PaperCase.PaperCaseI(
      m_flow_H2_ref = 0.005,
      useEnergyDemand = false,
...
<li>The system operates dynamically.</li>
  ...
  model PaperCaseI_B
    "Same as PaperCaseI with injection of pure hydrogen in node 7"
    extends PaperCase.PaperCaseI(
      useEnergyDemand = false,
...
<p>Not working: the problem is structurally singular. </p>
  ...
  model PaperCaseI_C
    "Same as PaperCaseI with injection of pure hydrogen in node 9"
    extends PaperCase.PaperCaseI(
      useEnergyDemand = false,
...
<p><span style=\"font-family: Segoe UI;\">No injection. </span></p>
  ...
  model PaperCaseI_Demand_A
    extends PaperCase.PaperCaseI_Demand(
                              useEnergyDemand = false, sourceH2_A(G=0, computeEnthalpyWithFixedPressure=false), m_flow_H2_ref = 0.00129827,
      m_flow_H2(
        duration=0,
        offset=0,
        startTime=3*3600),
...
<p><span style=\"font-family: Arial;\">WI results are the same ad PaperCaseI --&gt; Ok.</span></p>
  ...
  equation
    connect(sourceH2_A.outlet, pipe17.inlet) annotation (Line(
        points={{-94,-40},{-100,-40},{-100,-102},{6,-102},{6,0},{45,0}},
        color={182,109,49},
        thickness=0.5));
...
<p>WI results are the same ad PaperCaseI --&gt; Ok.</p>
  ...
  model PaperCaseI_Demand_D
    extends PaperCase.PaperCaseI_Demand_A(
                                sourceP1(use_in_X0=true), X_start = H2GasFacility.Data.MassMolFractionData.NG_Cheli.X,
  ...
  model PaperCaseI_EnergyDemand_A
    extends PaperCase.PaperCaseI_EnergyDemand(
                                    sourceH2_A(G=0, computeEnthalpyWithFixedPressure=false), m_flow_H2_ref = 0.00129827,
      m_flow_H2(
        duration=0,
        offset=0,
        startTime=3*3600));
  equation
    connect(sourceH2_A.outlet, pipe7.inlet) annotation (Line(
        points={{-94,-40},{-100,-40},{-100,-40},{-94,-40},{-94,-60},{-66,-60},{
            -66,-6},{-20,-6},{-20,-10}},
        color={182,109,49},
        thickness=0.5));
    annotation (experiment(
  ...
  equation
    connect(sourceH2_A.outlet, pipe9.inlet) annotation (Line(
        points={{-94,-40},{-102,-40},{-102,-106},{-88,-106},{-88,-98},{10,-98},{
            10,0},{30,0},{30,10}},
        color={182,109,49},
        thickness=0.5));
    annotation (experiment(

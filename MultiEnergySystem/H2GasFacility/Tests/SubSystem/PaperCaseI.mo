...
constantFrictionFactor=constantFrictionFactor)                                                                                                                                                                                                         annotation (
  ...
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user5(redeclare
      model                                                                        Medium = Medium, X0 = X_start, m_flow0 = 0.03493965, massflowratedemand = [0, 0.03493965; 0.5*3600, 0.03493965; 1*3600, 1*0.03493965; 6*3600, 1*0.03493965], useEnergyDemand = useEnergyDemand) annotation (

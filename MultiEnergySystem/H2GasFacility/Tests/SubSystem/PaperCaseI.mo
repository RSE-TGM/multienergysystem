...
model PaperCaseI
  ...
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user4(redeclare
      model                                                                        Medium = Medium, X0 = X_start, m_flow0 = 0.044645108, userdemand = [0, 0.044645108; 0.5*3600, 0.044645108; 1*3600, 0.4*0.044645108; 6*3600, 0.4*0.044645108]) annotation (
    Placement(visible = true, transformation(origin = {20, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user5(redeclare
      model                                                                        Medium = Medium, X0 = X_start, m_flow0 = 0.03493965, userdemand = [0, 0.03493965; 0.5*3600, 0.03493965; 1*3600, 1*0.03493965; 6*3600, 1*0.03493965]) annotation (
    Placement(visible = true, transformation(origin = {-80, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user10(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.040762925, userdemand = [0, 0.040762925; 0.5*3600, 0.040762925; 1*3600, 1*0.040762925; 6*3600, 1*0.040762925]) annotation (
    Placement(visible = true, transformation(origin = {-80, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user11(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.009705458) annotation (
    Placement(visible = true, transformation(origin = {80, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user12(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.014558188) annotation (
  ...
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user13(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.006793821) annotation (
  ...
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user14(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.008734913) annotation (
    Placement(visible = true, transformation(origin = {80, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user15(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.017469825, userdemand = [0, 0.017469825; 0.5*3600, 0.017469825; 1*3600, 1*0.017469825; 6*3600, 1*0.017469825]) annotation (
    Placement(visible = true, transformation(origin = {80, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user16(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.012723856) annotation (
    Placement(visible = true, transformation(origin = {-30, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Users.IdealUser user17(redeclare
      model                                                                         Medium = Medium, X0 = X_start, m_flow0 = 0.010676004) annotation (
  ...
  MultiEnergySystem.H2GasFacility.Sources.SourceMassFlow sourceH2_A(redeclare
      model                                                                         Medium = Medium, G = 1000, T0 = 15 + 273.15, X0 = X_start_H2, computeEnthalpyWithFixedPressure = true, m_flow0 = m_flow_H2_ref, p0 = 0.5e5, use_in_m_flow0 = true) annotation (

...
model PaperCaseII
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe14(Di = 0.08, L = 200, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.000529, k_linear = 11782.0324, kc = 1, m_flow_start = 0.006111, n = n, pin_start(displayUnit = "Pa") = 2414, pout_start(displayUnit = "Pa") = 2342, rho_nom = 0.016751808, u_nom = 1.701679) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe11(Di = 0.08, L = 780, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.0009843, k_linear = 40509.01379, kc = 1, m_flow_start = 0.004715, n = n, pin_start(displayUnit = "Pa") = 3930, pout_start(displayUnit = "Pa") = 3739, rho_nom = 0.02727200, u_nom = 1.29598, momentum = momentum) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe1(Di = 0.16, L = 50, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.0013676, k_linear = 3341.245823, kc = 1, m_flow_start = 0.266667, n = n, pin_start(displayUnit = "Pa") = 7499.999999999999, pout_start(displayUnit = "Pa") = 6608.999999999999, rho_nom = 0.0520458, u_nom = 17.757623) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe2(Di = 0.16, L = 500, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.0011957, k_linear = 15533.71641, kc = 1, m_flow_start = 0.124954, n = n, pin_start(displayUnit = "Pa") = 6608.999999999999, pout_start(displayUnit = "Pa") = 4668, rho_nom = 0.045862759, u_nom = 8.380916) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe3(Di = 0.11, L = 500, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.0013452, k_linear = 41747.55164, kc = 1, m_flow_start = 0.045847, n = n, pin_start(displayUnit = "Pa") = 6608.999999999999, pout_start(displayUnit = "Pa") = 4694.999999999999, rho_nom = 0.045862759, u_nom = 6.505865) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe4(Di = 0.11, L = 500, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.0013330, k_linear = 47153.38245, kc = 1, m_flow_start = 0.052255, n = n, pin_start(displayUnit = "Pa") = 6608.999999999999, pout_start(displayUnit = "Pa") = 4694.999999999999, rho_nom = 0.045862759, u_nom = 7.573584) annotation(
    Placement(visible = true, transformation(origin = {-110, 60}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe8(Di = 0.08, L = 600, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.0009843, k_linear = 43715.06378, kc = 1, m_flow_start = 0.006977, n = n, pin_start(displayUnit = "Pa") = 4145, pout_start(displayUnit = "Pa") = 3840, rho_nom = 0.028763979, u_nom = 1.911895) annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV pipe6(Di = 0.11, L = 600, redeclare model Medium = Medium, Tin_start = 15 + 273.15, Tout_start = 15 + 273.15, X_start = X_start, hin_start = -4.38097e6, k = 0.0009427, k_linear = 28286.69989, kc = 1, m_flow_start = 0.02609, n = n, pin_start(displayUnit = "Pa") = 4668, pout_start(displayUnit = "Pa") = 3930, rho_nom = 0.032393306, u_nom = 3.763901) annotation(

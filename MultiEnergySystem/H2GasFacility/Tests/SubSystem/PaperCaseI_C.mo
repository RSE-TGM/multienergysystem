...
equation
  connect(sourceH2_A.outlet, pipe14.inlet) annotation (Line(
      points={{-104,-42},{-100,-42},{-100,-100},{20,-100},{20,-40},{40,-40}},
      color={182,109,49},
      thickness=0.5));
  connect(m_flow_H2.y, sourceH2_A.in_m_flow0) annotation (Line(points={{-129,-28},{-124,
          -28},{-124,-26},{-120,-26},{-120,-37}}, color={0,0,127}));
  annotation (

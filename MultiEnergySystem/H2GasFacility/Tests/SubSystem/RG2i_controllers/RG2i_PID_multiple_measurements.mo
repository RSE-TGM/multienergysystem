...
equation
  ...
  connect(idealPressureSensor7.inlet, s28e30.outlet) annotation (Line(
      points={{232,-258},{234,-258},{234,-204}},
      color={182,109,49},
      thickness=0.5));
  connect(s1.inlet, idealPressureSensor4.outlet) annotation (Line(
      points={{-162,26},{-144,26}},
      color={182,109,49},
      thickness=0.5));
  connect(idealPressureSensor4.inlet, REMI_station.fluidPortOutlet) annotation (
     Line(
      points={{-124,26},{-114,26}},
      color={182,109,49},
      thickness=0.5));
  connect(p_ref.y,aWPIDContinuous. REF)
    annotation (Line(points={{-134,-4},{-120,-4}}, color={0,0,127}));
  connect(aWPIDContinuous.controlAction, REMI_station.in_opening) annotation (
      Line(points={{-101,-8},{-84,-8},{-84,44},{-98.4,44},{-98.4,34.4}}, color={
          0,0,127}));
  connect(idealPressureSensor4.p_meas, aWPIDContinuous.FeedBack) annotation (
      Line(points={{-137.8,18.6},{-164,18.6},{-164,-32},{-130,-32},{-130,-12},{-120,
          -12}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)),
    experiment(StopTime=7500, __Dymola_Algorithm="Dassl"));
end RG2i_PID_multiple_measurements;

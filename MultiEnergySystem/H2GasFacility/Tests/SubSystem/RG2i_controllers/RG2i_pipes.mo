...
partial model RG2i_pipes
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.Round1DFV sds11e12(
    L=Data.PipelineData_2i.sds11.L + Data.PipelineData_2i.sds12.L,
    H=Data.PipelineData_2i.sds11.h + Data.PipelineData_2i.sds12.h,
    ...
    hctype=hctype,
    momentum=momentum,
    rho_nom=Data.PipelineData_2i.sds11.rho_nom) annotation (Placement(
        transformation(
        extent={{-9,-9},{9,9}},
        rotation=90,
        origin={-121,201})));

...
model RG2i_source1_doubleControl_NG6
  ...
  MultiEnergySystem.H2GasFacility.Components.Valves.ValveLinearOpening valve_immissione(
    m_flow_nom=0.4138,
    A_v=0.05*0.4138/(sqrt(40.17625*(60 - 4.93)*1e5)),
...
equation
  ...
  connect(aWPIDContinuous1.controlAction,valve_immissione. opening) annotation (
  ...
  connect(idealSGSensor.outlet, GRM_1.inlet) annotation (Line(
      ...
      color={182,109,49},
      thickness=0.5));
  connect(aWPIDContinuous1.FeedBack, idealSGSensor.SG_meas) annotation (Line(
        points={{-114,-78},{-128,-78},{-128,-96},{22,-96},{22,-18},{195.8,-18},
          {195.8,-24.6}}, color={0,0,127}));
  annotation (experiment(StopTime=28000, __Dymola_Algorithm="Dassl"));
end RG2i_source1_doubleControl_NG6;

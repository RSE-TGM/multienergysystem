...
partial model Rete_Gas_2i_low_pipes_GRM1
...
equation
  ...
  connect(s19.outlet,s20. inlet) annotation (Line(
      points={{194,-84},{194,-94}},
      color={182,109,49},
      thickness=0.5));
  connect(s20.outlet,s21. inlet) annotation (Line(
      points={{194,-114},{194,-122},{210,-122}},
      color={182,109,49},
      thickness=0.5));
  connect(s14e16e18.outlet, s19.inlet) annotation (Line(
      points={{-8,-6},{-8,-8},{194,-8},{194,-64}},
      color={182,109,49},
      thickness=0.5));
  connect(s26.outlet,s28e30. inlet) annotation (Line(
      points={{224,-198},{256,-198},{256,-214}},
      color={182,109,49},
      thickness=0.5));
  connect(s22e24.outlet,s26. inlet) annotation (Line(
      points={{196,-166},{196,-198},{204,-198}},
      color={182,109,49},
      thickness=0.5));
  connect(s22e24.inlet, s20.outlet) annotation (Line(
      points={{196,-146},{194,-144},{194,-114}},
      color={182,109,49},
      thickness=0.5));
  connect(s36_Stadio.inlet,s31. outlet) annotation (Line(
      points={{56,-112},{56,-114},{74,-114},{74,-96}},
      color={182,109,49},
      thickness=0.5));
  connect(s14e16e18.outlet,s31. inlet) annotation (Line(
      points={{-8,-6},{-8,-8},{74,-8},{74,-76}},
      color={182,109,49},
      thickness=0.5));
  connect(sds2.inlet,sds1. outlet) annotation (Line(
      points={{-184,88},{-192,88},{-192,78}},
      color={182,109,49},
      thickness=0.5));
  connect(sds2.outlet,sds3. inlet) annotation (Line(
      points={{-164,88},{-150,88}},
      color={182,109,49},
      thickness=0.5));
  connect(sds3.outlet,sds4e6. inlet) annotation (Line(
      points={{-130,88},{-122,88},{-122,86},{-114,86},{-114,112}},
      color={182,109,49},
      thickness=0.5));
  connect(sds4e6.outlet,sds9. inlet) annotation (Line(
      points={{-114,132},{-116,132},{-116,174}},
      color={182,109,49},
      thickness=0.5));
  connect(sds10.inlet, sds9.outlet) annotation (Line(
      points={{-138,202},{-116,202},{-116,194}},
      color={182,109,49},
      thickness=0.5));
  connect(sds1.inlet, homotopyInitializer1.inlet) annotation (Line(
      points={{-192,58},{-194,58},{-194,38},{-200,38},{-200,4}},
      color={182,109,49},
      thickness=0.5));
  ...
  connect(homotopyInitializer.outlet,sds11. inlet) annotation (Line(
      points={{-116,216},{-115,216},{-115,232}},
      color={182,109,49},
      thickness=0.5));
  connect(sds11.outlet,sds12. inlet) annotation (Line(
      points={{-115,250},{-115,258},{-28,258},{-28,230}},
      color={182,109,49},
      thickness=0.5));
  connect(sds9.outlet, homotopyInitializer.inlet) annotation (Line(
      points={{-116,194},{-116,208}},
      color={182,109,49},
      thickness=0.5));
  connect(sds13.outlet, sds15.inlet) annotation (Line(
      points={{38,230},{46,230},{46,232},{50,232},{50,260}},
      color={182,109,49},
      thickness=0.5));
  connect(sds13.outlet, sds14.inlet) annotation (Line(
      points={{38,230},{80,230},{80,234},{86,234}},
      color={182,109,49},
      thickness=0.5));
  connect(sds7e8.inlet, sds9.inlet) annotation (Line(
      points={{150,162},{-116,162},{-116,174}},
      color={182,109,49},
      thickness=0.5));
...
end Rete_Gas_2i_low_pipes_GRM1;

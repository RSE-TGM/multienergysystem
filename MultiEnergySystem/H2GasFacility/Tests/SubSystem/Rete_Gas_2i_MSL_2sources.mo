...
model Rete_Gas_2i_MSL_2sources
  ...
  Modelica.Fluid.Pipes.DynamicPipe sds16(
    ...
    roughness=Data.PipelineData_2i.sds16.kappa,
  ...
  Modelica.Fluid.Pipes.DynamicPipe sds17(
    ...
    roughness=Data.PipelineData_2i.sds17.kappa,
  ...
  Modelica.Fluid.Pipes.DynamicPipe s4(
    ...
    roughness=Data.PipelineData_2i.s4.kappa,
  ...
  Modelica.Fluid.Pipes.DynamicPipe s31(
    redeclare package Medium = Medium,
    length=Data.PipelineData_2i.s31.L,
    diameter=Data.PipelineData_2i.s31.Di,
    roughness=Data.PipelineData_2i.s31.kappa,
    height_ab=Data.PipelineData_2i.s31.h,
    p_a_start=Data.PipelineData_2i.s31.pin_start,
    p_b_start=Data.PipelineData_2i.s31.pout_start,
    T_start=288.15,
    X_start=X_start,
  ...
  Modelica.Fluid.Pipes.DynamicPipe s36(
    redeclare package Medium = Medium,
    length=Data.PipelineData_2i.s36.L,
    diameter=Data.PipelineData_2i.s36.Di,
    roughness=Data.PipelineData_2i.s36.kappa,
    height_ab=Data.PipelineData_2i.s36.h,
    p_a_start=Data.PipelineData_2i.s36.pin_start,
    p_b_start=Data.PipelineData_2i.s36.pout_start,
    T_start=288.15,
    X_start=X_start,

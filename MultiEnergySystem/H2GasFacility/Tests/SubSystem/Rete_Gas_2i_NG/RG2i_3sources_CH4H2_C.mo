...
model RG2i_3sources_CH4H2_C "Test using a fluid for the network with 100% CH4 and 0% H2 and three immissions with 0% CH4 and 100% H2, including mass compositions dynamics"

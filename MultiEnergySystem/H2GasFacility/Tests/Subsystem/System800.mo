...
model System800
  MultiEnergySystem.H2GasFacility.Sources.SourceMassFlow sourceCH4 annotation(
  ...
  MultiEnergySystem.H2GasFacility.Components.Pipes.round1DFV gasline1 annotation(
    Placement(visible = true, transformation(origin = {-90, -4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Pipes.round1DFV gasline2 annotation(
    Placement(visible = true, transformation(origin = {-62, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  MultiEnergySystem.H2GasFacility.Components.Pipes.round1DFV gasline3 annotation(
    Placement(visible = true, transformation(origin = {-36, 38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  MultiEnergySystem.H2GasFacility.Components.Pipes.round1DFV gasline4 annotation(
  ...
  MultiEnergySystem.H2GasFacility.Sources.SinkPressure sinkPressure annotation(

...
partial model SystemInterfaceBaseIII
  ...
  Modelica.Blocks.Interfaces.RealInput pumpset "Input for pump frequency" annotation (Placement(transformation(extent={{-120,60},{-100,80}}), iconTransformation(extent={{-120,60},{-100,80}})));

...
partial model SystemInterfaceBaseV
  Modelica.Blocks.Interfaces.RealInput m_flow_set "Valve opening" annotation (Placement(transformation(extent={{-120,40},{-100,60}}), iconTransformation(extent={{-120,40},{-100,60}})));

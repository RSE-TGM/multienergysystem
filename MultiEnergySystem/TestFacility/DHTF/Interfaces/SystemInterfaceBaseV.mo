...
partial model SystemInterfaceBaseV
  Modelica.Blocks.Interfaces.RealInput dp_set "Delta pressure fixed" annotation (Placement(transformation(extent={{-120,40},{-100,60}}), iconTransformation(extent={{-120,40},{-100,60}})));

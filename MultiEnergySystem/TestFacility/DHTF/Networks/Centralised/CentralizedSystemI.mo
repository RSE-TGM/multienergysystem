...
partial model CentralizedSystemI "System with only Gas Boiler as source of heat"
  extends DHTF.Networks.BaseClass.CentralizedNetworkBase(Tout_start_S9 = T_start_hot, Tin_start_S9 = T_start_cold);
  ...
  DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCV101(redeclare
      model                                                                            Medium = WaterHot,Kv = TestFacility.Data.ValveData.FCV101.Kv, dp_nom(displayUnit = "Pa") = TestFacility.Data.ValveData.FCV101.dp_nom, rho_nom = TestFacility.Data.ValveData.FCV101.rho_nom, q_m3h_nom = TestFacility.Data.ValveData.FCV101.q_nom_m3h, Tin_start(displayUnit = "K") = Tout_start_S1, pin_start = pout_start_S1, q_m3h_start = TestFacility.Data.PumpData.P101.qnom_inm3h) annotation (
    Placement(transformation(extent = {{-10, 10}, {10, -10}}, rotation = 90, origin = {-240, -140})));
  DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL3_S101(redeclare
      model                                                                      Medium = WaterHot,L = L_S1_PL3, t = t_S1, pin_start = pout_start_S1, Tin_start = Tout_start_S1, Tout_start = Tout_start_S1, Di = Di_S1, q_m3h_start = q_m3h_S1, hctype = hctype, n = n) annotation (
    Placement(transformation(extent = {{-10, 10}, {10, -10}}, rotation = 90, origin = {-240, -230})));
  DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL2_S101(redeclare
      model                                                                      Medium = WaterHot,L = L_S1_PL2, t = t_S1, pin_start = pin_start_S1, Tin_start = Tin_start_S1, Tout_start = Tin_start_S1, Di = Di_S1, q_m3h_start = q_m3h_S1, hctype = hctype, n = n) annotation (
    Placement(transformation(extent = {{10, -10}, {-10, 10}}, rotation = 90, origin = {-276, -232})));
  DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL4_S101(redeclare
      model                                                                      Medium = WaterHot,L = L_S1_PL3, t = t_S1, pin_start = pout_start_S1, Tin_start = Tout_start_S1, Tout_start = Tout_start_S1, Di = Di_S1, q_m3h_start = q_m3h_S1, hctype = hctype, n = n) annotation (
  ...
  DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL1_S101(redeclare
      model                                                                      Medium = WaterHot,L = L_S1_PL1, t = t_S1, pin_start = pin_start_S1, Tin_start = Tin_start_S1, Tout_start = Tin_start_S1, Di = Di_S1, q_m3h_start = q_m3h_S1, hctype = hctype, n = n) annotation (
  ...
  DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL_S100_rCD_hot(redeclare
      model                                                                             Medium = WaterHot,L = L_S1_rCD_hot, t = t_S1, pin_start = pout_start_S1, Tin_start = Tout_start_S1, Tout_start = Tout_start_S1, Di = Di_S1, q_m3h_start = q_m3h_S1, hctype = hctype, n = n) annotation (
  ...
  DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL_S100_rCD_cold(redeclare
      model                                                                              Medium = WaterHot,L = L_S1_rCD_cold, t = t_S1, pin_start = pin_start_S1, Tin_start = Tin_start_S1, Tout_start = Tin_start_S1, Di = Di_S1, q_m3h_start = q_m3h_S1, hctype = hctype, n = n) annotation (

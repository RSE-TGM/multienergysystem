...
equation
  ...
  connect(inletPower, EB.inletPower) annotation (Line(
      ...
      color={56,93,138},
      thickness=1));
  connect(pumpset, P401.in_omega) annotation (Line(points={{-110,70},{-95,70},{-95,135.5},{9,135.5},{9,-23.8},{14,-23.8}}, color={0,0,127}));
  connect(theta, FCV401.opening) annotation (Line(points={{-110,50},{-97.5,50},{-97.5,137},{10.5,137},{10.5,40},{13.6,40}}, color={0,0,127}));

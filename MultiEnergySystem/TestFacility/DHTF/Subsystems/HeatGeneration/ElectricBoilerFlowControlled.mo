...
model ElectricBoilerFlowControlled "System 400 with ideal flow control"
  ...
  ElectricNetwork.Interfaces.ElectricPortInlet inletPower annotation (Placement(transformation(extent={{-120,
            -108},{-100,-88}}),                                                                                                 iconTransformation(extent={{-120,-60},{-100,-40}})));
equation
  Pe = P401.W;
  ...
  connect(PL_S400_P401_FCV401.wall, MultiPort) annotation (Line(points={{15.9,40},{-58,40},{-58,-70},{-110,-70}},                 color={255,238,44}));
  ...
  connect(PL_S400_P401_FCV401.outlet, PT402.inlet) annotation (Line(
      points={{20,50},{20,56},{19.6,56},{19.6,62}},
      color={140,56,54},
      thickness=0.5));
  connect(m_flow_set, P401.in_m_flow) annotation (Line(points={{-110,50},{-46,50},{-46,-23.8},{14.48,-23.8}}, color={0,0,127}));
  connect(inletPower, EB.inletPower) annotation (Line(
      points={{-110,-98},{-96,-98},{-96,-118},{28,-118},{28,-94},{15.4,-94}},
      color={56,93,138},
      thickness=1));
...
end ElectricBoilerFlowControlled;

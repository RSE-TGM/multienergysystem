...
model ControlPowerTest
  ...
  parameter Real Kp_Pt = -0.0013715;
  parameter Real Ti_Pt = 1.17885;
  ...
  Modelica.Blocks.Sources.RealExpression Pt_SP(y=30E3) annotation (Placement(transformation(extent={{-66,8},{-46,28}})));

...
model E700Test "HX70X base test with real data"
  ...
  parameter String Temperatures = Modelica.Utilities.Files.loadResource("modelica://MultiEnergySystem/TestFacility/Resources/Centralised/0412_Test3.mat") "File name of matrix" annotation (
    Dialog(loadSelector(filter = "MATLAB MAT files (*.mat)", caption = "Open MATLAB MAT file")));
  parameter String Pressures = Modelica.Utilities.Files.loadResource("modelica://MultiEnergySystem/TestFacility/Resources/Centralised/0412_Test3.mat") "File name of matrix" annotation (
    Dialog(loadSelector(filter = "MATLAB MAT files (*.mat)", caption = "Open MATLAB MAT file")));
  parameter String Flows = Modelica.Utilities.Files.loadResource("modelica://MultiEnergySystem/TestFacility/Resources/Centralised/0412_Test3.mat") "File name of matrix" annotation (
    Dialog(loadSelector(filter = "MATLAB MAT files (*.mat)", caption = "Open MATLAB MAT file")));
  parameter String Actuators = Modelica.Utilities.Files.loadResource("modelica://MultiEnergySystem/TestFacility/Resources/Centralised/0412_Test3.mat") "File name of matrix" annotation (
    Dialog(loadSelector(filter = "MATLAB MAT files (*.mat)", caption = "Open MATLAB MAT file")));
  ...
  inner MultiEnergySystem.System system annotation (Placement(visible=true, transformation(
        origin={-90,90},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.BrazedPlateHeatExchanger E7X1(
    ...
    redeclare model Medium = Medium, Di_cold=Data.BPHEData.E701.Di_cold,
                                                                  Di_hot=Data.BPHEData.E701.Di_hot,
                                                                                             L_cold=Data.BPHEData.E701.L_cold,
                                                                                                                        L_hot=Data.BPHEData.E701.L_hot,
                                                                                                                                                 MWall=Data.BPHEData.E701.MWall,
                                                                                                                                                                          Stot_cold=Data.BPHEData.E701.Stot_cold,
                                                                                                                                                                                                        Stot_hot=Data.BPHEData.E701.Stot_hot,
                                                                                                                                                                                                        Tin_start_cold=Data.BPHEData.E701.Tin_start_cold,
                                                                                                                                                                                                        Tin_start_hot=Data.BPHEData.E701.Tin_start_hot,
                                                                                                                                                                                                        Tout_start_cold=Data.
        BPHEData.E701.Tout_start_cold,                                                                                                                                                                                                        Tout_start_hot=Data.
        BPHEData.E701.Tout_start_hot,                                                                                                                                                                                                        cpm_cold=Data.
        BPHEData.E701.cpm_cold,                                                                                                                                                                                                        cpm_hot=Data.
        BPHEData.E701.cpm_hot,                                                                                                                                                                                                        t_cold=Data.
        BPHEData.E701.t_cold,                                                                                                                                                                                                        t_hot=Data.
        BPHEData.E701.t_hot,
    gamma_nom_cold=11200.497,
    gamma_nom_hot=4313.9346,                                                                                                                                                                                                        h_cold=Data.BPHEData.E701.h_cold,
                                                                                                                                                                                                        h_hot=Data.BPHEData.E701.h_hot,                                                                              k_cold=Data.
        BPHEData.E701.k_cold,                                                                                                                                                                                                        k_hot=Data.
        BPHEData.E701.k_hot,                                                                                                                                                                                                        kc_cold = 1, kc_hot = 1, lambdam_cold=Data.
        BPHEData.E701.lambdam_cold,                                                                                                                                                                                                        lambdam_hot=Data.
        BPHEData.E701.lambdam_hot,                                                                                                                                                                                                        m_flow_start_cold=Data.
        BPHEData.E701.m_flow_start_cold,                                                                                                                                                                                                        m_flow_start_hot=Data.
        BPHEData.E701.m_flow_start_hot,                                                                                                                                                                                                        n = 9, nPipes_cold=Data.
        BPHEData.E701.nPipes_cold,                                                                                                                                                                                                        nPipes_hot=Data.
        BPHEData.E701.nPipes_hot,                                                                                                                                                                                                        nPlates=Data.
        BPHEData.E701.nPlates,                                                                                                                                                                                                        pin_start_cold=Data.
        BPHEData.E701.pin_start_cold,                                                                                                                                                                                                        pin_start_hot=Data.
        BPHEData.E701.pin_start_hot,                                                                                                                                                                                                        pout_start_cold=Data.
        BPHEData.E701.pout_start_cold,                                                                                                                                                                                                        pout_start_hot=Data.
        BPHEData.E701.pout_start_hot,                                                                                                                                                                                                        rho_nom_cold = (Data.
        BPHEData.E701.rhoin_nom_cold                                                                                                                                                                                                        +Data.
        BPHEData.E701.rhoout_nom_cold)                                                                                                                                                                                                        /2, rho_nom_hot = (Data.
        BPHEData.E701.rhoin_nom_hot                                                                                                                                                                                                        +Data.
        BPHEData.E701.rhoout_nom_hot)                                                                                                                                                                                                        /2, rhom_cold(displayUnit = "kg/m3")=Data.
      BPHEData.E701.rhom_cold,                                                                                                                                                                                                        rhom_hot(displayUnit = "g/cm3")=Data.
      BPHEData.E701.rhom_hot,                                                                                                                                                                                                        thermalInertia = false, u_nom_cold=Data.
        BPHEData.E701.u_nom_cold,                                                                                                                                                                                                        u_nom_hot=Data.
        BPHEData.E701.u_nom_hot)                                                                                                                                                                                                         annotation (
  ...
  DistrictHeatingNetwork.Sources.SourceMassFlow sourceHot_mflow(
    ...
    use_in_m_flow=true,
    use_in_T=true,
    p0=Data.BPHEData.E701.pin_start_hot,
    T0=Data.BPHEData.E701.Tin_start_hot,
    m_flow0=Data.BPHEData.E701.m_flow_start_hot,
    G=1e-8) annotation (Placement(transformation(extent={{61,41},{41,21}})));
  DistrictHeatingNetwork.Sources.SourceMassFlow sourceCold_mflow(
    redeclare model Medium = Medium,
    use_in_m_flow=true,
    use_in_T=true,
    p0=Data.BPHEData.E701.pin_start_cold,
    T0=Data.BPHEData.E701.Tin_start_cold,
    m_flow0=0.32,
    G=1e-8) annotation (Placement(transformation(extent={{-60,-42},{-40,-22}})));
  DistrictHeatingNetwork.Sources.SinkPressure sinkHot_p(
    redeclare model Medium = Medium,
    use_in_p0=true,
    p0=Data.BPHEData.E701.pout_start_hot,
    T0=Data.BPHEData.E701.Tout_start_hot,
    R=1e-3) annotation (Placement(transformation(extent={{44,-43},{64,-23}})));
  DistrictHeatingNetwork.Sources.SinkPressure sinkCold_p(
    redeclare model Medium = Medium,
    use_in_p0=false,
    p0=Data.BPHEData.E701.pout_start_cold,
    T0=Data.BPHEData.E701.Tout_start_cold,
    R=1e-3) annotation (Placement(transformation(extent={{-43,21},{-62,40}})));
  ...
  DistrictHeatingNetwork.Sources.SinkPressure sinkCold_ref(
    ...
    use_in_p0=false,
    use_in_T0=true,
    R=1e-3) annotation (Placement(transformation(origin={40,42}, extent={{-50,18},{-70,38}})));
  ...
  DistrictHeatingNetwork.Sources.SinkPressure sinkHot_ref(
    ...
    use_in_p0=false,
    use_in_T0=true,
    R=1e-3) annotation (Placement(transformation(origin={-58,110}, extent={{68,-50},{88,-30}})));
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sensors.IdealAbsoluteTemperatureSensor TT7X1(
    redeclare model Medium = Medium,
    T_start=Data.BPHEData.E701.Tout_start_hot,
    p_start=Data.BPHEData.E701.pout_start_hot)
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sensors.IdealAbsoluteTemperatureSensor TT7X4(
    redeclare model Medium = Medium,
    T_start=Data.BPHEData.E701.Tout_start_cold,
    p_start=Data.BPHEData.E701.pout_start_cold)
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sensors.IdealAbsoluteTemperatureSensor TT7X3(
    redeclare model Medium = Medium,
    T_start=Data.BPHEData.E701.Tin_start_cold,
    p_start=Data.BPHEData.E701.pin_start_cold)
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sensors.IdealAbsoluteTemperatureSensor TT7X2(
    redeclare model Medium = Medium,
    T_start=Data.BPHEData.E701.Tin_start_hot,
    p_start=Data.BPHEData.E701.pin_start_hot)

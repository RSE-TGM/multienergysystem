...
partial model CentralPlantBase "Base Case considering rack CD and the pipelines connecting to the loads"
  ...
  DistrictHeatingNetwork.Sources.SourcePressure VE901(redeclare model Medium = MediumCP, p0 = p_VE901, T0(displayUnit="K") = T_start_cold, R=1e-3)  annotation (
    Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {-849, 131})));
  MultiEnergySystem.DistrictHeatingNetwork.Components.TurboMachines.PrescribedPump P901(redeclare
      model                                                                                             Medium = MediumCP, Tin_start = TestFacility.Data.PumpData.P901.Tin_start, Tout_start = TestFacility.Data.PumpData.P901.Tout_start, hin_start = TestFacility.Data.PumpData.P901.hin_start, pin_start = pin_start_S9, pout_start = pout_start_S9, a = TestFacility.Data.PumpData.P901.a, b = TestFacility.Data.PumpData.P901.b, dpnom = TestFacility.Data.PumpData.P901.dpnom, etaelec = TestFacility.Data.PumpData.P901.etaelec, etamech = TestFacility.Data.PumpData.P901.etamech, etanom = TestFacility.Data.PumpData.P901.etanom, headnom = TestFacility.Data.PumpData.P901.headnom, headmax = TestFacility.Data.PumpData.P901.headnommax, headmin = TestFacility.Data.PumpData.P901.headnommin, m_flow_nom = TestFacility.Data.PumpData.P901.m_flow_nom, omeganom = TestFacility.Data.PumpData.P901.omeganom, qnom_inm3h = TestFacility.Data.PumpData.P901.qnom_inm3h, qnom_inm3h_min = TestFacility.Data.PumpData.P901.qnommin_inm3h, rhonom(displayUnit = "kg/m3") = TestFacility.Data.PumpData.P901.rhonom, qnom_inm3h_max = TestFacility.Data.PumpData.P901.qnommax_inm3h, use_in_omega = true) annotation (
    Placement(visible = true, transformation(extent = {{-20.5, 20.5}, {20.5, -20.5}}, rotation = 90, origin = {-757.5, 74.5})));
  MultiEnergySystem.DistrictHeatingNetwork.Sensors.IdealMassFlowSensor FT901(redeclare
      model                                                                                  Medium = MediumCP, T_start = Tout_start_S9, p_start = pout_start_S9) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Sensors.IdealAbsoluteTemperatureSensor TT902(redeclare
      model                                                                                             Medium = MediumCP, T_start = Tout_start_S9, p_start = pout_start_S9) "Temperature sensor at the outlet of pump 901" annotation (
    Placement(transformation(extent = {{-4.75, 4.75}, {4.75, -4.75}}, rotation = 90, origin = {-754.75, 196.25})));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL4_S901(redeclare
      model                                                                                        Medium = MediumCP, L = L_S9_PL3, t = t_S9, pin_start = pout_start_S9, Tin_start = Tout_start_S9, Tout_start = Tout_start_S9, Di = Di_S9, q_m3h_start = q_m3h_S9, n = n, hctype = hctype) annotation (
    Placement(transformation(origin={-757,112},    extent = {{-10, 10}, {10, -10}}, rotation = 90)));
  MultiEnergySystem.DistrictHeatingNetwork.Sensors.IdealAbsoluteTemperatureSensor TT901(redeclare
      model                                                                                             Medium = MediumCP, T_start = Tin_start_S9, p_start = pin_start_S9) "Temperature sensor at the inlet of pump 901" annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL2_S901(redeclare
      model                                                                                        Medium = MediumCP, L = L_S9_PL2, h = h_S9_PL2, t = t_S9, pin_start = pin_start_S9, Tin_start = Tin_start_S9, Tout_start = Tin_start_S9, Di = Di_S9, q_m3h_start = q_m3h_S9, n = n, hctype = hctype) annotation (
    Placement(transformation(extent = {{10, -10}, {-10, 10}}, rotation = 90, origin = {-808, 101})));
  MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCV901(redeclare
      model                                                                                              Medium = MediumCP, Kv = TestFacility.Data.ValveData.FCV901.Kv, dp_nom(displayUnit = "Pa") = TestFacility.Data.ValveData.FCV901.dp_nom, openingChar=TestFacility.Data.ValveData.FCV901.openingChar, rho_nom = TestFacility.Data.ValveData.FCV901.rho_nom, q_m3h_nom = TestFacility.Data.ValveData.FCV901.q_nom_m3h, Tin_start(displayUnit = "K") = Tout_start_S9, pin_start = pout_start_S9, q_m3h_start = q_m3h_S9) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL2L3_rackL3L4_hot(redeclare
      model                                                                                                     Medium = MediumCP, L = L_rL2L3_rL3L4_H, t = t_rL_H, pin_start = pin_start_Users, Tin_start = T_start_hot, Tout_start = T_start_hot, Di = Di_rL_H, q_m3h_start = q_m3h_rackHot, n = n, hctype = hctype) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV FCVC01_rackL4L5_hot(redeclare
      model                                                                                                   Medium = MediumCP, L = L_FCVC01_rL4L5_H, t = t_rL_H, pin_start = pin_start_Users - 0.01e5, Tin_start = T_start_hot, Tout_start = T_start_hot, Di = Di_rL_H, q_m3h_start = q_m3h_rackHot, n = n, hctype = hctype) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL5L6_rackL6L7_hot(redeclare
      model                                                                                                     Medium = MediumCP, L = L_rL5L6_rL6L7_H, t = t_rL_H, pin_start = pin_start_Users - 0.02e5, Tin_start = T_start_hot, Tout_start = T_start_hot, Di = Di_rL_H, q_m3h_start = q_m3h_rackHot, n = n, hctype = hctype) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL2L3_rackL3L4_cold(redeclare
      model                                                                                                      Medium = MediumCP, L = L_rL2L3_rL3L4_C, t = t_rL_C, pin_start = pout_start_Users - 0.02e5, Tin_start = T_start_cold, Tout_start = T_start_cold, Di = Di_rL_C, q_m3h_start = q_m3h_rackCold, n = n, hctype = hctype) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV FCVC01_rackL4L5_cold(redeclare
      model                                                                                                    Medium = MediumCP, L = L_FCVC01_rL4L5_C, t = t_rL_C, pin_start = pin_start_Users - 0.01e5, Tin_start = T_start_cold, Tout_start = T_start_cold, Di = Di_rL_C, q_m3h_start = q_m3h_rackCold, n = n, hctype = hctype) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL5L6_rackL6L7_cold(redeclare
      model                                                                                                      Medium = MediumCP, L = L_rL5L6_rL6L7_C, t = t_rL_C, pin_start = pin_start_Users - 0.02e5, Tin_start = T_start_cold, Tout_start = T_start_cold, Di = Di_rL_C, q_m3h_start = q_m3h_rackCold, n = n, hctype = hctype) annotation (

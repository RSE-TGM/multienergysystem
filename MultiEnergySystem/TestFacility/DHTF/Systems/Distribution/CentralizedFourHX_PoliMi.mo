...
model CentralizedFourHX_PoliMi
  ...
  replaceable model MediumCP =
      DistrictHeatingNetwork.Media.WaterLiquidVaryingcp                          constrainedby
...
//   parameter DistrictHeatingNetwork.Types.Temperature Tout_start_S9 = 17 + 273.15;
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCVC02(redeclare
      model Medium =                                                                                              MediumCP, Kv = TestFacility.Data.ValveData.FCVC02.Kv, openingChar=TestFacility.Data.ValveData.FCVC02.openingChar, dp_nom(displayUnit = "Pa") = dp_nom_UsersValve, Tin_start(displayUnit = "K") = T_start_hot,
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCVC01(redeclare
      model Medium =                                                                                              MediumCP, Kv = TestFacility.Data.ValveData.FCVC01.Kv, openingChar=TestFacility.Data.ValveData.FCVC01.openingChar, dp_nom(displayUnit = "Pa") = dp_nom_UsersValve, Tin_start(displayUnit = "K") = T_start_hot,
    pin_start=350000)                                                                                                                                                                                                         annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV S900_rackL3L4_hot(
    ...
    m_flow_start=m_flow_S9,                                                                 redeclare
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL3L4_FCVC01_hot(
    set_m_flow_start=true,
    m_flow_start=m_flow_S9/2,                                                                 redeclare
      model Medium =                                                                                                   MediumCP, L = L_rL3L4_FCVC01_H, t = t_rL_H, pin_start = pin_start_Users - 0.01e5, Tin_start = T_start_hot, Tout_start = T_start_hot, Di = Di_rL_H,
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL4L5_rackL5L6_hot(
    set_m_flow_start=true,
    m_flow_start=m_flow_S9/4,                                                                   redeclare
      model Medium =                                                                                                     MediumCP, L = L_rL4L5_rL5L6_H, t = t_rL_H, pin_start = pin_start_Users - 0.02e5, Tin_start = T_start_hot, Tout_start = T_start_hot, Di = Di_rL_H,
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL3L4_FCVC01_cold(
    set_m_flow_start=true,
    m_flow_start=m_flow_S9/2,                                                                  redeclare
      model Medium =                                                                                                    MediumCP, L = L_rL3L4_FCVC01_C, t = t_rL_C, pin_start = pout_start_Users - 0.01e5, Tin_start = T_start_cold, Tout_start = T_start_cold, Di = Di_rL_C,
    q_m3h_start=q_m3h_rackHot/2,                                                                                                                                                                                                        n = n, hctype = hctype) annotation (
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL4L5_rackL5L6_cold(
    set_m_flow_start=true,
    m_flow_start=m_flow_S9/4,                                                                    redeclare
      model Medium =                                                                                                      MediumCP, L = L_rL4L5_rL5L6_C, t = t_rL_C, pin_start = pout_start_Users, Tin_start = T_start_cold, Tout_start = T_start_cold, Di = Di_rL_C,
  ...
  MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV rackL6L7_FCVC02_cold(
    set_m_flow_start=true,
    m_flow_start=m_flow_S9/4,                                                                  redeclare
      model Medium =                                                                                                    MediumCP, L = L_rL6L7_FCVC02_C, t = t_rL_C, pin_start = pin_start_Users - 0.02e5, Tin_start = T_start_cold, Tout_start = T_start_cold, Di = Di_rL_C,

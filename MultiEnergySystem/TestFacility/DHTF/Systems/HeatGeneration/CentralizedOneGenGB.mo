...
model CentralizedOneGenGB
  ...
  // Initialization
  //-------------------------------
  parameter DistrictHeatingNetwork.Types.Pressure pin_start_S100 = 1.695e5;
  parameter DistrictHeatingNetwork.Types.Pressure pout_start_S100 = 1.6e5;
  parameter DistrictHeatingNetwork.Types.Temperature Tin_start_S100 = 70 + 273.15;
  parameter DistrictHeatingNetwork.Types.Temperature Tout_start_S100 = 80 + 273.15;
  parameter Real q_m3h_S100(unit = "m3/h") = 9;
  ...
  final parameter DistrictHeatingNetwork.Types.MassFlowRate m_flow_S100 = q_m3h_S100*975/3600;

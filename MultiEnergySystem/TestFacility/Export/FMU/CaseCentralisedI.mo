...
model CaseCentralisedI
  ...
  Modelica.Blocks.Interfaces.RealInput GB101Tout_SP annotation (Placement(transformation(
        extent={{-5,-5},{5,5}},
        rotation=0,
        origin={-100,37.5}),iconTransformation(extent={{-110,0},{-100,10}})));
...
equation
  ...
  connect(GB101Tout_SP, actuator.GB101Tout_SP) annotation (Line(points={{-100,37.5},{-65,37.5},{-65,63.2625},{-21.0125,63.2625}}, color={0,0,127}));
  connect(P101omega, actuator.P101omega) annotation (Line(points={{-100,29.5},{-62.5,29.5},{-62.5,61.2375},{-21.0125,61.2375}}, color={0,0,127}));

...
equation
  ...
  connect(actuator.controlSignalBus, facility.controlSignalBus) annotation (
      Line(
      points={{0.25,42.81},{0,42.81},{0,30}},
      color={255,204,51},
      thickness=0.5));
  connect(facility.inletGas, sourceGas.outlet) annotation (Line(
      points={{30,0},{30,0},{36,0},{36,-45.5},{31.5,-45.5}},
      color={182,109,49},
      thickness=0.5));
  connect(facility.electricPortInlet, sourceVoltage.outlet) annotation (Line(
      points={{-30,0},{-30,0},{-35,0},{-35,-45},{-29.5,-45}},
      color={56,93,138},
      thickness=1));
  annotation (
    Icon(coordinateSystem(grid={0.5,0.5})),
  Diagram(coordinateSystem(grid={0.5,0.5})));
end CaseCentralisedII_Copia;

...
model CaseCentralisedII_noChiller
  extends CaseCentralisedI(
    redeclare DHTF.Networks.Centralised.LoadControl.CentralSystemLoadControl_II_withoutChiller facility,
...
end CaseCentralisedII_noChiller;

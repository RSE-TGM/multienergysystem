...
model CaseCentralisedIV
  ...
  Modelica.Blocks.Interfaces.RealInput FCV201theta annotation (Placement(transformation(
        extent={{-5,-5},{5,5}},
        rotation=0,
        origin={-100.5,-31}),iconTransformation(extent={{-110,-90},{-100,-80}})));
equation
  connect(P201input, actuator.P201omega) annotation (Line(points={{-100.5,-23.5},{-50,-23.5},{-50,47.0625},{-21.0125,47.0625}},
                                                                                                                            color={0,0,127}));
  connect(FCV201theta, actuator.FCV201theta) annotation (Line(points={{-100.5,-31},{-48.5,-31},{-48.5,45.0375},{-21.0125,45.0375}},     color={0,0,127}));
  connect(S200_status, actuator.S200_status) annotation (Line(points={{-100.5,-39},{-47,-39},{-47,43.0125},{-21.0125,43.0125}},     color={255,127,0}));
  annotation (

...
model CentralisedSystemLoadSimplifiedI_B_FMU
  ...
  Modelica.Blocks.Interfaces.RealInput GB101_Tout
    annotation (Placement(transformation(extent={{-328,-290},{-288,-250}})));
  ...
  Modelica.Blocks.Sources.BooleanConstant GB101Status
    annotation (Placement(transformation(extent={{-304,-362},{-284,-342}})));
  ...
  ElectricNetwork.Sources.SourceVoltage sourceVoltage annotation (Placement(transformation(extent={{-352,-368},{-332,-348}})));
equation
  ...
  connect(EB401.Tout_ref, EB401_Tout) annotation (Line(points={{-361.5,-301},{-374.5,-301},{-374.5,-300},{-398,-300}},
                                            color={0,0,127}));
  connect(GB101.Tout_ref, GB101_Tout) annotation (Line(points={{-281.5,-301},{-288,-301},{-288,-302},{-296,-302},{-296,-286},{-308,-286},{-308,-270}},
                              color={0,0,127}));
  ...
  connect(GB101Status.y, GB101.heat_on) annotation (Line(points={{-283,-352},{-283,-335.25},{-281.5,-335.25},{-281.5,-318.5}},
                                                color={255,0,255}));
  ...
  connect(sourceVoltage.outlet, EB401.inletPower) annotation (Line(
      points={{-332,-358},{-312.5,-358},{-312.5,-301}},
      color={56,93,138},
      thickness=1));

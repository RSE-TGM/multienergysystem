...
model S100 "Example of system S100 fmu test model"
  ...
  Modelica.Blocks.Interfaces.RealInput f annotation (Placement(transformation(extent={{-140,40},{-100,80}}), iconTransformation(extent={{-140,40},{-100,80}})));
  Modelica.Blocks.Interfaces.RealInput theta annotation (Placement(transformation(extent={{-140,0},{-100,40}}),iconTransformation(extent={{-140,0},{-100,40}})));
  Modelica.Blocks.Interfaces.RealInput ToutSP annotation (Placement(transformation(extent={{-140,-40},{-100,0}}),iconTransformation(extent={{-140,-40},{-100,0}})));
  Modelica.Blocks.Interfaces.RealOutput FT101 annotation (Placement(transformation(extent={{100,30},{120,50}}),iconTransformation(extent={{100,30},{120,50}})));
  Modelica.Blocks.Interfaces.RealOutput TT101 annotation (Placement(transformation(extent={{100,10},{120,30}}),iconTransformation(extent={{100,10},{120,30}})));
  Modelica.Blocks.Interfaces.RealOutput TT102 annotation (Placement(transformation(extent={{100,-10},{120,10}}),iconTransformation(extent={{100,-10},{120,10}})));
  Modelica.Blocks.Interfaces.RealOutput PT101 annotation (Placement(transformation(extent={{100,-30},{120,-10}}),iconTransformation(extent={{100,-30},{120,-10}})));
  Modelica.Blocks.Interfaces.RealOutput PT102 annotation (Placement(transformation(extent={{100,-50},{120,-30}}),iconTransformation(extent={{100,-50},{120,-30}})));
  Modelica.Blocks.Interfaces.BooleanInput status annotation (Placement(transformation(extent={{-140,-80},{-100,-40}}),iconTransformation(extent={{-140,-80},{-100,-40}})));
...
equation
  ...
  connect(gain1.y, FT101) annotation (Line(points={{70.6,40},{80,40},{80,40},{110,40}},
                                                                       color={0,0,127}));
  connect(gasBoiler.TTin, TT101) annotation (Line(points={{46.2,19},{62,19},{62,20},{110,20}},color={0,0,127}));
  connect(gasBoiler.TTout, TT102) annotation (Line(points={{46.2,10.6},{67.1,10.6},{67.1,0},{110,0}},  color={0,0,127}));
  connect(gasBoiler.PTin, PT101) annotation (Line(points={{46.2,2.2},{62,2.2},{62,-20},{110,-20}},
                                                                                                color={0,0,127}));
  connect(gasBoiler.PTout, PT102) annotation (Line(points={{46.2,-6.2},{52,-6.2},{52,-6},{60,-6},{60,-40},{110,-40}},color={0,0,127}));
  ...
  connect(Tin, source.in_T0) annotation (Line(points={{0,120},{0,74},{-36,74},{-36,68.4}},     color={0,0,127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
                ...
                textString="to FMU")}),                          Diagram(coordinateSystem(preserveAspectRatio=false)));
end S100;

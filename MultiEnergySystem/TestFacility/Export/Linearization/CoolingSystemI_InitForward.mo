...
model CoolingSystemI_InitForward "Analysis of the cooling system using InputOffset/OutputOffset blocks"
  ...
  parameter Boolean ForwardInit = true;
...
//Normalisation values
  ...
  Export.Utilities.InputOffset mflowEX701Offset(
    ...
    u_start=m_flowhot_nom) annotation (Placement(visible=true, transformation(
        ...
        extent={{-6,-6},{6,6}},
        rotation=0)));
  Export.Utilities.InputOffset mflowEX711Offset(
    ...
    u_start=m_flowhot_nom) annotation (Placement(visible=true, transformation(
        ...
        extent={{-6,-6},{6,6}},
        rotation=0)));
  Export.Utilities.InputOffset mflowEX721Offset(
    ...
    u_start=m_flowhot_nom) annotation (Placement(visible=true, transformation(
        ...
        extent={{-6,-6},{6,6}},
        rotation=0)));
  Export.Utilities.InputOffset mflowEX731Offset(

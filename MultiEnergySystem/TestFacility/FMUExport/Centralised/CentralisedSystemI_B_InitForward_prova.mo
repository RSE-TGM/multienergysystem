...
equation
  ...
  connect(PT902.p, PT902Offset.y)    annotation (Line(points={{-748.5,181.5},{-748.5,182},{-738.8,182}},
                                                                                 color={0,0,127}));
  connect(TT701.T, TT701Offset.y)    annotation (Line(points={{146.5,-92},{154,
          -92},{154,-88},{161.2,-88}},                                                                          color={0,0,127}));
  ...
  connect(TT704.T, TT704Offset.y)    annotation (Line(points={{88.2,-245},{88.2,
          -252},{84.8,-252}},                                                                                 color={0,0,127}));
  ...
  connect(PT901Offset.deltaYnorm, processVariableBus.dPT901) annotation (Line(points={{-853,162},{-876,162},{-876,282},{820,282},{820,14},{896,14},{896,-3}}, color={0,0,127}),
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(PT701.p, PT701Offset.y) annotation (Line(points={{146.5,-82},{156,-82},
          {156,-72},{161.2,-72}},                                                                      color={0,0,127}));
  connect(PT702.p, PT702Offset.y) annotation (Line(points={{89.5,-94},{86,-94},
          {86,-80},{82.8,-80}},                                                  color={0,0,127}));
  ...
  connect(thetaTCV701Offset.u, TCV701.opening) annotation (Line(points={{69.4,
          -320},{80,-320},{80,-296},{90,-296}},                                                 color={0,0,127}));

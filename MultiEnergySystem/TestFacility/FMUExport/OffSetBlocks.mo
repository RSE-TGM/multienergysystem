...
package OffSetBlocks
  ...
  model InputOffset
    ...
    parameter Real u_Offset_fixed = u_start "Value of u_Offset if fixedOffset == true"
      annotation(Dialog(enable = fixedOffset));
  ...
  initial equation
    ...
    annotation (
      Icon(                                               graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {170, 255, 85},
              fillPattern =                                                                                                                                                           FillPattern.Solid), Text(extent = {{-100, -100}, {100, -140}}, lineColor = {0, 0, 0}, textString = "IN OFFSET")}),
...
It is meant to be used in conjuction to a corresponding <a href=\"modelica://AllamCycle.Components.OffSetBlocks.OutputOffset\">OutputOffset</a> model. 
...
the chosen initialization mode.
  ...
  initial equation
    ...
    assert(not (fixOffset and fixInput), "You can't set fixOffset and fixInput both to true");
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {170, 255, 85},
              fillPattern =                                                                                                                                                           FillPattern.Solid), Text(extent = {{-100, -100}, {100, -140}}, lineColor = {0, 0, 0}, textString = "IN OFFSET")}),
  ...
  model OutputOffset
    ...
    parameter Real y_Offset_fixed = y_fixed "Value of y_Offset if fixedOffset == true"
      annotation(Dialog(enable = fixedOffset));
  ...
  initial equation
    ...
    annotation (
      Icon(                                               graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0}, fillColor = {170, 255, 85},
              fillPattern =                                                                                                                                                           FillPattern.Solid), Text(extent = {{-100, -100}, {100, -140}}, lineColor = {0, 0, 0}, textString = "OUT OFFSET")}),
      Documentation(info="<html>
This block provides initialization conditions, normalizations and offsets for a plant model initialized in steady state. 
It is meant to be used in conjuction to a corresponding <a href=\"modelica://AllamCycle.Components.OffSetBlocks.InputOffset\">InputOffset</a> model. 
It can be used in several ways.</p>

...
<<<<<<<< HEAD:MultiEnergySystem/TestFacility/Loads/Thermal/Systems/CoolingSingleLoadPowerControl.mo
model CoolingSingleLoadPowerControl "Load model including a thermal power control loop"
========
...
<<<<<<<< HEAD:MultiEnergySystem/TestFacility/Loads/Thermal/Systems/CoolingSingleLoadPowerControl.mo
  ...
  parameter Real Kv_TCV(unit = "m3/h") = DistrictHeatingNetwork.Data.ValveData.TCV701.Kv "Metri Flow Coefficient" annotation (
  ...
  parameter DistrictHeatingNetwork.Components.Types.valveOpeningChar openingChar_TCV = DistrictHeatingNetwork.Components.Types.valveOpeningChar.EqualPercentage "opening characteristic" annotation (
    Dialog(tab = "Valve", group = "TCV"));
  parameter DistrictHeatingNetwork.Types.Pressure dp_nom_valve_TCV = DistrictHeatingNetwork.Data.ValveData.TCV701.dp_nom "Pressure drop between supply and return, as imposed by the differential pump" annotation (
    Dialog(tab = "Valve", group = "TCV"));
  parameter DistrictHeatingNetwork.Types.Density rho_nom_valve_TCV = DistrictHeatingNetwork.Data.ValveData.TCV701.rho_nom "Nominal fluid density at supply" annotation (
    Dialog(tab = "Valve", group = "TCV"));
  parameter Real q_m3h_nom_valve_TCV(unit = "m3/h") = DistrictHeatingNetwork.Data.ValveData.TCV701.q_nom_m3h "Nominal volumetric flowrate in m3/h";
  ...
  parameter DistrictHeatingNetwork.Types.Pressure pin_start_valve_TCV = 2e5 annotation (
    Dialog(tab = "Valve", group = "TCV"));
  parameter DistrictHeatingNetwork.Types.Density rho_start_valve_TCV = DistrictHeatingNetwork.Data.ValveData.TCV701.rho_nom "Start value fluid density at the inlet" annotation (
    Dialog(tab = "Valve", group = "TCV"));
  parameter Real q_m3h_start_valve_TCV(unit = "m3/h") = DistrictHeatingNetwork.Data.ValveData.TCV701.q_nom_m3h "Start value volumetric flowrate in m3/h" annotation (
    Dialog(tab = "Valve", group = "TCV"));



  // Controllers' parameters
  parameter Real Kp_TT7X1 = -0.2743;
  parameter Real Ti_TT7X1 = 0.7859;
...
<<<<<<<< HEAD:MultiEnergySystem/TestFacility/Loads/Thermal/Systems/CoolingSingleLoadPowerControl.mo
    ...
    dp_nom=dp_nom_valve_TCV,
    rho_nom=rho_nom_valve_TCV,
    q_m3h_nom=q_m3h_nom_valve_TCV,
...
========
  ...
  Modelica.Blocks.Interfaces.RealInput theta_TCV7X1 "Opening valve" annotation (Placement(
      visible=true,
      transformation(extent={{-63,-95},{-43,-115}}),
...
equation
  ...
  connect(FCV7X1.inlet,PL701_SourceOut_FCV701. outlet) annotation (Line(
      ...
      thickness=0.5));
  connect(PL701_SourceOut_FCV701.inlet,EX7X1. outhot) annotation (Line(
      points={{20,-20},{20,-36.75},{21.3,-36.75}},
      color={140,56,54},
      thickness=0.5));
  connect(FT701.inlet,PL701_FCV701_FT701. outlet) annotation (Line(
      points={{20,71},{20,62}},
  ...
  connect(TT7X2.inlet,PT7X2. inlet) annotation (Line(
      ...
      thickness=0.5));
  connect(PL701_TT702_SourceIn.outlet,EX7X1. inhot) annotation (Line(
      points={{-20,3.55271e-15},{-19.3,3.55271e-15},{-19.3,-36.75}},
      color={140,56,54},
      thickness=0.5));
  connect(PT7X1.inlet,TT7X1. inlet) annotation (Line(
      points={{20,96},{20,86}},
  ...
  connect(TT7X1.inlet,FT701. outlet) annotation (Line(
      ...
      thickness=0.5));
  connect(EX7X1.outcold,TT7X4. inlet) annotation (Line(
      points={{-19.3,-54.25},{-19.6,-54.25},{-19.6,-69}},
      color={140,56,54},
      thickness=0.5));
  connect(TT7X3.inlet,EX7X1. incold) annotation (Line(
      points={{19.6,-70},{19.6,-58.125},{21.3,-58.125},{21.3,-54.25}},
      color={140,56,54},
      thickness=0.5));
  connect(MultiPort, MultiPort) annotation (Line(points={{-110,0},{-110,0}}, color={255,238,44}));
  connect(PL701_TT702_SourceIn1.inlet, TT7X4.inlet) annotation (Line(
      points={{-20,-73},{-20,-71},{-19.6,-71},{-19.6,-69}},
      color={140,56,54},
      thickness=0.5));
  connect(PL701_TT702_SourceIn2.outlet, TT7X3.inlet) annotation (Line(
      points={{20,-80},{20,-75},{19.6,-75},{19.6,-70}},
      color={140,56,54},
      thickness=0.5));
  connect(PL701_TT702_SourceIn2.inlet, incold) annotation (Line(
  ...
  connect(PT7X1.inlet, outhot) annotation (Line(
      ...
      thickness=0.5));
  connect(PL701_TT702_SourceIn1.wall, MultiPort) annotation (Line(
      points={{-24.1,-83},{-40,-83},{-40,0},{-110,0}},
      color={255,101,98},
      thickness=0.5));
  connect(PL701_SourceOut_FCV701.wall, MultiPort) annotation (Line(
      points={{15.9,-10},{-40,-10},{-40,0},{-110,0}},
      color={255,101,98},
      thickness=0.5));
  connect(PL701_TT702_SourceIn.wall, MultiPort) annotation (Line(
  ...
  connect(PT7X1.p, PT7X1_PT) annotation (Line(points={{28.5,96},{30,96},{30,113},{93.5,113},{93.5,75},{110,75}}, color={0,0,127}));
  connect(TT7X1.T, TT7X1_TT) annotation (Line(points={{28.5,86},{31.5,86},{31.5,111.5},{92.5,111.5},{92.5,60},{110,60}}, color={0,0,127}));
  connect(TT7X2.T, TT7X2_TT) annotation (Line(points={{-28.5,66},{-31.5,66},{-31.5,116},{95.5,116},{95.5,105},{110,105}}, color={0,0,127}));
  connect(theta_FCV7X1, FCV7X1.opening) annotation (Line(points={{50,20},{28,20}}, color={0,0,127}));
  connect(TT7X4.T, TT7X4_TT) annotation (Line(points={{-29.8,-69},{-33,-69},{-33,-116},{97,-116},{97,-95},{110,-95}}, color={0,0,127}));
  connect(TT7X3.T, TT7X3_TT) annotation (Line(points={{29.8,-70},{30,-70},{30,-115},{96,-115},{96,-75},{110,-75}}, color={0,0,127}));
  connect(PL701_FCV701_FT701.wall, MultiPort) annotation (Line(
      points={{15.9,52},{3,52},{3,-16},{-40,-16},{-40,0},{-110,0}},
      color={255,101,98},
      thickness=0.5));
  connect(FT701.m_flow, FT7X1_FT) annotation (Line(points={{25,77.5},{25,79},{33,79},{33,110},{91,110},{91,45},{110,45}}, color={0,0,127}));
  connect(PL701_TT702_SourceIn1.outlet, TCV7X1.inlet) annotation (Line(
      points={{-20,-93},{-20,-100}},
      color={140,56,54},
      thickness=0.5));
  connect(TCV7X1.outlet, outcold) annotation (Line(
      points={{-20,-110},{-20,-130}},
      color={140,56,54},
      thickness=0.5));
  connect(theta_TCV7X1, TCV7X1.opening) annotation (Line(points={{-53,-105},{-24,-105}}, color={0,0,127}));

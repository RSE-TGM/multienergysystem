...
package Configurations "Different possible configurations of the heat generating part of the network"
  ...
  package BaseClass "Package with different base models for the possible configurations"
    ...
    partial model CentralPlantBaseII "Base Case considering rack CD and the pipelines connecting to the loads"
      ...
      Systems.ConnectorTypeI rackL3L4(
        redeclare model Medium = MediumCP,
        hctype=hctype,
        n=n,
    ...
    partial model CentralPlantBaseSimplified "Base Case considering rack CD and the pipelines connecting to the loads"
      ...
      DistrictHeatingNetwork.Sources.SourcePressure VE901(p0 = p_VE901, T0(displayUnit = "K") = 30 + 273.15) annotation (
        Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 0, origin = {-849, 131})));
      MultiEnergySystem.DistrictHeatingNetwork.Components.TurboMachines.PrescribedPump P901(Tin_start = TestFacility.Data.PumpData.P901.Tin_start, Tout_start = TestFacility.Data.PumpData.P901.Tout_start, hin_start = TestFacility.Data.PumpData.P901.hin_start, pin_start = pin_start_S9, pout_start = pout_start_S9, a = TestFacility.Data.PumpData.P901.a, b = TestFacility.Data.PumpData.P901.b, dpnom = TestFacility.Data.PumpData.P901.dpnom, etaelec = TestFacility.Data.PumpData.P901.etaelec, etamech = TestFacility.Data.PumpData.P901.etamech, etanom = TestFacility.Data.PumpData.P901.etanom, headnom = TestFacility.Data.PumpData.P901.headnom, headmax = TestFacility.Data.PumpData.P901.headnommax, headmin = TestFacility.Data.PumpData.P901.headnommin, m_flow_nom = TestFacility.Data.PumpData.P901.m_flow_nom, omeganom = TestFacility.Data.PumpData.P901.omeganom, qnom_inm3h = TestFacility.Data.PumpData.P901.qnom_inm3h, qnom_inm3h_min = TestFacility.Data.PumpData.P901.qnommin_inm3h, rhonom(displayUnit = "kg/m3") = TestFacility.Data.PumpData.P901.rhonom, qnom_inm3h_max = TestFacility.Data.PumpData.P901.qnommax_inm3h, use_in_omega = true) annotation (
        Placement(visible = true, transformation(extent = {{-20.5, 20.5}, {20.5, -20.5}}, rotation = 90, origin = {-757.5, 74.5})));
      ...
      MultiEnergySystem.DistrictHeatingNetwork.Components.Pipes.RoundPipe1DFV PL2_S901(L = L_S9_PL2, h = h_S9_PL2, t = t_S9, pin_start = pin_start_S9, Tin_start = Tin_start_S9, Tout_start = Tin_start_S9, Di = Di_S9, q_m3h_start = q_m3h_S9, n = n, hctype = hctype) annotation (
        Placement(transformation(extent = {{10, -10}, {-10, 10}}, rotation = 90, origin = {-808, 101})));
      MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCV901(Kv = TestFacility.Data.ValveData.FCV901.Kv, dp_nom(displayUnit = "Pa") = TestFacility.Data.ValveData.FCV901.dp_nom, openingChar = MultiEnergySystem.DistrictHeatingNetwork.Components.Types.valveOpeningChar.SquareRoot, rho_nom = TestFacility.Data.ValveData.FCV901.rho_nom, q_m3h_nom = TestFacility.Data.ValveData.FCV901.q_nom_m3h, Tin_start(displayUnit = "K") = Tout_start_S9, pin_start = pout_start_S9, q_m3h_start = q_m3h_S9) annotation (
      ...
      MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientOnOffValve FV933(Kv = 33, dp_nom = 50000, Tin_start = T_start, pin_start = pin_start) annotation (
        Placement(visible = true, transformation(origin = {-218, 45}, extent = {{-5, 5}, {5, -5}}, rotation = 180)));
      MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCVC02(Kv = TestFacility.Data.ValveData.FCVC02.Kv, dp_nom(displayUnit = "Pa") = dp_nom_UsersValve, Tin_start(displayUnit = "K") = T_start_hot, pin_start = 200000, q_m3h_start = q_m3h_rackHot) annotation (
        Placement(transformation(extent = {{10, -10}, {-10, 10}}, rotation = -90, origin = {690, 235})));
      MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCVC01(Kv = TestFacility.Data.ValveData.FCVC01.Kv, dp_nom(displayUnit = "Pa") = dp_nom_UsersValve, Tin_start(displayUnit = "K") = 60 + 273.15, pin_start = 200000) annotation (
        Placement(transformation(extent = {{10, -10}, {-10, 10}}, rotation = -90, origin = {250, 235})));

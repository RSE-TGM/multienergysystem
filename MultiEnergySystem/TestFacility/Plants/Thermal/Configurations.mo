...
package Configurations "Different possible configurations of the heat generating part of the network"
  ...
  package BaseClass "Package with different base models for the possible configurations"
    ...
    partial model CentralPlantBase "Base Case considering rack CD and the pipelines connecting to the loads"
      ...
      DistrictHeatingNetwork.Sources.SourcePressure VE901(redeclare model Medium = MediumCP, p0 = p_VE901,
        T0(displayUnit="K") = T_start_cold,
        R=1e-3)                                                                                                                                 annotation (
      ...
      MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCVC02(redeclare model Medium = MediumCP, Kv = DistrictHeatingNetwork.Data.ValveData.FCVC02.Kv,
        openingChar=DistrictHeatingNetwork.Data.ValveData.FCVC02.openingChar,                                                                                                         dp_nom(displayUnit = "Pa") = dp_nom_UsersValve, Tin_start(displayUnit = "K") = T_start_hot,
        pin_start=200000,                                                                                                                                                                                                        q_m3h_start = q_m3h_rackHot) annotation (
        Placement(transformation(extent = {{10, -10}, {-10, 10}}, rotation = -90, origin = {690, 235})));
      MultiEnergySystem.DistrictHeatingNetwork.Components.Valves.FlowCoefficientValve FCVC01(redeclare model Medium = MediumCP, Kv = DistrictHeatingNetwork.Data.ValveData.FCVC01.Kv,
        openingChar=DistrictHeatingNetwork.Data.ValveData.FCVC01.openingChar,                                                                                                         dp_nom(displayUnit = "Pa") = dp_nom_UsersValve, Tin_start(displayUnit = "K") = 60 + 273.15,

...
package Configurations
  "Different possible configurations of the heat generating part of the network"
  ...
  package BaseClass "Package with different base models for the possible configurations"
    ...
    partial model CentralPlantBaseSimplified
      "Base Case considering rack CD and the pipelines connecting to the loads"
    ...
    equation
      ...
      connect(VE901.outlet, PT901.inlet) annotation (Line(
          ...
          color={140,56,54},
          thickness=0.5));
      connect(FV933.outlet, rackCD_Hot_S200_S900.inlet) annotation (Line(
          points={{-223,45},{-475,45},{-475,44.75},{-727,44.75}},
          color={140,56,54},
          thickness=0.5));
      connect(rackCD_Cold_S900_S200.outlet, FV933.inlet) annotation (Line(
          points={{-716.5,5.25},{-200,5.25},{-200,45},{-213,45}},
          color={140,56,54},
          thickness=0.5));
      annotation (
        Diagram(coordinateSystem(extent={{-900,-500},{900,320}}), graphics={

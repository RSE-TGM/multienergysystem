...
model CirculationPump
  DistrictHeatingNetwork.Sources.SourcePressure VE901(p0=p_VE901, T0(displayUnit="K") = 30 + 273.15)
  ...
  DistrictHeatingNetwork.Components.TurboMachines.PrescribedPump                   P901(
    ...
    Placement(visible = true, transformation(                 extent={{-10,10},{10,-10}},      rotation=90,
        origin={20,-42})));
  DistrictHeatingNetwork.Sensors.IdealMassFlowSensor                   FT901(T_start=Tout_start_S9,
  ...
  DistrictHeatingNetwork.Interfaces.FluidPortInlet fluidPortInlet
    annotation (Placement(transformation(extent={{15,-85},{25,-75}}), iconTransformation(extent={{
            15,-85},{25,-75}})));
  DistrictHeatingNetwork.Interfaces.FluidPortInlet fluidPortInlet1
    annotation (Placement(transformation(extent={{-25,74},{-15,84}}), iconTransformation(extent={{
            -25,74},{-15,84}})));
  DistrictHeatingNetwork.Interfaces.FluidPortOutlet fluidPortOutlet
    annotation (Placement(transformation(extent={{-25,-85},{-15,-75}}), iconTransformation(extent={
            {-25,-85},{-15,-75}})));
  DistrictHeatingNetwork.Interfaces.FluidPortOutlet fluidPortOutlet1
    annotation (Placement(transformation(extent={{15,75},{25,85}}), iconTransformation(extent={{15,
            75},{25,85}})));
equation
  ...
  connect(PT901.inlet,TT901. inlet) annotation (Line(
      points={{-20,30.5},{-20,35.375},{-19.85,35.375},{-19.85,68.25}},
      color={140,56,54},
      thickness=0.5));
  ...
  connect(VE901.outlet,PT901. inlet) annotation (Line(
      ...
      color={140,56,54},
      thickness=0.5));
  connect(TT902.inlet, fluidPortOutlet1) annotation (Line(
      points={{21.35,68.25},{20,68.25},{20,80}},
      color={140,56,54},
      thickness=0.5));
  connect(TT901.inlet, fluidPortInlet1) annotation (Line(
      points={{-19.85,68.25},{-20,68.25},{-20,79}},
      color={140,56,54},
      thickness=0.5));
  connect(PL2_S901.outlet, fluidPortOutlet)
    annotation (Line(
      points={{-20,-41},{-20,-66},{-20,-80},{-20,-80}},
      color={140,56,54},
      thickness=0.5));
  connect(P901.inlet, fluidPortInlet) annotation (Line(
      points={{20,-50},{20,-80}},
      color={140,56,54},
      thickness=0.5));
  annotation (Icon(coordinateSystem(grid={1,1}), graphics={
                     Rectangle(lineColor = {140, 56, 54}, fillColor = {192, 80, 77}, fillPattern=
              FillPattern.Solid,                                                                                        extent={{-60,80},
              {60,-80}},
          radius=15),                                                                                                                                     Ellipse(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent={{-40,40},
              {40,-40}}),                                                                                                                                                                                                        Text(origin={-174,0},  textColor = {140, 56, 54}, extent={{100,-74},
              {-100,-114}},                                                                                                                                                                                                        textString = "%name",
          rotation=90),                                                                                                                                                                                                        Ellipse(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent={{-40,40},
              {40,-40}}),
        Bitmap(
          extent={{-36,-45},{36,45}},
          origin={-4,0},

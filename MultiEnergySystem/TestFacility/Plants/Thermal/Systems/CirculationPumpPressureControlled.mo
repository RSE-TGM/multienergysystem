...
model CirculationPumpPressureControlled
 extends TestFacility.Interfaces.SystemInterfaceBaseV(MultiPort(n=n));
...
//   parameter DistrictHeatingNetwork.Types.Length L_rCD_H7 = 15;
  ...
  DistrictHeatingNetwork.Components.TurboMachines.ControlledPump P901(
    ...
    correctionfactor=pumpcorrectionfactor)                                                   annotation (
...
equation
  ...
  connect(rCD_S900.inlet, inlethot) annotation (Line(
      ...
      color={140,56,54},
      thickness=0.5));
  connect(PL_S900_P901_FCV901.outlet, FT.inlet) annotation (Line(
      points={{20,0},{20,17.8},{20.4,17.8},{20.4,35.6}},
      color={140,56,54},
      thickness=0.5));
  connect(m_flow_set, P901.in_m_flow) annotation (Line(points={{-110,50},{-90,50},{-90,52},{2,52},{2,-40},{15.4,-40}}, color={0,0,127}));
...
end CirculationPumpPressureControlled;

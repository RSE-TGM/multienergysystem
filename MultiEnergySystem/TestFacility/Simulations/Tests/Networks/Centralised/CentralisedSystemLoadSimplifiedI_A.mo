...
model CentralisedSystemLoadSimplifiedI_A "Sequence using Gas Boiler as heat source only"
  ...
  Modelica.Blocks.Sources.TimeTable TT733_(table=EX731_TinCold)
    annotation (Placement(transformation(extent={{348,-280},{328,-260}})));
  Modelica.Blocks.Sources.TimeTable TT723_(table=EX721_TinCold)
    annotation (Placement(transformation(extent={{672,-280},{652,-260}})));
  Modelica.Blocks.Sources.TimeTable TT713_(table=EX711_TinCold)
...
equation
  ...
  connect(FT713_.y, FT713.in_m_flow)
    annotation (Line(points={{391,-330},{400,-330},{400,-305}},
                                                            color={0,0,127}));

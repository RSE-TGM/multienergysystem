  ...
  package Networks
    ...
    package Centralised
      ...
      model TestCentralised
        ...
        replaceable Control.OpenLoopActuators.OLA_ThreeGenTES_Case_A_III openLoopActuatorBase_III annotation (
...
Act")}),  Diagram(coordinateSystem(extent = {{-160, -200}, {160, 200}}, grid = {1, 1}), graphics={  Rectangle(extent = {{-150, 190}, {-80, 90}}, fillColor = {255, 200, 160}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Text(extent = {{-145, 190}, {-85, 170}}, textString = "S900", textColor = {0, 0, 0}), Rectangle(extent = {{-150, 80}, {-80, -50}}, fillColor = {255, 200, 160}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Text(extent = {{-145, 80}, {-85, 60}}, textColor = {0, 0, 0}, textString = "S100"), Rectangle(extent = {{-60, 190}, {10, 36}}, fillColor = {255, 200, 160}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Text(extent = {{-55, 190}, {5, 170}}, textColor = {0, 0, 0}, textString = "S700"), Rectangle(extent = {{-60, 30}, {10, -60}}, fillColor = {255, 200, 160}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Text(extent = {{-56, 28}, {4, 8}}, textColor = {0, 0, 0}, textString = "RACK"), Rectangle(extent = {{30, 190}, {100, -30}}, fillColor = {255, 200, 160}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Text(extent = {{34, 190}, {94, 170}}, textColor = {0, 0, 0}, textString = "RR00")}));
    ...
    package StepResponse "Package to evaluate step responses in the system"
      ...
      model StepResponseBase
        ...
        replaceable OpenLoopActuators.OLA_OneGen_CaseA actuator annotation (
          Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
        replaceable Export.Linearization.CentralisedSystemGB_InitForward plant annotation (
      ...
      model SR_OneGen_CaseA "This test model considers the step response using as a base the generating plant with Gas Boiler, Electric Boiler & CHP as heat generators"
        ...
        annotation (
          experiment(StopTime = 5000, Tolerance = 1e-06, __Dymola_Algorithm = "Dassl"));
      end SR_OneGen_CaseA;
      ...
      model SR_TwoGen_CaseA "This test model considers the step response using as a base the generating plant with Gas Boiler & Electric Boiler as heat generators"
        extends SR_OneGen_CaseA(redeclare replaceable OpenLoopActuators.OLA_TwoGen_CaseA actuator(useRealExpression = false, dtheta_FCVC01 = [0, -1; 1e6, -1], dtheta_FCVC02 = [0, -1; 1e6, -1], domega_P901 = [0, (f_P901 - 50)/50; 1e3, (f_P901 - 50)/50; 1e3, (f_P901 - 50 + f_P901_delta)/50; 1e6, (f_P901 - 50 + f_P901_delta)/50], dtheta_FCV901 = [0, 0; 1e6, 0], dTout_GB101 = [0, 0; 1e6, 0], domega_P101 = [0, (f_P101 - 50)/50; 1e3, (f_P101 - 50)/50; 1e3, (f_P101 - 50 + f_P101_delta)/50; 1e6, (f_P101 - 50 + f_P101_delta)/50], dtheta_FCV101 = [0, 0; 1e6, 0], dtheta_FCV701 = [0, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1 + theta_FCV701_delta)/1; 1e6, (theta_FCV701 - 1 + theta_FCV701_delta)/1], dtheta_FCV711 = [0, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1 + theta_FCV711_delta)/1; 1e6, (theta_FCV711 - 1 + theta_FCV711_delta)/1], dtheta_FCV721 = [0, 0; 1e6, 0], dtheta_FCV731 = [0, 0; 1e6, 0], dtheta_TCV701 = [0, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1 + theta_TCV701_delta)/1; 1e6, (theta_TCV701 - 1 + theta_TCV701_delta)/1], dtheta_TCV711 = [0, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1 + theta_TCV711_delta)/1; 1e6, (theta_TCV711 - 1 + theta_TCV711_delta)/1], dtheta_TCV721 = [0, 0; 1e6, 0], dtheta_TCV731 = [0, 0; 1e6, 0], dtheta_FCVR01 = [0, 0; 1e6, 0], dTout_RR01 = [0, (Tout_RR01 - 15)/(100 + 273.15); 1e6, (Tout_RR01 - 15)/(100 + 273.15)], domega_P401 = [0, (f_P401 - 50)/50; 1e3, (f_P401 - 50)/50; 1e3, (f_P401 - 50 + f_P401_delta)/50; 1e6, (f_P401 - 50 + f_P401_delta)/50], dtheta_FCV401 = [0, 0; 1e6, 0]), redeclare replaceable Export.Linearization.CentralisedSystemGBEB_InitForward plant(thetaFCVC01Offset(fixInput = false, fixOffset = true), thetaFCVC02Offset(fixInput = false, fixOffset = true), thetaFCV901Offset(fixInput = false, fixOffset = true), thetaFCV101Offset(fixInput = false, fixOffset = true), thetaTCV701Offset(fixInput = false, fixOffset = true), thetaTCV711Offset(fixInput = false, fixOffset = true), omegaP901Offset(fixInput = false, fixOffset = true), omegaP101Offset(fixInput = false, fixOffset = true), ToutRR01Offset(fixInput = false, fixOffset = true), TTR02_nom = 100 + 273.15, thetaFCV401Offset(fixInput = false, fixOffset = true), omegaP401Offset(fixInput = false, fixOffset = true)), f_P101 = 30);
      ...
      model SR_ThreeGen_CaseA "This test model considers the step response using as a base the generating plant with Gas Boiler, Electric Boiler & CHP as heat generators"
        extends SR_TwoGen_CaseA(redeclare replaceable OpenLoopActuators.OLA_ThreeGen_CaseA actuator(useRealExpression = false, dtheta_FCVC01 = [0, -1; 1e6, -1], dtheta_FCVC02 = [0, -1; 1e6, -1], domega_P901 = [0, (f_P901 - 50)/50; 1e3, (f_P901 - 50)/50; 1e3, (f_P901 - 50 + f_P901_delta)/50; 1e6, (f_P901 - 50 + f_P901_delta)/50], dtheta_FCV901 = [0, 0; 1e6, 0], dTout_GB101 = [0, 0; 1e6, 0], domega_P101 = [0, (f_P101 - 50)/50; 1e3, (f_P101 - 50)/50; 1e3, (f_P101 - 50 + f_P101_delta)/50; 1e6, (f_P101 - 50 + f_P101_delta)/50], dtheta_FCV101 = [0, 0; 1e6, 0], dtheta_FCV701 = [0, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1 + theta_FCV701_delta)/1; 1e6, (theta_FCV701 - 1 + theta_FCV701_delta)/1], dtheta_FCV711 = [0, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1 + theta_FCV711_delta)/1; 1e6, (theta_FCV711 - 1 + theta_FCV711_delta)/1], dtheta_FCV721 = [0, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1 + theta_FCV721_delta)/1; 1e6, (theta_FCV721 - 1 + theta_FCV721_delta)/1], dtheta_FCV731 = [0, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1 + theta_FCV731_delta)/1; 1e6, (theta_FCV731 - 1 + theta_FCV731_delta)/1], dtheta_TCV701 = [0, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1 + theta_TCV701_delta)/1; 1e6, (theta_TCV701 - 1 + theta_TCV701_delta)/1], dtheta_TCV711 = [0, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1 + theta_TCV711_delta)/1; 1e6, (theta_TCV711 - 1 + theta_TCV711_delta)/1], dtheta_TCV721 = [0, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1 + theta_TCV721_delta)/1; 1e6, (theta_TCV721 - 1 + theta_TCV721_delta)/1], dtheta_TCV731 = [0, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1 + theta_TCV731_delta)/1; 1e6, (theta_TCV731 - 1 + theta_TCV731_delta)/1], dtheta_FCVR01 = [0, 0; 1e6, 0], dTout_RR01 = [0, (Tout_RR01 - 15)/(100 + 273.15); 1e6, (Tout_RR01 - 15)/(100 + 273.15)], domega_P401 = [0, (f_P401 - 50)/50; 1e3, (f_P401 - 50)/50; 1e3, (f_P401 - 50 + f_P401_delta)/50; 1e6, (f_P401 - 50 + f_P401_delta)/50], dtheta_FCV401 = [0, 0; 1e6, 0], domega_P501 = [0, (f_P501 - 50)/50; 1e3, (f_P501 - 50)/50; 1e3, (f_P501 - 50 + f_P501_delta)/50; 1e6, (f_P501 - 50 + f_P501_delta)/50]), redeclare replaceable Export.Linearization.CentralisedSystemGBEBCHP_InitForward plant(h_FT701_rackL2L3 = -0.85, h_FT711_rackL3L4 = -1, h_FT721_rackL4L5 = -1, h_FT731_rackL6L7 = -1.25, thetaFCVC01Offset(fixInput = false, fixOffset = true), thetaFCVC02Offset(fixInput = false, fixOffset = true), thetaFCV901Offset(fixInput = false, fixOffset = true), thetaFCV101Offset(fixInput = false, fixOffset = true), thetaTCV701Offset(fixInput = false, fixOffset = true), thetaTCV711Offset(fixInput = false, fixOffset = true), thetaTCV721Offset(fixInput = false, fixOffset = true), thetaTCV731Offset(fixInput = false, fixOffset = true), omegaP901Offset(fixInput = false, fixOffset = true), omegaP101Offset(fixInput = false, fixOffset = true), ToutRR01Offset(fixInput = false, fixOffset = true), TTR02_nom = 373.15, thetaFCV401Offset(fixInput = false, fixOffset = true), omegaP401Offset(fixInput = false, fixOffset = true), omegaP501Offset(fixInput = false, fixOffset = true), S500(PL_S500_P501_PT501(h = 2.05*0)), S900(h_FCV901_PT902 = 2.5*0.1), PL_S500_rCD_hot(h = 3*0), PL_S400_rCD_hot(h = 1.2*0)), theta_TCV701 = 1, theta_TCV711 = 1, theta_TCV721 = 1, theta_TCV731 = 1, f_P901 = 30, f_P101 = 30, f_P401 = 30, f_P101_delta = 0);
...
System")}),
      ...
      model ControllerBaseIV
        extends ControllerBaseIII;
      end ControllerBaseIV;
...
System")}),
    ...
    package ControlledPlants
      partial model PlantControlBase
        extends Modelica.Icons.Example;
        replaceable Controllers.ControllerBase controller(useRealExpression = false, dtheta_FCVC01 = [0, -1; 1e6, -1], dtheta_FCVC02 = [0, -1; 1e6, -1], domega_P901 = [0, (f_P901 - 50)/50; 1e3, (f_P901 - 50)/50; 1e3, (f_P901 - 50 + f_P901_delta)/50; 1e6, (f_P901 - 50 + f_P901_delta)/50], dtheta_FCV901 = [0, 0; 1e6, 0], dTout_GB101 = [0, 0; 1e6, 0], domega_P101 = [0, (f_P101 - 50)/50; 1e3, (f_P101 - 50)/50; 1e3, (f_P101 - 50 + f_P101_delta)/50; 1e6, (f_P101 - 50 + f_P101_delta)/50], dtheta_FCV101 = [0, 0; 1e6, 0], dtheta_FCV701 = [0, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1 + theta_FCV701_delta)/1; 1e6, (theta_FCV701 - 1 + theta_FCV701_delta)/1], dtheta_FCV711 = [0, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1 + theta_FCV711_delta)/1; 1e6, (theta_FCV711 - 1 + theta_FCV711_delta)/1], dtheta_FCV721 = [0, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1 + theta_FCV721_delta)/1; 1e6, (theta_FCV721 - 1 + theta_FCV721_delta)/1], dtheta_FCV731 = [0, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1 + theta_FCV731_delta)/1; 1e6, (theta_FCV731 - 1 + theta_FCV731_delta)/1], dtheta_TCV701 = [0, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1 + theta_TCV701_delta)/1; 1e6, (theta_TCV701 - 1 + theta_TCV701_delta)/1], dtheta_TCV711 = [0, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1 + theta_TCV711_delta)/1; 1e6, (theta_TCV711 - 1 + theta_TCV711_delta)/1], dtheta_TCV721 = [0, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1 + theta_TCV721_delta)/1; 1e6, (theta_TCV721 - 1 + theta_TCV721_delta)/1], dtheta_TCV731 = [0, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1 + theta_TCV731_delta)/1; 1e6, (theta_TCV731 - 1 + theta_TCV731_delta)/1], dtheta_FCVR01 = [0, 0; 1e6, 0], dTout_RR01 = [0, (Tout_RR01 - 15)/(100 + 273.15); 1e6, (Tout_RR01 - 15)/(100 + 273.15)], domega_P401 = [0, (f_P401 - 50)/50; 1e3, (f_P401 - 50)/50; 1e3, (f_P401 - 50 + f_P401_delta)/50; 1e6, (f_P401 - 50 + f_P401_delta)/50], dtheta_FCV401 = [0, 0; 1e6, 0], domega_P501 = [0, (f_P501 - 50)/50; 1e3, (f_P501 - 50)/50; 1e3, (f_P501 - 50 + f_P501_delta)/50; 1e6, (f_P501 - 50 + f_P501_delta)/50]) annotation (
          Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
      ...
      partial model PlantControlBaseII
        extends Modelica.Icons.Example;
        replaceable Controllers.ControllerBaseII controller(useRealExpression = false, dtheta_FCVC01 = [0, -1; 1e6, -1], dtheta_FCVC02 = [0, -1; 1e6, -1], domega_P901 = [0, (f_P901 - 50)/50; 1e3, (f_P901 - 50)/50; 1e3, (f_P901 - 50 + f_P901_delta)/50; 1e6, (f_P901 - 50 + f_P901_delta)/50], dtheta_FCV901 = [0, 0; 1e6, 0], dTout_GB101 = [0, 0; 1e6, 0], domega_P101 = [0, (f_P101 - 50)/50; 1e3, (f_P101 - 50)/50; 1e3, (f_P101 - 50 + f_P101_delta)/50; 1e6, (f_P101 - 50 + f_P101_delta)/50], dtheta_FCV101 = [0, 0; 1e6, 0], dtheta_FCV701 = [0, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1 + theta_FCV701_delta)/1; 1e6, (theta_FCV701 - 1 + theta_FCV701_delta)/1], dtheta_FCV711 = [0, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1 + theta_FCV711_delta)/1; 1e6, (theta_FCV711 - 1 + theta_FCV711_delta)/1], dtheta_FCV721 = [0, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1 + theta_FCV721_delta)/1; 1e6, (theta_FCV721 - 1 + theta_FCV721_delta)/1], dtheta_FCV731 = [0, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1 + theta_FCV731_delta)/1; 1e6, (theta_FCV731 - 1 + theta_FCV731_delta)/1], dtheta_TCV701 = [0, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1 + theta_TCV701_delta)/1; 1e6, (theta_TCV701 - 1 + theta_TCV701_delta)/1], dtheta_TCV711 = [0, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1 + theta_TCV711_delta)/1; 1e6, (theta_TCV711 - 1 + theta_TCV711_delta)/1], dtheta_TCV721 = [0, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1 + theta_TCV721_delta)/1; 1e6, (theta_TCV721 - 1 + theta_TCV721_delta)/1], dtheta_TCV731 = [0, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1 + theta_TCV731_delta)/1; 1e6, (theta_TCV731 - 1 + theta_TCV731_delta)/1], dtheta_FCVR01 = [0, 0; 1e6, 0], dTout_RR01 = [0, (Tout_RR01 - 15)/(100 + 273.15); 1e6, (Tout_RR01 - 15)/(100 + 273.15)], domega_P401 = [0, (f_P401 - 50)/50; 1e3, (f_P401 - 50)/50; 1e3, (f_P401 - 50 + f_P401_delta)/50; 1e6, (f_P401 - 50 + f_P401_delta)/50], dtheta_FCV401 = [0, 0; 1e6, 0], domega_P501 = [0, (f_P501 - 50)/50; 1e3, (f_P501 - 50)/50; 1e3, (f_P501 - 50 + f_P501_delta)/50; 1e6, (f_P501 - 50 + f_P501_delta)/50]) annotation (
          Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
        replaceable Export.Linearization.CentralisedSystemGBEBCHP_InitForward plant(TT701Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT711Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT721Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT731Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), EX701PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX711PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX721PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX731PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), thetaFCV701Offset(fixInput = false, fixOffset = true), thetaFCV711Offset(fixInput = false, fixOffset = true), thetaFCV721Offset(fixInput = false, fixOffset = true), thetaFCV731Offset(fixInput = false, fixOffset = true), thetaFCVC01Offset(fixInput = false, fixOffset = true), thetaFCVC02Offset(fixInput = false, fixOffset = true), thetaFCV901Offset(fixInput = false, fixOffset = true), thetaFCV101Offset(fixInput = false, fixOffset = true), thetaTCV701Offset(fixInput = false, fixOffset = true), thetaTCV711Offset(fixInput = false, fixOffset = true), thetaTCV721Offset(fixInput = false, fixOffset = true), thetaTCV731Offset(fixInput = false, fixOffset = true), omegaP901Offset(fixInput = false, fixOffset = true), omegaP101Offset(fixInput = false, fixOffset = true), ToutRR01Offset(fixInput = false, fixOffset = true), TTR02_nom = 373.15, thetaFCV401Offset(fixInput = false, fixOffset = true), omegaP401Offset(fixInput = false, fixOffset = true), omegaP501Offset(fixInput = false, fixOffset = true), S500(PL_S500_P501_PT501(h = 2.05*0)), S900(h_FCV901_PT902 = 2.5*0.1), PL_S500_rCD_hot(h = 3*0), PL_S400_rCD_hot(h = 1.2*0)) annotation (
          Placement(transformation(origin = {-1, 0}, extent = {{11, -38}, {55, 38}})));
        //thetaTCV701Offset(fixInput=false, fixOffset=true),
        //thetaTCV701Offset(fixInput=false, fixOffset=true),
        //
      ...
      partial model PlantControlBaseIII
        extends Modelica.Icons.Example;
        replaceable Controllers.ControllerBaseIII controller(useRealExpression = false, dtheta_FCVC01 = [0, -1; 1e6, -1], dtheta_FCVC02 = [0, -1; 1e6, -1], domega_P901 = [0, (f_P901 - 50)/50; 1e3, (f_P901 - 50)/50; 1e3, (f_P901 - 50 + f_P901_delta)/50; 1e6, (f_P901 - 50 + f_P901_delta)/50], dtheta_FCV901 = [0, 0; 1e6, 0], dTout_GB101 = [0, 0; 1e6, 0], domega_P101 = [0, (f_P101 - 50)/50; 1e3, (f_P101 - 50)/50; 1e3, (f_P101 - 50 + f_P101_delta)/50; 1e6, (f_P101 - 50 + f_P101_delta)/50], dtheta_FCV101 = [0, 0; 1e6, 0], dtheta_FCV701 = [0, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1 + theta_FCV701_delta)/1; 1e6, (theta_FCV701 - 1 + theta_FCV701_delta)/1], dtheta_FCV711 = [0, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1 + theta_FCV711_delta)/1; 1e6, (theta_FCV711 - 1 + theta_FCV711_delta)/1], dtheta_FCV721 = [0, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1 + theta_FCV721_delta)/1; 1e6, (theta_FCV721 - 1 + theta_FCV721_delta)/1], dtheta_FCV731 = [0, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1 + theta_FCV731_delta)/1; 1e6, (theta_FCV731 - 1 + theta_FCV731_delta)/1], dtheta_TCV701 = [0, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1 + theta_TCV701_delta)/1; 1e6, (theta_TCV701 - 1 + theta_TCV701_delta)/1], dtheta_TCV711 = [0, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1 + theta_TCV711_delta)/1; 1e6, (theta_TCV711 - 1 + theta_TCV711_delta)/1], dtheta_TCV721 = [0, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1 + theta_TCV721_delta)/1; 1e6, (theta_TCV721 - 1 + theta_TCV721_delta)/1], dtheta_TCV731 = [0, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1 + theta_TCV731_delta)/1; 1e6, (theta_TCV731 - 1 + theta_TCV731_delta)/1], dtheta_FCVR01 = [0, 0; 1e6, 0], dTout_RR01 = [0, (Tout_RR01 - 15)/(100 + 273.15); 1e6, (Tout_RR01 - 15)/(100 + 273.15)], domega_P401 = [0, (f_P401 - 50)/50; 1e3, (f_P401 - 50)/50; 1e3, (f_P401 - 50 + f_P401_delta)/50; 1e6, (f_P401 - 50 + f_P401_delta)/50], dtheta_FCV401 = [0, 0; 1e6, 0], domega_P501 = [0, (f_P501 - 50)/50; 1e3, (f_P501 - 50)/50; 1e3, (f_P501 - 50 + f_P501_delta)/50; 1e6, (f_P501 - 50 + f_P501_delta)/50]) annotation (
          Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
        replaceable Export.Linearization.CentralisedSystemGBEBCHP_InitForward plant(TT701Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT711Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT721Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT731Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), EX701PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX711PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX721PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX731PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), thetaFCV701Offset(fixInput = false, fixOffset = true), thetaFCV711Offset(fixInput = false, fixOffset = true), thetaFCV721Offset(fixInput = false, fixOffset = true), thetaFCVC01Offset(fixInput = false, fixOffset = true), thetaFCVC02Offset(fixInput = false, fixOffset = true), thetaFCV901Offset(fixInput = false, fixOffset = true), thetaFCV101Offset(fixInput = false, fixOffset = true), thetaTCV701Offset(fixInput = false, fixOffset = true), thetaTCV711Offset(fixInput = false, fixOffset = true), thetaTCV721Offset(fixInput = false, fixOffset = true), thetaTCV731Offset(fixInput = false, fixOffset = true), omegaP901Offset(fixInput = false, fixOffset = true), omegaP101Offset(fixInput = false, fixOffset = true), ToutRR01Offset(fixInput = false, fixOffset = true), TTR02_nom = 373.15, thetaFCV401Offset(fixInput = false, fixOffset = true), omegaP401Offset(fixInput = false, fixOffset = true), omegaP501Offset(fixInput = false, fixOffset = true), S500(PL_S500_P501_PT501(h = 2.05)), S900(h_FCV901_PT902 = 2.5), PL_S500_rCD_hot(h = 3), PL_S400_rCD_hot(h = 1.2)) annotation (
          Placement(transformation(origin = {-1, 0}, extent = {{11, -38}, {55, 38}})));
        //thetaTCV701Offset(fixInput=false, fixOffset=true),
      ...
      partial model PlantControlBaseIV
        extends Modelica.Icons.Example;
        replaceable Controllers.FlowsController controller(useRealExpression = false, dtheta_FCVC01 = [0, -1; 1e6, -1], dtheta_FCVC02 = [0, -1; 1e6, -1], domega_P901 = [0, (f_P901 - 50)/50; 1e3, (f_P901 - 50)/50; 1e3, (f_P901 - 50 + f_P901_delta)/50; 1e6, (f_P901 - 50 + f_P901_delta)/50], dtheta_FCV901 = [0, 0; 1e6, 0], dTout_GB101 = [0, 0; 1e6, 0], domega_P101 = [0, (f_P101 - 50)/50; 1e3, (f_P101 - 50)/50; 1e3, (f_P101 - 50 + f_P101_delta)/50; 1e6, (f_P101 - 50 + f_P101_delta)/50], dtheta_FCV101 = [0, 0; 1e6, 0], dtheta_FCV701 = [0, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1)/1; 1e3, (theta_FCV701 - 1 + theta_FCV701_delta)/1; 1e6, (theta_FCV701 - 1 + theta_FCV701_delta)/1], dtheta_FCV711 = [0, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1)/1; 1e3, (theta_FCV711 - 1 + theta_FCV711_delta)/1; 1e6, (theta_FCV711 - 1 + theta_FCV711_delta)/1], dtheta_FCV721 = [0, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1)/1; 1e3, (theta_FCV721 - 1 + theta_FCV721_delta)/1; 1e6, (theta_FCV721 - 1 + theta_FCV721_delta)/1], dtheta_FCV731 = [0, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1)/1; 1e3, (theta_FCV731 - 1 + theta_FCV731_delta)/1; 1e6, (theta_FCV731 - 1 + theta_FCV731_delta)/1], dtheta_TCV701 = [0, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1)/1; 1e3, (theta_TCV701 - 1 + theta_TCV701_delta)/1; 1e6, (theta_TCV701 - 1 + theta_TCV701_delta)/1], dtheta_TCV711 = [0, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1)/1; 1e3, (theta_TCV711 - 1 + theta_TCV711_delta)/1; 1e6, (theta_TCV711 - 1 + theta_TCV711_delta)/1], dtheta_TCV721 = [0, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1)/1; 1e3, (theta_TCV721 - 1 + theta_TCV721_delta)/1; 1e6, (theta_TCV721 - 1 + theta_TCV721_delta)/1], dtheta_TCV731 = [0, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1)/1; 1e3, (theta_TCV731 - 1 + theta_TCV731_delta)/1; 1e6, (theta_TCV731 - 1 + theta_TCV731_delta)/1], dtheta_FCVR01 = [0, 0; 1e6, 0], dTout_RR01 = [0, (Tout_RR01 - 15)/(100 + 273.15); 1e6, (Tout_RR01 - 15)/(100 + 273.15)], domega_P401 = [0, (f_P401 - 50)/50; 1e4, (f_P401 - 50)/50; 1e4, (f_P401 - 50 + f_P401_delta)/50; 1e6, (f_P401 - 50 + f_P401_delta)/50], dtheta_FCV401 = [0, 0; 1e6, 0], domega_P501 = [0, (f_P501 - 50)/50; 1e3, (f_P501 - 50)/50; 1e3, (f_P501 - 50 + f_P501_delta)/50; 1e6, (f_P501 - 50 + f_P501_delta)/50]) annotation (
          Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
        replaceable Export.Linearization.CentralisedSystemGBEBCHP_InitForward plant(TT701Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT711Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT721Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), TT731Offset(fixOffset = true, y_Offset_fixed = 100 + 273.15, y_norm = 100 + 273.15), EX701PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX711PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX721PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), EX731PtOffset(fixOffset = true, y_Offset_fixed = 100e3, y_norm = 100e3), FT101Offset(fixOffset = true, y_Offset_fixed = 4, y_norm = 4), FT401Offset(fixOffset = true, y_Offset_fixed = 1.5, y_norm = 1.5), FT501Offset(fixOffset = true, y_Offset_fixed = 1.5, y_norm = 1.5), thetaFCV701Offset(fixInput = false, fixOffset = true), thetaFCV711Offset(fixInput = false, fixOffset = true), thetaFCV721Offset(fixInput = false, fixOffset = true), thetaFCV731Offset(fixInput = false, fixOffset = true), thetaFCVC01Offset(fixInput = false, fixOffset = true), thetaFCVC02Offset(fixInput = false, fixOffset = true), thetaFCV901Offset(fixInput = false, fixOffset = true), thetaFCV101Offset(fixInput = false, fixOffset = true), thetaTCV701Offset(fixInput = false, fixOffset = true), thetaTCV711Offset(fixInput = false, fixOffset = true), thetaTCV721Offset(fixInput = false, fixOffset = true), thetaTCV731Offset(fixInput = false, fixOffset = true), omegaP901Offset(fixInput = false, fixOffset = true), omegaP101Offset(fixInput = false, fixOffset = true), omegaP401Offset(fixInput = false, fixOffset = true), omegaP501Offset(fixInput = false, fixOffset = true), ToutRR01Offset(fixInput = false, fixOffset = true), TTR02_nom = 373.15, thetaFCV401Offset(fixInput = false, fixOffset = true), S500(PL_S500_P501_PT501(h = 2.05*0)), S900(h_FCV901_PT902 = 2.5*0.1), PL_S500_rCD_hot(h = 3*0), PL_S400_rCD_hot(h = 1.2*0)) annotation (
          Placement(transformation(origin = {-1, 0}, extent = {{11, -38}, {55, 38}})));
        //     FT101Offset(
        //       fixOffset=true,
        //       y_Offset_fixed=4,
...
System")}),
    ...
    model FullPlantController
      ...
      parameter Real Kp_TT701 = 2.7148;
      // phi = 60°, omegac = 0.12 rad/s;
      parameter Real Ti_TT701 = 0.23764;
      parameter Real Kp_TT711 = 10.2519;
      // phi = 60°, omega = 0.11 rad/s;
      parameter Real Ti_TT711 = 0.97913;
      parameter Real Kp_TT721 = 16.66;
      // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT721 = 1.4156;
      parameter Real Kp_TT731 = 21.1084;
      // phi = 60°, omega = 0.12 rad/s;
      ...
      parameter Real Kp_dTT701 = -0.02916;
      //-3.1401; //-0.15335; // phi = 75°, omegac = 0.12 rad/s;
      parameter Real Ti_dTT701 = 0.2142;
      //2.3537; //0.12925;
      parameter Real Kp_dTT711 = -0.12;
      //-6.7268e-05; //-0.076137; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_dTT711 = 0.9852;
      //0.01; //0.91554;
      parameter Real Kp_dTT721 = -0.194;
      //-6.9181e-05; //-0.10967; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_dTT721 = 1.352;
      //0.01; //1.2869;
      parameter Real Kp_dTT731 = -0.236;
      //-4.395; //-0.0022188; // phi = 75°, omega = 0.05 rad/s;
      parameter Real Ti_dTT731 = 1.712;
      //5.663; //0.0011111;
      parameter Real Kp_TT704 = 45.7901;
      // phi = 60°, omegac = 0.12 rad/s;
      parameter Real Ti_TT704 = 0.48554;
      parameter Real Kp_TT714 = 48.4543;
      // phi = 60°, omega = 0.11 rad/s;
      parameter Real Ti_TT714 = 0.56124;
      parameter Real Kp_TT724 = 50.0852;
      // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT724 = 0.5399;
      parameter Real Kp_TT734 = 77.0333;
      // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT734 = 0.77589;
      parameter Real Kp_PtEX701 = 5.923;
      // phi = 60°, omegac = 0.12 rad/s;
      parameter Real Ti_PtEX701 = 1.23;
      parameter Real Kp_PtEX711 = 5.662;
      // phi = 60°, omega = 0.11 rad/s;
      parameter Real Ti_PtEX711 = 1.145;
      parameter Real Kp_PtEX721 = 5.757;
      // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_PtEX721 = 1.201;
      parameter Real Kp_PtEX731 = 9.406;
      // phi = 60°, omega = 0.12 rad/s;
      ...
      Modelica.Blocks.Sources.TimeTable dthetaFCV731(table = dtheta_FCV731) annotation (
        Placement(transformation(extent = {{-80, -60}, {-70, -50}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT704(Kp = Kp_dTT701, Ti = Ti_dTT701, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 50}, {50, 60}})));
      Modelica.Blocks.Sources.TimeTable dTT704SP(table = dTT704) annotation (
        Placement(transformation(extent = {{20, 52}, {30, 62}})));
      Export.Interfaces.ControlSignalBus processVariableBus annotation (
        Placement(visible = true, transformation(origin = {-102, 0}, extent = {{51, 41}, {-51, -41}}, rotation = -90), iconTransformation(origin = {-91, -1}, extent = {{31, 33}, {-31, -33}}, rotation = -90)));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT714(Kp = Kp_dTT711, Ti = Ti_dTT711, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 35}, {50, 45}})));
      Modelica.Blocks.Sources.TimeTable dTT714SP(table = dTT714) annotation (
        Placement(transformation(extent = {{20, 37}, {30, 47}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT724(Kp = Kp_dTT721, Ti = Ti_dTT721, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{46, 21}, {56, 31}})));
      Modelica.Blocks.Sources.TimeTable dTT724SP(table = dTT724) annotation (
        Placement(transformation(extent = {{20, 22}, {30, 32}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT734(Kp = Kp_dTT731, Ti = Ti_dTT731, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{45, 5}, {55, 15}})));
      Modelica.Blocks.Sources.TimeTable dTT734SP(table = dTT734) annotation (
        Placement(transformation(extent = {{20, 7}, {30, 17}})));
      Modelica.Blocks.Sources.TimeTable dFT101SP(table = dFT101) annotation (
        Placement(transformation(extent = {{20, 83}, {30, 93}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_FT401(Kp = 0.00030402, Ti = 0.0002, Umax = 0, Umin = -0.4, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 66}, {50, 76}})));
      Modelica.Blocks.Sources.TimeTable dFT401SP(table = dFT401) annotation (
      ...
      Modelica.Blocks.Sources.TimeTable dToutGB101(table = dTout_GB101) annotation (
        Placement(transformation(extent = {{-80, 122}, {-70, 132}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dPTA2(Kp = 2.412, Ti = 0.2679, Umax = 0, Umin = -0.4, y_start = -0.4, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, -52}, {50, -42}})));
      Modelica.Blocks.Sources.TimeTable ddPTA2SP(table = ddPTA2) annotation (
        Placement(transformation(extent = {{20, -47}, {30, -37}})));
      Modelica.Blocks.Sources.TimeTable dthetaFCVC01(table = dtheta_FCVC01) annotation (
        Placement(transformation(extent = {{-80, -137}, {-70, -127}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dPT100(Kp = 0.00024658, Ti = 0.0002, Umax = 0, Umin = -0.4, y_start = 0, firstOrder(initType = Modelica.Blocks.Types.Init.InitialOutput)) annotation (
        Placement(transformation(extent = {{39, -32}, {49, -22}})));
      Modelica.Blocks.Sources.TimeTable ddPT100SP(table = ddPT100) annotation (
        Placement(transformation(extent = {{20, -30}, {30, -20}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_FT101(Kp = 0.00032462, Ti = 0.0002, Umax = 0, Umin = -0.4, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 81}, {50, 91}})));
      Modelica.Blocks.Continuous.LimIntegrator I_FTR01(k = 1.2, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState) annotation (
        Placement(transformation(extent = {{52, 189}, {62, 199}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX711Pt(Kp = Kp_PtEX711, Ti = Ti_PtEX711, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 159}, {64, 169}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX701Pt(Kp = Kp_PtEX701, Ti = Ti_PtEX701, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 174}, {64, 184}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX721Pt(Kp = Kp_PtEX721, Ti = Ti_PtEX721, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 144}, {64, 154}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX731Pt(Kp = Kp_PtEX731, Ti = Ti_PtEX731, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 129}, {64, 139}})));
      Modelica.Blocks.Math.Feedback fbFTR01 annotation (
        Placement(transformation(extent = {{33, 189}, {43, 199}})));
      Modelica.Blocks.Sources.TimeTable dFTR01SP(table = dFTR01) annotation (
        Placement(transformation(extent = {{19, 189}, {29, 199}})));
      Modelica.Blocks.Sources.TimeTable dEX721PtSP(table = dEX721Pt) annotation (
        Placement(transformation(extent = {{19, 144}, {29, 154}})));
      Modelica.Blocks.Sources.TimeTable dEX701PtSP(table = dEX701Pt) annotation (
        Placement(transformation(extent = {{19, 174}, {29, 184}})));
      Modelica.Blocks.Sources.TimeTable dEX711PtSP(table = dEX711Pt) annotation (
        Placement(transformation(extent = {{19, 159}, {29, 169}})));
      Modelica.Blocks.Sources.TimeTable dEX731PtSP(table = dEX731Pt) annotation (
        Placement(transformation(extent = {{19, 129}, {29, 139}})));
      Modelica.Blocks.Sources.TimeTable dToutRR01(table = dTout_RR01) annotation (
        Placement(transformation(extent = {{-80, -155}, {-70, -145}})));
      Modelica.Blocks.Sources.TimeTable dthetaFCVR01(table = dtheta_FCVR01) annotation (
        Placement(transformation(extent = {{-80, -175}, {-70, -165}})));
      Modelica.Blocks.Continuous.LimIntegrator I_dPTA2(k = 0.065, outMax = 0, outMin = -0.4, initType = Modelica.Blocks.Types.Init.InitialState) annotation (
        Placement(transformation(extent = {{58, -72}, {68, -62}})));
      Modelica.Blocks.Math.Feedback fbdPTA2 annotation (
        Placement(transformation(extent = {{38, -74}, {52, -60}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX701Pt(k = 1.3327, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{80, 180}, {90, 190}})));
      Modelica.Blocks.Math.Feedback fbEX701Pt annotation (
        Placement(transformation(extent = {{68, 181}, {76, 189}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX711Pt(k = 1.3604, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{80, 160}, {90, 170}})));
      Modelica.Blocks.Math.Feedback fbEX711Pt annotation (
        Placement(transformation(extent = {{68, 161}, {76, 169}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX721Pt(k = 1.3604, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{80, 144}, {90, 154}})));
      Modelica.Blocks.Math.Feedback fbEX721Pt annotation (
        Placement(transformation(extent = {{68, 145}, {76, 153}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX731Pt(k = 2.0703, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{80, 129}, {90, 139}})));
      Modelica.Blocks.Math.Feedback fbEX731Pt annotation (
        Placement(transformation(extent = {{68, 130}, {76, 138}})));
      Modelica.Blocks.Sources.TimeTable dFT901SP(table = dFT901) annotation (
        Placement(transformation(extent = {{20, 99}, {30, 109}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_FT901(Kp = 0.00021009, Ti = 0.0002, Umax = 0, Umin = -0.4, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 97}, {50, 107}})));
      Modelica.Blocks.Sources.RealExpression dEX701PtSP_var(y = (EX701PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{4, 172}, {14, 182}})));
      Modelica.Blocks.Sources.RealExpression dEX711PtSP_var(y = (EX711PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{3, 159}, {13, 169}})));
      Modelica.Blocks.Sources.RealExpression dEX721PtSP_var(y = (EX721PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{3, 144}, {13, 154}})));
      Modelica.Blocks.Sources.RealExpression dEX731PtSP_var(y = (EX731PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{3, 130}, {13, 140}})));
      Modelica.Blocks.Sources.RealExpression dFT901SP_var(y = (FT901SP - 7.6222)/7.6222) annotation (
        Placement(transformation(extent = {{5, 97}, {15, 107}})));
      Modelica.Blocks.Sources.TimeTable dTT701SP(table = ddTT701) annotation (
        Placement(transformation(extent = {{4, 53}, {14, 63}})));
      Modelica.Blocks.Sources.TimeTable dTT711SP(table = ddTT711) annotation (
        Placement(transformation(extent = {{4, 38}, {14, 48}})));
      Modelica.Blocks.Sources.TimeTable dTT721SP(table = ddTT721) annotation (
        Placement(transformation(extent = {{4, 23}, {14, 33}})));
      Modelica.Blocks.Sources.TimeTable dTT731SP(table = ddTT731) annotation (
        Placement(transformation(extent = {{4, 8}, {14, 18}})));
      Modelica.Blocks.Sources.RealExpression dFT101SP_var(y = (FT101SP - 5.7166667)/5.7166667) annotation (
        Placement(transformation(extent = {{5, 85}, {15, 95}})));
    equation
      ...
      connect(dthetaFCVC02.y, controlSignalBus.dthetaFCVC02) annotation (
        ...
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT704.controlAction, controlSignalBus.dthetaFCV701) annotation (
        Line(points = {{50.5, 55}, {67, 55}, {67, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT714.controlAction, controlSignalBus.dthetaFCV711) annotation (
        Line(points = {{50.5, 40}, {63, 40}, {63, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT724.controlAction, controlSignalBus.dthetaFCV721) annotation (
        Line(points = {{56.5, 26}, {59, 26}, {59, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT734.controlAction, controlSignalBus.dthetaFCV731) annotation (
        Line(points = {{55.5, 10}, {62, 10}, {62, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dFT401SP.y, PI_FT401.REF) annotation (
        Line(points = {{30.5, 73}, {41, 73}}, color = {0, 0, 127}));
      connect(processVariableBus.dFT401, PI_FT401.FeedBack) annotation (
        Line(points = {{-102, 0}, {36, 0}, {36, 69}, {41, 69}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(dthetaFCV901.y, controlSignalBus.dthetaFCV901) annotation (
        Line(points = {{-69.5, 80}, {-32, 80}, {-32, -5}, {110, -5}}, color = {0, 0, 127}));
      connect(dToutEB401.y, controlSignalBus.dToutEB401) annotation (
        Line(points = {{-69.5, 110}, {10, 110}, {10, 112}, {89, 112}, {89, -8}, {110, -8}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dToutGB101.y, controlSignalBus.dToutGB101) annotation (
        Line(points = {{-69.5, 127}, {9, 127}, {9, 124}, {87, 124}, {87, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(processVariableBus.ddTT701, PI_TT704.FeedBack) annotation (
        Line(points = {{-102, 0}, {37, 0}, {37, 53}, {41, 53}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.ddTT711, PI_TT714.FeedBack) annotation (
        Line(points = {{-102, 0}, {38, 0}, {38, 38}, {41, 38}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.ddTT721, PI_TT724.FeedBack) annotation (
        Line(points = {{-102, 0}, {-32, 0}, {-32, -1}, {39, -1}, {39, 24}, {47, 24}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.ddTT731, PI_TT734.FeedBack) annotation (
        Line(points = {{-102, 0}, {-56, 0}, {-56, -8}, {42, -8}, {42, 2}, {44, 2}, {44, 8}, {46, 8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dPTA2, PI_dPTA2.FeedBack) annotation (
        Line(points = {{-102, 0}, {37, 0}, {37, -49}, {41, -49}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(ddPTA2SP.y, PI_dPTA2.REF) annotation (
        Line(points = {{30.5, -42}, {35, -42}, {35, -45}, {41, -45}}, color = {0, 0, 127}));
      connect(dthetaFCVC01.y, controlSignalBus.dthetaFCVC01) annotation (
        Line(points = {{-69.5, -132}, {-7, -132}, {-7, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(ddPT100SP.y, PI_dPT100.REF) annotation (
        Line(points = {{30.5, -25}, {40, -25}}, color = {0, 0, 127}));
      connect(processVariableBus.dPT102, PI_dPT100.FeedBack) annotation (
        Line(points = {{-102, 0}, {38, 0}, {38, -29}, {40, -29}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(fbFTR01.y, I_FTR01.u) annotation (
        Line(points = {{42.5, 194}, {51, 194}}, color = {0, 0, 127}));
      connect(dFTR01SP.y, fbFTR01.u1) annotation (
        Line(points = {{29.5, 194}, {34, 194}}, color = {0, 0, 127}));
      connect(processVariableBus.dFTR01, fbFTR01.u2) annotation (
        Line(points = {{-102, 0}, {-10, 0}, {-10, 183}, {38, 183}, {38, 190}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX701Pt, PI_dEX701Pt.FeedBack) annotation (
        Line(points = {{-102, 0}, {-7, 0}, {-7, 173}, {49, 173}, {49, 177}, {55, 177}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX711Pt, PI_dEX711Pt.FeedBack) annotation (
        Line(points = {{-102, 0}, {-4, 0}, {-4, 158}, {50, 158}, {50, 162}, {55, 162}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX721Pt, PI_dEX721Pt.FeedBack) annotation (
        Line(points = {{-102, 0}, {-51, 0}, {-51, -1}, {-1, -1}, {-1, 143}, {50, 143}, {50, 147}, {55, 147}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX731Pt, PI_dEX731Pt.FeedBack) annotation (
        Line(points = {{-102, 0}, {-1, 0}, {-1, 126}, {49, 126}, {49, 132}, {55, 132}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(dToutRR01.y, controlSignalBus.dToutRR01) annotation (
        Line(points = {{-69.5, -150}, {-1, -150}, {-1, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dthetaFCVR01.y, controlSignalBus.dthetaFCVR01) annotation (
        Line(points = {{-69.5, -170}, {83, -170}, {83, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(fbdPTA2.y, I_dPTA2.u) annotation (
        Line(points = {{51.3, -67}, {57, -67}}, color = {0, 0, 127}));
      connect(processVariableBus.dPTA2, fbdPTA2.u2) annotation (
        Line(points = {{-102, 0}, {36, 0}, {36, -80}, {45, -80}, {45, -72.6}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbdPTA2.u1, PI_dPTA2.REF) annotation (
        Line(points = {{39.4, -67}, {37, -67}, {37, -68}, {35, -68}, {35, -45}, {41, -45}}, color = {0, 0, 127}));
      connect(fbEX701Pt.y, I_EX701Pt.u) annotation (
        Line(points = {{75.6, 185}, {79, 185}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX701Pt, fbEX701Pt.u2) annotation (
        Line(points = {{-102, -0}, {-7, -0}, {-7, 173}, {41, 173}, {41, 170}, {72, 170}, {72, 181.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbEX701Pt.u1, PI_dEX701Pt.REF) annotation (
        Line(points = {{68.8, 185}, {42, 185}, {42, 179}, {49, 179}, {49, 181}, {55, 181}}, color = {0, 0, 127}));
      connect(fbEX711Pt.y, I_EX711Pt.u) annotation (
        Line(points = {{75.6, 165}, {79, 165}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX711Pt, fbEX711Pt.u2) annotation (
        Line(points = {{-102, 0}, {-4.02439, 0}, {-4.02439, 158.049}, {50, 158.049}, {50, 156}, {72, 156}, {72, 161.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbEX721Pt.y, I_EX721Pt.u) annotation (
        Line(points = {{75.6, 149}, {79, 149}}, color = {0, 0, 127}));
      connect(fbEX721Pt.u1, PI_dEX721Pt.REF) annotation (
        Line(points = {{68.8, 149}, {66, 149}, {66, 155}, {49, 155}, {49, 151}, {55, 151}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX721Pt, fbEX721Pt.u2) annotation (
        Line(points = {{-102, 0}, {-50.9756, 0}, {-50.9756, -0.97561}, {-1.09756, -0.97561}, {-1.09756, 143.049}, {50, 143.049}, {50, 141}, {72, 141}, {72, 145.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbEX731Pt.y, I_EX731Pt.u) annotation (
        Line(points = {{75.6, 134}, {79, 134}}, color = {0, 0, 127}));
      connect(fbEX731Pt.u1, PI_dEX731Pt.REF) annotation (
        Line(points = {{68.8, 134}, {66, 134}, {66, 140}, {50, 140}, {50, 136}, {55, 136}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX731Pt, fbEX731Pt.u2) annotation (
        Line(points = {{-102, 0}, {-56, 0}, {-56, -1}, {-18, -1}, {-18, 119}, {72, 119}, {72, 130.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(PI_dEX731Pt.controlAction, controlSignalBus.dthetaTCV731) annotation (
        Line(points = {{64.5, 134}, {66, 134}, {66, 114}, {103, 114}, {103, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dthetaFCV101.y, controlSignalBus.dthetaFCV101) annotation (
        Line(points = {{-69.5, 50}, {-52, 50}, {-52, 51}, {-39, 51}, {-39, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_FT101.controlAction, controlSignalBus.domegaP101) annotation (
        Line(points = {{50.5, 86}, {82, 86}, {82, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dthetaFCV401.y, controlSignalBus.dthetaFCV401) annotation (
        Line(points = {{-69.5, 20}, {-58, 20}, {-58, 21}, {-43, 21}, {-43, -5}, {110, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_dEX721Pt.controlAction, controlSignalBus.dthetaTCV721) annotation (
        Line(points = {{64.5, 149}, {65, 149}, {65, 145}, {78, 145}, {78, 105}, {99, 105}, {99, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(processVariableBus.dFT101, PI_FT101.FeedBack) annotation (
        Line(points = {{-102, 0}, {35, 0}, {35, 84}, {41, 84}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dFT901, PI_FT901.FeedBack) annotation (
        Line(points = {{-102, 0}, {34, 0}, {34, 100}, {41, 100}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(PI_dEX701Pt.controlAction, controlSignalBus.dthetaTCV701) annotation (
        Line(points = {{64.5, 179}, {69, 179}, {69, 175}, {96, 175}, {96, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_dEX711Pt.controlAction, controlSignalBus.dthetaTCV711) annotation (
        Line(points = {{64.5, 164}, {66, 164}, {66, 160}, {92, 160}, {92, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dEX701PtSP_var.y, PI_dEX701Pt.REF) annotation (
        Line(points = {{14.5, 177}, {17, 177}, {17, 176}, {45, 176}, {45, 181}, {55, 181}}, color = {0, 0, 127}));
      connect(PI_FT901.controlAction, controlSignalBus.domegaP901) annotation (
        Line(points = {{50.5, 102}, {91, 102}, {91, -5}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(domegaP401.y, controlSignalBus.domegaP401) annotation (
        Line(points = {{-69.5, 35}, {-57, 35}, {-57, 36}, {-43, 36}, {-43, -4}, {110, -4}, {110, -5}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dEX711PtSP_var.y, PI_dEX711Pt.REF) annotation (
        Line(points = {{13.5, 164}, {15, 164}, {15, 163}, {16, 163}, {16, 162}, {43, 162}, {43, 166}, {55, 166}}, color = {0, 0, 127}));
      connect(fbEX711Pt.u1, PI_dEX711Pt.REF) annotation (
        Line(points = {{68.8, 165}, {66, 165}, {66, 171}, {50, 171}, {50, 166}, {55, 166}}, color = {0, 0, 127}));
      connect(dEX721PtSP_var.y, PI_dEX721Pt.REF) annotation (
        Line(points = {{13.5, 149}, {17, 149}, {17, 155}, {43, 155}, {43, 151}, {55, 151}}, color = {0, 0, 127}));
      connect(dEX731PtSP_var.y, PI_dEX731Pt.REF) annotation (
        Line(points = {{13.5, 135}, {15, 135}, {15, 134}, {17, 134}, {17, 131}, {44, 131}, {44, 136}, {55, 136}}, color = {0, 0, 127}));
      connect(dFT901SP_var.y, PI_FT901.REF) annotation (
        Line(points = {{15.5, 102}, {19, 102}, {19, 114}, {36, 114}, {36, 104}, {41, 104}}, color = {0, 0, 127}));
      connect(dTT731SP.y, PI_TT734.REF) annotation (
        Line(points = {{14.5, 13}, {14.5, 4}, {42, 4}, {42, 12}, {46, 12}}, color = {0, 0, 127}));
      connect(dTT721SP.y, PI_TT724.REF) annotation (
        Line(points = {{14.5, 28}, {23, 28}, {23, 29}, {32, 29}, {32, 28}, {47, 28}}, color = {0, 0, 127}));
      connect(dTT711SP.y, PI_TT714.REF) annotation (
        Line(points = {{14.5, 43}, {16, 43}, {16, 46}, {32, 46}, {32, 42}, {41, 42}}, color = {0, 0, 127}));
      connect(dTT701SP.y, PI_TT704.REF) annotation (
        Line(points = {{14.5, 58}, {16, 58}, {16, 61}, {32, 61}, {32, 57}, {41, 57}}, color = {0, 0, 127}));
      connect(dFT101SP_var.y, PI_FT101.REF) annotation (
        Line(points = {{15.5, 90}, {18, 90}, {18, 95}, {37, 95}, {37, 88}, {41, 88}}, color = {0, 0, 127}));
      annotation (
        Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(lineColor = {175, 175, 175}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid, lineThickness = 1, extent = {{-100, 100}, {100, -100}}, radius = 25), Text(extent = {{-70, 100}, {70, -100}}, textColor = {0, 0, 0}, textStyle = {TextStyle.Bold}, textString = "PID
Control
System")}),
        Diagram(coordinateSystem(extent = {{-100, -200}, {100, 200}}, preserveAspectRatio = false, grid = {1, 1})));
    ...
    model FullPlantController_B
      ...
      Real FT901SP(nominal = 10);
      Real FT101SP(nominal = 5);
      parameter Real Kp_TT701 = 35.7682;
      //2.7148; // phi = 60°, omegac = 0.05 rad/s;
      parameter Real Ti_TT701 = 1.7239;
      //0.23764;
      parameter Real Kp_TT711 = 1.6754;
      // 1.1403; // phi = 60°, omega = 0.05 rad/s;
      parameter Real Ti_TT711 = 1.0102;
      // 1.4897;
      parameter Real Kp_TT721 = 2.6074;
      // 2.6074; 16.66; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT721 = 1.5278;
      //1.4156;
      parameter Real Kp_TT731 = 26.7534;
      //21.1084; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT731 = 0.653;
      //1.7782;
      parameter Real Kp_dTT701 = -3.1401;
      //-0.15335; // phi = 75°, omegac = 0.12 rad/s;
      parameter Real Ti_dTT701 = 2.3537;
      //0.12925;
      parameter Real Kp_dTT711 = -6.7268e-05;
      //-0.076137; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_dTT711 = 0.01;
      //0.91554;
      parameter Real Kp_dTT721 = -6.9181e-05;
      //-0.10967; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_dTT721 = 0.01;
      //1.2869;
      parameter Real Kp_dTT731 = -4.395;
      //-0.0022188; // phi = 75°, omega = 0.05 rad/s;
      parameter Real Ti_dTT731 = 5.663;
      //0.0011111;
      parameter Real Kp_TT704 = 45.7901;
      // phi = 60°, omegac = 0.12 rad/s;
      parameter Real Ti_TT704 = 0.48554;
      ...
      // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT734 = 0.77589;
      parameter Real Kp_PtEX701 = 1.3737;
      // phi = 60°, omegac = 0.12 rad/s;
      parameter Real Ti_PtEX701 = 0.38217;
      parameter Real Kp_PtEX711 = 1.8703;
      // phi = 60°, omega = 0.11 rad/s;
      parameter Real Ti_PtEX711 = 0.53366;
      parameter Real Kp_PtEX721 = 1.8751;
      // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_PtEX721 = 0.52629;
      parameter Real Kp_PtEX731 = 3.9812;
      // phi = 60°, omega = 0.12 rad/s;
      ...
      Modelica.Blocks.Sources.TimeTable dthetaFCV731(table = dtheta_FCV731) annotation (
        Placement(transformation(extent = {{-80, -60}, {-70, -50}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT704(Kp = Kp_dTT701, Ti = Ti_dTT701, Umax = 0, Umin = -1, y_start = 0, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{45, 75}, {55, 85}})));
      Modelica.Blocks.Sources.TimeTable dTT704SP(table = dTT704) annotation (
      ...
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT714(Kp = Kp_dTT711, Ti = Ti_dTT711, Umax = 0, Umin = -1, y_start = 0, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{45, 55}, {55, 65}})));
      Modelica.Blocks.Sources.TimeTable dTT714SP(table = dTT714) annotation (
        Placement(transformation(extent = {{17, 65}, {27, 75}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT724(Kp = Kp_dTT721, Ti = Ti_dTT721, Umax = 0, Umin = -1, y_start = 0, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{45, 35}, {55, 45}})));
      Modelica.Blocks.Sources.TimeTable dTT724SP(table = dTT724) annotation (
        Placement(transformation(extent = {{20, 37}, {30, 47}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_TT734(Kp = Kp_dTT731, Ti = Ti_dTT731, Umax = 0, Umin = -1, y_start = 0, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{45, 5}, {55, 15}})));
      Modelica.Blocks.Sources.TimeTable dTT734SP(table = dTT734) annotation (
        Placement(transformation(extent = {{20, 7}, {30, 17}})));
      Modelica.Blocks.Sources.TimeTable dFT101SP(table = dFT101) annotation (
      ...
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_FT401(Kp = 0.00030402, Ti = 0.0002, Umax = 0, Umin = -0.4, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 128}, {50, 138}})));
      Modelica.Blocks.Sources.TimeTable dFT401SP(table = dFT401) annotation (
      ...
      Modelica.Blocks.Sources.TimeTable ddPT100SP(table = ddPT100) annotation (
        Placement(transformation(extent = {{20, -30}, {30, -20}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_FT101(Kp = 0.00032462, Ti = 0.0002, Umax = 0, Umin = -0.4, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 143}, {50, 153}})));
      Modelica.Blocks.Continuous.LimIntegrator I_FTR01(k = 1.2, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState) annotation (
        Placement(transformation(extent = {{52, 258}, {62, 268}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX711Pt(Kp = Kp_PtEX711, Ti = Ti_PtEX711, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 228}, {64, 238}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX701Pt(Kp = Kp_PtEX701, Ti = Ti_PtEX701, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 243}, {64, 253}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX721Pt(Kp = Kp_PtEX721, Ti = Ti_PtEX721, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 213}, {64, 223}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dEX731Pt(Kp = Kp_PtEX731, Ti = Ti_PtEX731, Umax = 0, Umin = -1, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{54, 198}, {64, 208}})));
      Modelica.Blocks.Math.Feedback fbFTR01 annotation (
        Placement(transformation(extent = {{33, 258}, {43, 268}})));
      Modelica.Blocks.Sources.TimeTable dFTR01SP(table = dFTR01) annotation (
        Placement(transformation(extent = {{19, 258}, {29, 268}})));
      Modelica.Blocks.Sources.TimeTable dEX721PtSP(table = dEX721Pt) annotation (
        Placement(transformation(extent = {{19, 213}, {29, 223}})));
      Modelica.Blocks.Sources.TimeTable dEX701PtSP(table = dEX701Pt) annotation (
        Placement(transformation(extent = {{19, 243}, {29, 253}})));
      Modelica.Blocks.Sources.TimeTable dEX711PtSP(table = dEX711Pt) annotation (
        Placement(transformation(extent = {{19, 228}, {29, 238}})));
      Modelica.Blocks.Sources.TimeTable dEX731PtSP(table = dEX731Pt) annotation (
        Placement(transformation(extent = {{19, 198}, {29, 208}})));
      Modelica.Blocks.Sources.TimeTable dToutRR01(table = dTout_RR01) annotation (
        Placement(transformation(extent = {{-80, -155}, {-70, -145}})));
      Modelica.Blocks.Sources.TimeTable dthetaFCVR01(table = dtheta_FCVR01) annotation (
        Placement(transformation(extent = {{-80, -175}, {-70, -165}})));
      ...
      Modelica.Blocks.Math.Feedback fbdPTA2 annotation (
        Placement(transformation(extent = {{38, -74}, {52, -60}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX701Pt(k = 1.3327, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{80, 249}, {90, 259}})));
      Modelica.Blocks.Math.Feedback fbEX701Pt annotation (
        Placement(transformation(extent = {{68, 250}, {76, 258}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX711Pt(k = 1.3604, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{88, 231}, {98, 241}})));
      Modelica.Blocks.Math.Feedback fbEX711Pt annotation (
        Placement(transformation(extent = {{76, 230}, {84, 238}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX721Pt(k = 1.3604, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{88, 214}, {98, 224}})));
      Modelica.Blocks.Math.Feedback fbEX721Pt annotation (
        Placement(transformation(extent = {{76, 214}, {84, 222}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX731Pt(k = 2.0703, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{88, 198}, {98, 208}})));
      Modelica.Blocks.Math.Feedback fbEX731Pt annotation (
        Placement(transformation(extent = {{76, 199}, {84, 207}})));
      Modelica.Blocks.Sources.TimeTable dFT901SP(table = dFT901) annotation (
        Placement(transformation(extent = {{20, 161}, {30, 171}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_FT901(Kp = 0.00021009, Ti = 0.0002, Umax = 0, Umin = -2, y_start = 1, firstOrder(initType = Modelica.Blocks.Types.Init.InitialState)) annotation (
        Placement(transformation(extent = {{40, 159}, {50, 169}})));
      Modelica.Blocks.Sources.RealExpression dEX701PtSP_var(y = (EX701PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{4, 241}, {14, 251}})));
      Modelica.Blocks.Sources.RealExpression dEX711PtSP_var(y = (EX711PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{3, 228}, {13, 238}})));
      Modelica.Blocks.Sources.RealExpression dEX721PtSP_var(y = (EX721PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{3, 213}, {13, 223}})));
      Modelica.Blocks.Sources.RealExpression dEX731PtSP_var(y = (EX731PtSP - 50e3)/50e3) annotation (
        Placement(transformation(extent = {{3, 199}, {13, 209}})));
      Modelica.Blocks.Sources.RealExpression dFT901SP_var(y = (FT901SP - 7.6222)/7.6222) annotation (
        Placement(transformation(extent = {{5, 159}, {15, 169}})));
      Modelica.Blocks.Sources.TimeTable dTT701SP(table = ddTT701) annotation (
        Placement(transformation(extent = {{5, 77}, {15, 87}})));
      Modelica.Blocks.Sources.TimeTable dTT711SP(table = ddTT711) annotation (
        Placement(transformation(extent = {{4, 58}, {14, 68}})));
      Modelica.Blocks.Sources.TimeTable dTT721SP(table = ddTT721) annotation (
        Placement(transformation(extent = {{4, 38}, {14, 48}})));
      Modelica.Blocks.Sources.TimeTable dTT731SP(table = ddTT731) annotation (
        Placement(transformation(extent = {{4, 8}, {14, 18}})));
      Modelica.Blocks.Sources.RealExpression dFT101SP_var(y = (FT101SP - 5.7166667)/5.7166667) annotation (
        Placement(transformation(extent = {{5, 147}, {15, 157}})));
      Modelica.Blocks.Logical.Switch switch_thetaTCV701 annotation (
        Placement(transformation(extent = {{60, -180}, {80, -200}})));
      Modelica.Blocks.Sources.TimeTable dTT70X_min(table = [0, (55 - 65)/(65 + 273.15); 1e6, (55 - 65)/(65 + 273.15)]) annotation (
        Placement(transformation(extent = {{-60, -200}, {-40, -180}})));
      Modelica.Blocks.Logical.GreaterEqual greaterEqual_TT701 annotation (
        Placement(transformation(extent = {{-10, -180}, {10, -200}})));
      Modelica.Blocks.Sources.Constant const(k = (0.2 - 1)/1) annotation (
        Placement(transformation(extent = {{20, -160}, {40, -140}})));
      Modelica.Blocks.Logical.Switch switch_thetaTCV731 annotation (
        Placement(transformation(extent = {{60, -300}, {80, -320}})));
      Modelica.Blocks.Logical.GreaterEqual greaterEqual_TT731 annotation (
        Placement(transformation(extent = {{-10, -300}, {10, -320}})));
      Modelica.Blocks.Logical.Switch switch_thetaTCV711 annotation (
        Placement(transformation(extent = {{60, -220}, {80, -240}})));
      Modelica.Blocks.Logical.GreaterEqual greaterEqual_TT711 annotation (
        Placement(transformation(extent = {{-10, -220}, {10, -240}})));
      Modelica.Blocks.Logical.Switch switch_thetaTCV721 annotation (
        Placement(transformation(extent = {{60, -260}, {80, -280}})));
      Modelica.Blocks.Logical.GreaterEqual greaterEqual_TT721 annotation (
        Placement(transformation(extent = {{-10, -260}, {10, -280}})));
      Modelica.Blocks.Logical.Not not1 annotation (
        Placement(transformation(extent = {{20, -200}, {40, -180}})));
      Modelica.Blocks.Logical.Not not2 annotation (
        Placement(transformation(extent = {{20, -240}, {40, -220}})));
    ...
    equation
      ...
      connect(dthetaFCVC02.y, controlSignalBus.dthetaFCVC02) annotation (
        ...
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT714.controlAction, controlSignalBus.dthetaFCV711) annotation (
        Line(points = {{55.5, 60}, {76, 60}, {76, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT724.controlAction, controlSignalBus.dthetaFCV721) annotation (
        Line(points = {{55.5, 40}, {72, 40}, {72, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT734.controlAction, controlSignalBus.dthetaFCV731) annotation (
        Line(points = {{55.5, 10}, {55.5, 8}, {68, 8}, {68, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dFT401SP.y, PI_FT401.REF) annotation (
        Line(points = {{30.5, 135}, {41, 135}}, color = {0, 0, 127}));
      connect(processVariableBus.dFT401, PI_FT401.FeedBack) annotation (
        Line(points = {{-240, 0}, {36, 0}, {36, 131}, {41, 131}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(dToutEB401.y, controlSignalBus.dToutEB401) annotation (
        Line(points = {{-69.5, 110}, {-69.5, 108}, {-4, 108}, {-4, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dToutGB101.y, controlSignalBus.dToutGB101) annotation (
        Line(points = {{-69.5, 127}, {-69.5, 124}, {-60, 124}, {-60, 140}, {-88, 140}, {-88, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(processVariableBus.ddTT701, PI_TT704.FeedBack) annotation (
        Line(points = {{-240, 0}, {38, 0}, {38, 78}, {46, 78}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.ddTT711, PI_TT714.FeedBack) annotation (
        Line(points = {{-240, 0}, {36, 0}, {36, 58}, {46, 58}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.ddTT721, PI_TT724.FeedBack) annotation (
        Line(points = {{-240, 0}, {40, 0}, {40, 38}, {46, 38}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.ddTT731, PI_TT734.FeedBack) annotation (
        Line(points = {{-240, 0}, {38, 0}, {38, 8}, {46, 8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dPTA2, PI_dPTA2.FeedBack) annotation (
        Line(points = {{-240, 0}, {36, 0}, {36, -49}, {41, -49}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(ddPTA2SP.y, PI_dPTA2.REF) annotation (
        Line(points = {{30.5, -42}, {35, -42}, {35, -45}, {41, -45}}, color = {0, 0, 127}));
      connect(dthetaFCVC01.y, controlSignalBus.dthetaFCVC01) annotation (
        Line(points = {{-69.5, -132}, {8, -132}, {8, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(ddPT100SP.y, PI_dPT100.REF) annotation (
        Line(points = {{30.5, -25}, {40, -25}}, color = {0, 0, 127}));
      connect(processVariableBus.dPT102, PI_dPT100.FeedBack) annotation (
        Line(points = {{-240, 0}, {34, 0}, {34, -29}, {40, -29}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(fbFTR01.y, I_FTR01.u) annotation (
        Line(points = {{42.5, 263}, {51, 263}}, color = {0, 0, 127}));
      connect(dFTR01SP.y, fbFTR01.u1) annotation (
        Line(points = {{29.5, 263}, {34, 263}}, color = {0, 0, 127}));
      connect(processVariableBus.dFTR01, fbFTR01.u2) annotation (
        Line(points = {{-240, 0}, {-2, 0}, {-2, 239}, {38, 239}, {38, 259}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX701Pt, PI_dEX701Pt.FeedBack) annotation (
        Line(points = {{-240, 0}, {-2, 0}, {-2, 225}, {44, 225}, {44, 241}, {50, 241}, {50, 246}, {55, 246}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX711Pt, PI_dEX711Pt.FeedBack) annotation (
        Line(points = {{-240, 0}, {-2, 0}, {-2, 225}, {44, 225}, {44, 231}, {55, 231}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX721Pt, PI_dEX721Pt.FeedBack) annotation (
        Line(points = {{-240, 0}, {0, 0}, {0, 211}, {50, 211}, {50, 216}, {55, 216}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dEX731Pt, PI_dEX731Pt.FeedBack) annotation (
        Line(points = {{-240, 0}, {-18, 0}, {-18, 187}, {50, 187}, {50, 201}, {55, 201}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(dToutRR01.y, controlSignalBus.dToutRR01) annotation (
        Line(points = {{-69.5, -150}, {8, -150}, {8, -136}, {12, -136}, {12, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dthetaFCVR01.y, controlSignalBus.dthetaFCVR01) annotation (
        Line(points = {{-69.5, -170}, {108, -170}, {108, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(fbdPTA2.y, I_dPTA2.u) annotation (
        Line(points = {{51.3, -67}, {57, -67}}, color = {0, 0, 127}));
      connect(processVariableBus.dPTA2, fbdPTA2.u2) annotation (
        Line(points = {{-240, 0}, {36, 0}, {36, -78}, {45, -78}, {45, -72.6}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbdPTA2.u1, PI_dPTA2.REF) annotation (
        Line(points = {{39.4, -67}, {37, -67}, {37, -68}, {35, -68}, {35, -45}, {41, -45}}, color = {0, 0, 127}));
      connect(fbEX701Pt.y, I_EX701Pt.u) annotation (
        Line(points = {{75.6, 254}, {79, 254}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX701Pt, fbEX701Pt.u2) annotation (
        Line(points = {{-240, 0}, {-2, 0}, {-2, 225}, {44, 225}, {44, 241}, {72, 241}, {72, 250.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbEX701Pt.u1, PI_dEX701Pt.REF) annotation (
        Line(points = {{68.8, 254}, {42, 254}, {42, 248}, {49, 248}, {49, 250}, {55, 250}}, color = {0, 0, 127}));
      connect(fbEX711Pt.y, I_EX711Pt.u) annotation (
        Line(points = {{83.6, 234}, {85, 234}, {85, 236}, {87, 236}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX711Pt, fbEX711Pt.u2) annotation (
        Line(points = {{-240, 0}, {-2, 0}, {-2, 225}, {80, 225}, {80, 230.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbEX721Pt.y, I_EX721Pt.u) annotation (
        Line(points = {{83.6, 218}, {85, 218}, {85, 219}, {87, 219}}, color = {0, 0, 127}));
      connect(fbEX721Pt.u1, PI_dEX721Pt.REF) annotation (
        Line(points = {{76.8, 218}, {72, 218}, {72, 224}, {49, 224}, {49, 220}, {55, 220}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX721Pt, fbEX721Pt.u2) annotation (
        Line(points = {{-240, 0}, {2, 0}, {2, 214}, {41, 214}, {41, 214.8}, {80, 214.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbEX731Pt.y, I_EX731Pt.u) annotation (
        Line(points = {{83.6, 203}, {87, 203}}, color = {0, 0, 127}));
      connect(fbEX731Pt.u1, PI_dEX731Pt.REF) annotation (
        Line(points = {{76.8, 203}, {72, 203}, {72, 209}, {50, 209}, {50, 205}, {55, 205}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX731Pt, fbEX731Pt.u2) annotation (
        Line(points = {{-240, 0}, {-56, 0}, {-56, 71}, {-18, 71}, {-18, 189}, {50, 189}, {50, 195}, {80, 195}, {80, 199.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(dthetaFCV101.y, controlSignalBus.dthetaFCV101) annotation (
        Line(points = {{-69.5, 50}, {-69.5, 48}, {-36, 48}, {-36, 24}, {-20, 24}, {-20, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_FT101.controlAction, controlSignalBus.domegaP101) annotation (
        Line(points = {{50.5, 148}, {108, 148}, {108, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dthetaFCV401.y, controlSignalBus.dthetaFCV401) annotation (
        Line(points = {{-69.5, 20}, {-48, 20}, {-48, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(processVariableBus.dFT101, PI_FT101.FeedBack) annotation (
        Line(points = {{-240, 0}, {32, 0}, {32, 146}, {41, 146}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dFT901, PI_FT901.FeedBack) annotation (
        Line(points = {{-240, 0}, {34, 0}, {34, 162}, {41, 162}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(dEX701PtSP_var.y, PI_dEX701Pt.REF) annotation (
        Line(points = {{14.5, 246}, {17, 246}, {17, 245}, {45, 245}, {45, 250}, {55, 250}}, color = {0, 0, 127}));
      connect(domegaP401.y, controlSignalBus.domegaP401) annotation (
        Line(points = {{-69.5, 35}, {-69.5, 32}, {-40, 32}, {-40, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dEX711PtSP_var.y, PI_dEX711Pt.REF) annotation (
        Line(points = {{13.5, 233}, {15, 233}, {15, 232}, {16, 232}, {16, 231}, {43, 231}, {43, 235}, {55, 235}}, color = {0, 0, 127}));
      connect(fbEX711Pt.u1, PI_dEX711Pt.REF) annotation (
        Line(points = {{76.8, 234}, {72, 234}, {72, 240}, {50, 240}, {50, 235}, {55, 235}}, color = {0, 0, 127}));
      connect(dEX721PtSP_var.y, PI_dEX721Pt.REF) annotation (
        Line(points = {{13.5, 218}, {17, 218}, {17, 224}, {43, 224}, {43, 220}, {55, 220}}, color = {0, 0, 127}));
      connect(dEX731PtSP_var.y, PI_dEX731Pt.REF) annotation (
        Line(points = {{13.5, 204}, {15, 204}, {15, 203}, {17, 203}, {17, 200}, {44, 200}, {44, 205}, {55, 205}}, color = {0, 0, 127}));
      connect(dFT901SP_var.y, PI_FT901.REF) annotation (
        Line(points = {{15.5, 164}, {19, 164}, {19, 176}, {36, 176}, {36, 166}, {41, 166}}, color = {0, 0, 127}));
      connect(dTT731SP.y, PI_TT734.REF) annotation (
        Line(points = {{14.5, 13}, {14.5, 4}, {42, 4}, {42, 12}, {46, 12}}, color = {0, 0, 127}));
      connect(dTT721SP.y, PI_TT724.REF) annotation (
        Line(points = {{14.5, 43}, {23, 43}, {23, 44}, {32, 44}, {32, 42}, {46, 42}}, color = {0, 0, 127}));
      connect(dTT711SP.y, PI_TT714.REF) annotation (
        Line(points = {{14.5, 63}, {30.25, 63}, {30.25, 62}, {46, 62}}, color = {0, 0, 127}));
      connect(dTT701SP.y, PI_TT704.REF) annotation (
        Line(points = {{15.5, 82}, {46, 82}}, color = {0, 0, 127}));
      connect(dFT101SP_var.y, PI_FT101.REF) annotation (
        Line(points = {{15.5, 152}, {18, 152}, {18, 157}, {37, 157}, {37, 150}, {41, 150}}, color = {0, 0, 127}));
      connect(dTT70X_min.y, greaterEqual_TT701.u1) annotation (
        Line(points = {{-39, -190}, {-12, -190}}, color = {0, 0, 127}));
      connect(processVariableBus.dTT701, greaterEqual_TT701.u2) annotation (
        Line(points = {{-240, 0}, {-86, 0}, {-86, -176}, {-24, -176}, {-24, -182}, {-12, -182}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(switch_thetaTCV701.y, controlSignalBus.dthetaTCV701) annotation (
        Line(points = {{81, -190}, {128, -190}, {128, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_thetaTCV701.u1, PI_dEX701Pt.controlAction) annotation (
        Line(points = {{58, -198}, {114, -198}, {114, 245}, {76, 245}, {76, 248}, {64.5, 248}}, color = {0, 0, 127}));
      connect(processVariableBus.dTT731, greaterEqual_TT731.u2) annotation (
        Line(points = {{-240, 0}, {-98, 0}, {-98, -288}, {-28, -288}, {-28, -302}, {-12, -302}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(const.y, switch_thetaTCV701.u3) annotation (
        Line(points = {{41, -150}, {48, -150}, {48, -182}, {58, -182}, {58, -182}}, color = {0, 0, 127}));
      connect(processVariableBus.dTT711, greaterEqual_TT711.u2) annotation (
        Line(points = {{-240, 0}, {-90, 0}, {-90, -210}, {-28, -210}, {-28, -222}, {-12, -222}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dTT721, greaterEqual_TT721.u2) annotation (
        Line(points = {{-240, 0}, {-94, 0}, {-94, -252}, {-28, -252}, {-28, -262}, {-12, -262}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(switch_thetaTCV711.y, controlSignalBus.dthetaTCV711) annotation (
        Line(points = {{81, -230}, {136, -230}, {136, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_thetaTCV711.u3, switch_thetaTCV701.u3) annotation (
        Line(points = {{58, -222}, {48, -222}, {48, -182}, {58, -182}}, color = {0, 0, 127}));
      connect(switch_thetaTCV721.u3, switch_thetaTCV701.u3) annotation (
        Line(points = {{58, -262}, {48, -262}, {48, -182}, {58, -182}}, color = {0, 0, 127}));
      connect(switch_thetaTCV731.u3, switch_thetaTCV701.u3) annotation (
        Line(points = {{58, -302}, {48, -302}, {48, -182}, {58, -182}}, color = {0, 0, 127}));
      connect(greaterEqual_TT711.u1, greaterEqual_TT701.u1) annotation (
        Line(points = {{-12, -230}, {-20, -230}, {-20, -190}, {-12, -190}}, color = {0, 0, 127}));
      connect(greaterEqual_TT721.u1, greaterEqual_TT701.u1) annotation (
        Line(points = {{-12, -270}, {-20, -270}, {-20, -190}, {-12, -190}}, color = {0, 0, 127}));
      connect(greaterEqual_TT731.u1, greaterEqual_TT701.u1) annotation (
        Line(points = {{-12, -310}, {-20, -310}, {-20, -190}, {-12, -190}}, color = {0, 0, 127}));
      connect(PI_dEX711Pt.controlAction, switch_thetaTCV711.u1) annotation (
        Line(points = {{64.5, 233}, {66, 233}, {66, 227}, {116, 227}, {116, -238}, {58, -238}}, color = {0, 0, 127}));
      connect(PI_dEX721Pt.controlAction, switch_thetaTCV721.u1) annotation (
        Line(points = {{64.5, 218}, {70, 218}, {70, 211}, {118, 211}, {118, -278}, {58, -278}}, color = {0, 0, 127}));
      connect(PI_dEX731Pt.controlAction, switch_thetaTCV731.u1) annotation (
        Line(points = {{64.5, 203}, {70, 203}, {70, 192}, {120, 192}, {120, -318}, {58, -318}}, color = {0, 0, 127}));
      connect(switch_thetaTCV721.y, controlSignalBus.dthetaTCV721) annotation (
        Line(points = {{81, -270}, {140, -270}, {140, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_thetaTCV731.y, controlSignalBus.dthetaTCV731) annotation (
        Line(points = {{81, -310}, {188, -310}, {188, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(greaterEqual_TT701.y, not1.u) annotation (
        Line(points = {{11, -190}, {18, -190}}, color = {255, 0, 255}));
      connect(not1.y, switch_thetaTCV701.u2) annotation (
        Line(points = {{41, -190}, {58, -190}}, color = {255, 0, 255}));
      connect(greaterEqual_TT711.y, not2.u) annotation (
        Line(points = {{11, -230}, {18, -230}}, color = {255, 0, 255}));
      connect(not2.y, switch_thetaTCV711.u2) annotation (
        Line(points = {{41, -230}, {58, -230}}, color = {255, 0, 255}));
      connect(greaterEqual_TT721.y, not3.u) annotation (
        Line(points = {{11, -270}, {18, -270}}, color = {255, 0, 255}));
      connect(not3.y, switch_thetaTCV721.u2) annotation (
        Line(points = {{41, -270}, {58, -270}}, color = {255, 0, 255}));
      connect(greaterEqual_TT731.y, not4.u) annotation (
        Line(points = {{11, -310}, {18, -310}}, color = {255, 0, 255}));
      connect(not4.y, switch_thetaTCV731.u2) annotation (
        Line(points = {{41, -310}, {58, -310}}, color = {255, 0, 255}));
      connect(splitRange.U, PI_FT901.controlAction) annotation (
        Line(points = {{59, 164}, {50.5, 164}}, color = {0, 0, 127}));
      connect(splitRange.Yout1, controlSignalBus.domegaP901) annotation (
        Line(points = {{67, 166}, {198, 166}, {198, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(splitRange.Yout2, controlSignalBus.dthetaFCV901) annotation (
        Line(points = {{67, 162}, {195, 162}, {195, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(PI_TT704.controlAction, controlSignalBus.dthetaFCV701) annotation (
        Line(points = {{55.5, 80}, {89, 80}, {89, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      annotation (
        Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(lineColor = {175, 175, 175}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid, lineThickness = 1, extent = {{-100, 100}, {100, -100}}, radius = 25), Text(extent = {{-70, 100}, {70, -100}}, textColor = {0, 0, 0}, textStyle = {TextStyle.Bold}, textString = "PID
Control
System")}),
        Diagram(coordinateSystem(extent = {{-240, -360}, {240, 360}}, preserveAspectRatio = false, grid = {1, 1})));
    ...
    model FullPlantController_C
      ...
      Real FT901SP(nominal = 10);
      Real FT101SP(nominal = 5);
      parameter Real Kp_TT701 = 1.295;
      //35.7682; //2.7148; // phi = 60°, omegac = 0.05 rad/s;
      parameter Real Ti_TT701 = 0.4175;
      //1.7239; //0.23764;
      parameter Real Kp_TT711 = 2.574;
      //1.6754; // 1.1403; // phi = 60°, omega = 0.05 rad/s;
      parameter Real Ti_TT711 = 0.9386;
      //1.0102; // 1.4897;
      parameter Real Kp_TT721 = 4.445;
      //2.6074; // 2.6074; 16.66; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT721 = 1.375;
      //1.5278; //1.4156;
      parameter Real Kp_TT731 = 5.541;
      //26.7534; //21.1084; // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_TT731 = 1.79;
      //0.653; //1.7782;
      parameter Real Kp_dTT701 = -0.02916;
      //-3.1401; //-0.15335; // phi = 75°, omegac = 0.12 rad/s;
      parameter Real Ti_dTT701 = 0.2142;
      ...
      Modelica.Blocks.Sources.TimeTable ddPTA2SP(table = ddPTA2) annotation (
        Placement(transformation(extent = {{20, -47}, {30, -37}})));
      Modelica.Blocks.Sources.TimeTable dthetaFCVC01(table = dtheta_FCVC01) annotation (
        Placement(transformation(extent = {{-121, -25}, {-111, -15}})));
      DistrictHeatingNetwork.Controllers.AWPIContinuous PI_dPT100(Kp = 0.00024658, Ti = 0.0002, Umax = 0, Umin = -0.4, y_start = 0, firstOrder(initType = Modelica.Blocks.Types.Init.InitialOutput)) annotation (
        Placement(transformation(extent = {{39, -32}, {49, -22}})));
      Modelica.Blocks.Sources.TimeTable ddPT100SP(table = ddPT100) annotation (
        Placement(transformation(extent = {{20, -30}, {30, -20}})));
      ...
      Modelica.Blocks.Sources.TimeTable dEX731PtSP(table = dEX731Pt) annotation (
        Placement(transformation(extent = {{19, 198}, {29, 208}})));
      Modelica.Blocks.Sources.TimeTable dToutRR01(table = dTout_RR01) annotation (
        Placement(transformation(extent = {{-121, -43}, {-111, -33}})));
      Modelica.Blocks.Sources.TimeTable dthetaFCVR01(table = dtheta_FCVR01) annotation (
        Placement(transformation(extent = {{-121, -63}, {-111, -53}})));
      Modelica.Blocks.Continuous.LimIntegrator I_dPTA2(k = 0.065, outMax = 0, outMin = -0.4, initType = Modelica.Blocks.Types.Init.InitialState) annotation (
        Placement(transformation(extent = {{58, -72}, {68, -62}})));
      Modelica.Blocks.Math.Feedback fbdPTA2 annotation (
        Placement(transformation(extent = {{38, -74}, {52, -60}})));
      ...
      Modelica.Blocks.Math.Feedback fbEX701Pt annotation (
        Placement(transformation(extent = {{68, 250}, {76, 258}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX711Pt(k = 1.3604, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{88, 229}, {98, 239}})));
      Modelica.Blocks.Math.Feedback fbEX711Pt annotation (
        Placement(transformation(extent = {{76, 230}, {84, 238}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX721Pt(k = 1.3604, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{88, 213}, {98, 223}})));
      Modelica.Blocks.Math.Feedback fbEX721Pt annotation (
        Placement(transformation(extent = {{76, 214}, {84, 222}})));
      Modelica.Blocks.Continuous.LimIntegrator I_EX731Pt(k = 2.0703, outMax = 0, outMin = -1, initType = Modelica.Blocks.Types.Init.InitialState, y_start = 1) annotation (
        Placement(transformation(extent = {{88, 198}, {98, 208}})));
      ...
      Modelica.Blocks.Logical.Switch switch_thetaTCV701 annotation (
        Placement(transformation(extent = {{60, -180}, {80, -200}})));
      Modelica.Blocks.Sources.TimeTable dTT70X_min(table = [0, (75 - 80)/(80 + 273.15); 1e6, (75 - 80)/(80 + 273.15)]) annotation (
      ...
      Modelica.Blocks.Sources.Constant consthot(k = 0) annotation (
        Placement(transformation(extent = {{22, -129}, {42, -109}})));
      Modelica.Blocks.MathBoolean.And and1(nu = 4) annotation (
        Placement(transformation(extent = {{-126, -243}, {-114, -231}})));
      Modelica.Blocks.MathBoolean.RisingEdge rising1 annotation (
        Placement(transformation(extent = {{-103, -241}, {-95, -233}})));
      Modelica.Blocks.MathBoolean.FallingEdge falling1 annotation (
        Placement(transformation(extent = {{-98, -257}, {-90, -249}})));
      Modelica.Blocks.Logical.Not not5 annotation (
        Placement(transformation(extent = {{-101, -287}, {-81, -267}})));
      Modelica.Blocks.MathBoolean.Or or1(nu = 4) annotation (
        Placement(transformation(extent = {{-130, -325}, {-118, -313}})));
      Modelica.Blocks.MathBoolean.RisingEdge rising2 annotation (
        Placement(transformation(extent = {{-106, -323}, {-98, -315}})));
      Modelica.Blocks.MathBoolean.FallingEdge falling2 annotation (
        Placement(transformation(extent = {{-106, -342}, {-98, -334}})));
      Modelica.Blocks.Logical.Not not6 annotation (
        Placement(transformation(extent = {{-105, -363}, {-85, -343}})));
      Modelica.Blocks.Logical.Switch switch_thetaFCV1 annotation (
        Placement(transformation(extent = {{75, -101}, {95, -121}})));
      Modelica.Blocks.Logical.Switch switch_thetaFCV721 annotation (
        Placement(transformation(extent = {{155, -122}, {175, -142}})));
      Modelica.Blocks.Logical.Switch switch_thetaFCV711 annotation (
        Placement(transformation(extent = {{154, -159}, {174, -179}})));
    equation
      EX701PtSP = if time < 4e3 then 30e3 elseif time < 5e3 then 40e3 else 40e3;
      EX711PtSP = if time < 4e3 then 30e3 elseif time < 5e3 then 35e3 else 35e3;
      EX721PtSP = if time < 4e3 then 30e3 elseif time < 5e3 then 40e3 else 40e3;
      ...
      connect(ddPTA2SP.y, PI_dPTA2.REF) annotation (
        Line(points = {{30.5, -42}, {35, -42}, {35, -45}, {41, -45}}, color = {0, 0, 127}));
      connect(dthetaFCVC01.y, controlSignalBus.dthetaFCVC01) annotation (
        Line(points = {{-110.5, -20}, {8, -20}, {8, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(ddPT100SP.y, PI_dPT100.REF) annotation (
        Line(points = {{30.5, -25}, {40, -25}}, color = {0, 0, 127}));
      connect(processVariableBus.dPT102, PI_dPT100.FeedBack) annotation (
      ...
      connect(processVariableBus.dEX731Pt, PI_dEX731Pt.FeedBack) annotation (
        ...
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(dToutRR01.y, controlSignalBus.dToutRR01) annotation (
        Line(points = {{-110.5, -38}, {13, -38}, {13, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(dthetaFCVR01.y, controlSignalBus.dthetaFCVR01) annotation (
        Line(points = {{-110.5, -58}, {18, -58}, {18, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(fbdPTA2.y, I_dPTA2.u) annotation (
        Line(points = {{51.3, -67}, {57, -67}}, color = {0, 0, 127}));
      connect(processVariableBus.dPTA2, fbdPTA2.u2) annotation (
      ...
      connect(fbEX701Pt.u1, PI_dEX701Pt.REF) annotation (
        Line(points = {{68.8, 254}, {42, 254}, {42, 248}, {49, 248}, {49, 250}, {55, 250}}, color = {0, 0, 127}));
      connect(fbEX711Pt.y, I_EX711Pt.u) annotation (
        Line(points = {{83.6, 234}, {87, 234}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX711Pt, fbEX711Pt.u2) annotation (
        Line(points = {{-240, 0}, {-2, 0}, {-2, 225}, {80, 225}, {80, 230.8}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-3, -6}, {-3, -6}}, horizontalAlignment = TextAlignment.Right));
      connect(fbEX721Pt.y, I_EX721Pt.u) annotation (
        Line(points = {{83.6, 218}, {87, 218}}, color = {0, 0, 127}));
      connect(fbEX721Pt.u1, PI_dEX721Pt.REF) annotation (
        Line(points = {{76.8, 218}, {72, 218}, {72, 224}, {49, 224}, {49, 220}, {55, 220}}, color = {0, 0, 127}));
      connect(processVariableBus.dEX721Pt, fbEX721Pt.u2) annotation (
        Line(points = {{-240, 0}, {2, 0}, {2, 214}, {41, 214}, {41, 214.8}, {80, 214.8}}, color = {255, 204, 51}, thickness = 0.5),
      ...
      connect(dFT101SP_var.y, PI_FT101.REF) annotation (
        Line(points = {{15.5, 152}, {18, 152}, {18, 157}, {37, 157}, {37, 150}, {41, 150}}, color = {0, 0, 127}));
      connect(dTT70X_min.y, greaterEqual_TT701.u1) annotation (
        Line(points = {{-39, -200}, {-30, -200}, {-30, -190}, {-12, -190}}, color = {0, 0, 127}));
      connect(processVariableBus.dTT702, greaterEqual_TT701.u2) annotation (
        Line(points = {{-240, 0}, {-164, 0}, {-164, -176}, {-102, -176}, {-102, -182}, {-12, -182}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(switch_thetaTCV701.y, controlSignalBus.dthetaTCV701) annotation (
        Line(points = {{81, -190}, {128, -190}, {128, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_thetaTCV701.u1, PI_dEX701Pt.controlAction) annotation (
        Line(points = {{58, -198}, {114, -198}, {114, 245}, {76, 245}, {76, 248}, {64.5, 248}}, color = {0, 0, 127}));
      connect(processVariableBus.dTT732, greaterEqual_TT731.u2) annotation (
        Line(points = {{-240, 0}, {-176, 0}, {-176, -288}, {-106, -288}, {-106, -302}, {-12, -302}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(const.y, switch_thetaTCV701.u3) annotation (
        Line(points = {{41, -150}, {48, -150}, {48, -182}, {58, -182}, {58, -182}}, color = {0, 0, 127}));
      connect(processVariableBus.dTT712, greaterEqual_TT711.u2) annotation (
        Line(points = {{-240, 0}, {-168, 0}, {-168, -210}, {-106, -210}, {-106, -222}, {-12, -222}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(processVariableBus.dTT722, greaterEqual_TT721.u2) annotation (
        Line(points = {{-240, 0}, {-172, 0}, {-172, -252}, {-106, -252}, {-106, -262}, {-12, -262}}, color = {255, 204, 51}, thickness = 0.5),
        Text(string = "%first", index = -1, extent = {{-6, 3}, {-6, 3}}, horizontalAlignment = TextAlignment.Right));
      connect(switch_thetaTCV711.y, controlSignalBus.dthetaTCV711) annotation (
        Line(points = {{81, -230}, {136, -230}, {136, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      ...
      connect(PI_dEX721Pt.controlAction, switch_thetaTCV721.u1) annotation (
        Line(points = {{64.5, 218}, {70, 218}, {70, 211}, {118, 211}, {118, -278}, {58, -278}}, color = {0, 0, 127}));
      connect(PI_dEX731Pt.controlAction, switch_thetaTCV731.u1) annotation (
        Line(points = {{64.5, 203}, {70, 203}, {70, 193}, {120, 193}, {120, -318}, {58, -318}}, color = {0, 0, 127}));
      connect(switch_thetaTCV721.y, controlSignalBus.dthetaTCV721) annotation (
        Line(points = {{81, -270}, {145, -270}, {145, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_thetaTCV731.y, controlSignalBus.dthetaTCV731) annotation (
        Line(points = {{81, -310}, {188, -310}, {188, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      ...
      connect(splitRange.Yout2, controlSignalBus.dthetaFCV901) annotation (
        Line(points = {{67, 162}, {195, 162}, {195, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(consthot.y, switch_thetaFCV701.u3) annotation (
        Line(points = {{43, -119}, {51, -119}, {51, -120}, {58, -120}, {58, -139}, {71, -139}}, color = {0, 0, 127}));
      connect(switch_thetaFCV701.u1, PI_TT704.controlAction) annotation (
        Line(points = {{71, -155}, {63, -155}, {63, -82}, {84, -82}, {84, 80}, {55.5, 80}}, color = {0, 0, 127}));
      connect(switch_thetaFCV701.y, controlSignalBus.dthetaFCV701) annotation (
        Line(points = {{94, -147}, {98, -147}, {98, 9}, {240, 9}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(greaterEqual_TT701.y, and1.u[1]) annotation (
        Line(points = {{11, -190}, {14, -190}, {14, -212}, {-135, -212}, {-135, -238.575}, {-126, -238.575}}, color = {255, 0, 255}));
      connect(greaterEqual_TT711.y, and1.u[2]) annotation (
        Line(points = {{11, -230}, {14, -230}, {14, -245}, {-136, -245}, {-136, -237.525}, {-126, -237.525}}, color = {255, 0, 255}));
      connect(greaterEqual_TT721.y, and1.u[3]) annotation (
        Line(points = {{11, -270}, {14, -270}, {14, -292}, {-135, -292}, {-135, -232}, {-126, -232}, {-126, -236.475}}, color = {255, 0, 255}));
      connect(greaterEqual_TT731.y, and1.u[4]) annotation (
        Line(points = {{11, -310}, {14, -310}, {14, -295}, {-132, -295}, {-132, -235.425}, {-126, -235.425}}, color = {255, 0, 255}));
      connect(rising1.u, and1.y) annotation (
        Line(points = {{-104.6, -237}, {-113.1, -237}}, color = {255, 0, 255}));
      connect(falling1.u, and1.y) annotation (
        Line(points = {{-99.6, -253}, {-105, -253}, {-105, -237}, {-113.1, -237}}, color = {255, 0, 255}));
      connect(not5.u, and1.y) annotation (
        Line(points = {{-103, -277}, {-107, -277}, {-107, -276}, {-110, -276}, {-110, -237}, {-113.1, -237}}, color = {255, 0, 255}));
      connect(greaterEqual_TT701.y, or1.u[1]) annotation (
        Line(points = {{11, -190}, {11, -216}, {-151, -216}, {-151, -320.575}, {-130, -320.575}}, color = {255, 0, 255}));
      connect(greaterEqual_TT711.y, or1.u[2]) annotation (
        Line(points = {{11, -230}, {12, -230}, {12, -258}, {-146, -258}, {-146, -319.525}, {-130, -319.525}}, color = {255, 0, 255}));
      connect(greaterEqual_TT721.y, or1.u[3]) annotation (
        Line(points = {{11, -270}, {12, -270}, {12, -297}, {-141, -297}, {-141, -318.475}, {-130, -318.475}}, color = {255, 0, 255}));
      connect(greaterEqual_TT731.y, or1.u[4]) annotation (
        Line(points = {{11, -310}, {12, -310}, {12, -330}, {-139, -330}, {-139, -317.425}, {-130, -317.425}}, color = {255, 0, 255}));
      connect(or1.y, rising2.u) annotation (
        Line(points = {{-117.1, -319}, {-107.6, -319}}, color = {255, 0, 255}));
      connect(falling2.u, rising2.u) annotation (
        Line(points = {{-107.6, -338}, {-114, -338}, {-114, -319}, {-107.6, -319}}, color = {255, 0, 255}));
      connect(not6.u, rising2.u) annotation (
        Line(points = {{-107, -353}, {-111, -353}, {-111, -351}, {-113, -351}, {-113, -338}, {-114, -338}, {-114, -319}, {-107.6, -319}}, color = {255, 0, 255}));
      connect(not5.y, switch_thetaFCV701.u2) annotation (
        Line(points = {{-80, -277}, {-31, -277}, {-31, -161}, {13, -161}, {13, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(switch_thetaTCV701.u2, switch_thetaFCV701.u2) annotation (
        Line(points = {{58, -190}, {50, -190}, {50, -150}, {53, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(switch_thetaFCV1.u3, switch_thetaFCV701.u3) annotation (
        Line(points = {{73, -103}, {57, -103}, {57, -120}, {58, -120}, {58, -139}, {71, -139}}, color = {0, 0, 127}));
      connect(switch_thetaFCV1.u2, switch_thetaFCV701.u2) annotation (
        Line(points = {{73, -111}, {65, -111}, {65, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(switch_thetaFCV1.u1, PI_TT734.controlAction) annotation (
        Line(points = {{73, -119}, {66, -119}, {66, -88}, {71, -88}, {71, -5}, {61, -5}, {61, 10}, {55.5, 10}}, color = {0, 0, 127}));
      connect(switch_thetaFCV1.y, controlSignalBus.dthetaFCV731) annotation (
        Line(points = {{96, -111}, {129, -111}, {129, -110}, {162, -110}, {162, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_thetaTCV731.u2, switch_thetaFCV701.u2) annotation (
        Line(points = {{58, -310}, {44, -310}, {44, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(switch_thetaFCV721.u3, switch_thetaFCV701.u3) annotation (
        Line(points = {{153, -124}, {106, -124}, {106, -127}, {58, -127}, {58, -139}, {71, -139}}, color = {0, 0, 127}));
      connect(switch_thetaFCV721.u2, switch_thetaFCV701.u2) annotation (
        Line(points = {{153, -132}, {65, -132}, {65, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(PI_TT724.controlAction, switch_thetaFCV721.u1) annotation (
        Line(points = {{55.5, 40}, {133, 40}, {133, -140}, {153, -140}}, color = {0, 0, 127}));
      connect(switch_thetaFCV721.y, controlSignalBus.dthetaFCV721) annotation (
        Line(points = {{176, -132}, {180, -132}, {180, -133}, {182, -133}, {182, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_thetaTCV721.u2, switch_thetaFCV701.u2) annotation (
        Line(points = {{58, -270}, {44, -270}, {44, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(switch_thetaTCV711.u2, switch_thetaFCV701.u2) annotation (
        Line(points = {{58, -230}, {51, -230}, {51, -227}, {44, -227}, {44, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(switch_thetaFCV711.u3, switch_thetaFCV701.u3) annotation (
        Line(points = {{152, -161}, {144, -161}, {144, -124}, {106, -124}, {106, -127}, {58, -127}, {58, -139}, {71, -139}}, color = {0, 0, 127}));
      connect(switch_thetaFCV711.u2, switch_thetaFCV701.u2) annotation (
        Line(points = {{152, -169}, {142, -169}, {142, -171}, {130, -171}, {130, -132}, {65, -132}, {65, -147}, {71, -147}}, color = {255, 0, 255}));
      connect(PI_TT714.controlAction, switch_thetaFCV711.u1) annotation (
        Line(points = {{55.5, 60}, {97, 60}, {97, 61}, {138, 61}, {138, -177}, {152, -177}}, color = {0, 0, 127}));
      connect(switch_thetaFCV711.y, controlSignalBus.dthetaFCV711) annotation (
        Line(points = {{175, -169}, {192, -169}, {192, 0}, {240, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      annotation (
        Icon(coordinateSystem(preserveAspectRatio = false), graphics={  Rectangle(lineColor = {175, 175, 175}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid, lineThickness = 1, extent = {{-100, 100}, {100, -100}}, radius = 25), Text(extent = {{-70, 100}, {70, -100}}, textColor = {0, 0, 0}, textStyle = {TextStyle.Bold}, textString = "PID
Control
System")}),
    ...
    equation
      ...
      connect(switch_dthetaFCV901.y, controlSignalBus.dthetaFCV901) annotation (
        ...
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_domegaP101.y, controlSignalBus.domegaP101) annotation (
        Line(points = {{-111.5, 40}, {-110, 40}, {-110, 27}, {25, 27}, {25, -35}, {124, -35}, {124, 0}, {160, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_dthetaFCV101.y, controlSignalBus.dthetaFCV101) annotation (
        Line(points = {{-112.5, 7}, {-110, 7}, {-110, 26}, {24, 26}, {24, -36}, {125, -36}, {125, 0}, {160, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
      connect(switch_dToutGB101.y, controlSignalBus.dToutGB101) annotation (
        Line(points = {{-112.5, -26}, {-110, -26}, {-110, -10}, {-77, -10}, {-77, 25}, {23, 25}, {23, -37}, {127, -37}, {127, 0}, {160, 0}}, color = {0, 0, 127}),
        Text(string = "%second", index = 1, extent = {{6, 3}, {6, 3}}, horizontalAlignment = TextAlignment.Left));
...
System")}),
    ...
    model TestOpenLoopActuator
      extends Modelica.Icons.Example;
      replaceable OpenLoopActuator thermalPlantController annotation (
        Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
    ...
    model TestActuator
      extends Modelica.Icons.Example;
      replaceable ThermalPlantController thermalPlantController annotation (
        Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
    ...
    model TestActuator_IdealWater
      extends TestActuator(centralisedSystemI_B_InitForward(redeclare model WaterHot = DistrictHeatingNetwork.Media.WaterLiquidIdeal, redeclare model WaterCold = DistrictHeatingNetwork.Media.WaterLiquidIdeal));
      annotation (
    ...
    model TestCoolingPlantController
      extends Modelica.Icons.Example;
      replaceable CoolingPlantController coolingPlantController annotation (
        Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
    ...
    model TestFullPlantController
      extends Modelica.Icons.Example;
      replaceable FullPlantController thermalPlantController annotation (
        Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));
      replaceable Export.Linearization.CentralisedSystemGBEB_InitForward centralisedSystemI_B_InitForward(m_flowcool_nom = 0.35, FT901Offset(fixOffset = true, y_Offset_fixed = 7.6222224), FT101Offset(fixOffset = true, y_Offset_fixed = 5.7166667), EX701PtOffset(fixOffset = true, y_Offset_fixed = 50e3), EX711PtOffset(fixOffset = true, y_Offset_fixed = 50e3), EX721PtOffset(fixOffset = true, y_Offset_fixed = 50e3), EX731PtOffset(fixOffset = true, y_Offset_fixed = 50e3), thetaFCVC01Offset(fixInput = false, fixOffset = true), thetaFCVC02Offset(fixInput = false, fixOffset = true), thetaFCVR01Offset(fixInput = false, fixOffset = true), thetaFCV101Offset(fixInput = false, fixOffset = true), thetaFCV401Offset(fixInput = false, fixOffset = true), omegaP401Offset(fixInput = false, fixOffset = true)) annotation (
        Placement(transformation(origin = {-1, 0}, extent = {{11, -38}, {55, 38}})));
    ...
    model TestFullPlantController_B
      extends TestFullPlantController(redeclare FullPlantController_B thermalPlantController(const(k = (kappa - 1)/1), Kp_PtEX701 = Kp_PtEX701, Ti_PtEX701 = Ti_PtEX701, Kp_PtEX711 = Kp_PtEX711, Ti_PtEX711 = Ti_PtEX711, Kp_PtEX721 = Kp_PtEX721, Ti_PtEX721 = Ti_PtEX721, Kp_PtEX731 = Kp_PtEX731, Ti_PtEX731 = Ti_PtEX731), centralisedSystemI_B_InitForward(thetaTCV701Offset(u_start = kappa), thetaTCV711Offset(u_start = kappa), thetaTCV721Offset(u_start = kappa), thetaTCV731Offset(u_start = kappa), TT701Offset(fixOffset = true), TT711Offset(fixOffset = true), TT721Offset(fixOffset = true), TT731Offset(fixOffset = true), RR101_Status(table = {1.5e3}, startValue = false)));
      parameter Real kappa = 0.3;
      parameter Real Kp_PtEX701 = 0.0002508;
      // phi = 60°, omegac = 0.12 rad/s;
      parameter Real Ti_PtEX701 = 0.01;
      parameter Real Kp_PtEX711 = 0.001018;
      // phi = 60°, omega = 0.11 rad/s;
      parameter Real Ti_PtEX711 = 0.01;
      parameter Real Kp_PtEX721 = 0.00039312;
      // phi = 60°, omega = 0.12 rad/s;
      parameter Real Ti_PtEX721 = 0.01;
      parameter Real Kp_PtEX731 = 0.0001;
      // phi = 60°, omega = 0.12 rad/s;
    ...
    model TestFullPlantController_C
      extends TestFullPlantController(redeclare FullPlantController_C thermalPlantController(const(k = (kappa - 1)/1), consthot(k = (kappa_hot - 1)/1), Kp_PtEX701 = Kp_PtEX701, Ti_PtEX701 = Ti_PtEX701, Kp_PtEX711 = Kp_PtEX711, Ti_PtEX711 = Ti_PtEX711, Kp_PtEX721 = Kp_PtEX721, Ti_PtEX721 = Ti_PtEX721, Kp_PtEX731 = Kp_PtEX731, Ti_PtEX731 = Ti_PtEX731), centralisedSystemI_B_InitForward(thetaTCV701Offset(u_start = kappa), thetaTCV711Offset(u_start = kappa), thetaTCV721Offset(u_start = kappa), thetaTCV731Offset(u_start = kappa), TT702Offset(fixOffset = true), TT712Offset(fixOffset = true), TT722Offset(fixOffset = true), TT732Offset(fixOffset = true), thetaFCV701Offset(u_start = kappa_hot), thetaFCV711Offset(u_start = kappa_hot), thetaFCV731Offset(u_start = kappa_hot), thetaFCV721Offset(u_start = kappa_hot), RR101_Status(table = {1.5e3}, startValue = false)));
    ...
    model TestFullPlantController_D
      extends Modelica.Icons.Example;
      replaceable FullPlantController_D thermalPlantController annotation (
        Placement(transformation(origin = {5, 0}, extent = {{-55, -38}, {-11, 38}})));

  ...
  package Systems
    ...
    equation
      ...
      connect(FCV101_theta.y, S100.theta) annotation(
        Line(points = {{-59, 30}, {-40, 30}, {-40, 16}, {-25.6, 16}}, color = {0, 0, 127}));
      connect(P101_omega.y, S100.omega) annotation(
    ...
    equation
      connect(sourceHot_E501.outlet, coolingSingleLoad.inlet) annotation(
        Line(points = {{-16, 52}, {-12, 52}, {-12, 27.2}}, color = {140, 56, 54}, thickness = 0.5));
      connect(sinkHot.inlet, coolingSingleLoad.outlet) annotation(
        Line(points = {{20, 51}, {18, 51}, {18, 52}, {12, 52}, {12, 27.2}}, color = {140, 56, 54}, thickness = 0.5));
  ...
  package Networks
    package Centralised
      ...
      model CentralisedSystemLoadSimplifiedI_D "Gas Boiler, Electric Boiler & Water Tanks"
        extends CentralisedSystemLoadSimplifiedI_B(P901omega = [0, 2*pi*30; 500, 2*pi*30], P101omega = [0, 2*pi*40; 500, 2*pi*40], P401omega = [0, 2*pi*35; 500, 2*pi*35], p_VE901 = 2e5, q_m3h_S9 = 15, EB401_ToutSP = [0, 80 + 273.15; 4000, 80 + 273.15; 4000, 90 + 273.15; 1e6, 90 + 273.15], GB101_ToutSP = [0, 80 + 273.15; 4000, 80 + 273.15; 4000, 90 + 273.15; 1e6, 90 + 273.15], EX701q_m3h_cold = [0, 2.2; 100, 2.2], EX711q_m3h_cold = [0, 2.2; 100, 2.2], EX721q_m3h_cold = [0, 2.2; 100, 2.2], EX731q_m3h_cold = [0, 2.2; 100, 2.2], EX701_Tin_cold = 20 + 273.15, EX711_Tin_cold = 20 + 273.15, EX721_Tin_cold = 20 + 273.15, EX731_Tin_cold = 20 + 273.15, EX701_Tout_cold = 35 + 273.15, EX711_Tout_cold = 35 + 273.15, EX721_Tout_cold = 35 + 273.15, EX731_Tout_cold = 35 + 273.15, FCVC01theta = [0, 0; 1e6, 0], FCVC02theta = [0, 0.5; 1e6, 0.5], VE901(p0 = p_VE901), EB401(tdelay = 30), GB101(tdelay = 20));
        // System S200
        // Unloading
        //   parameter Boolean FV201_state = true;
        //   parameter Boolean FV202_state = true;
      ...
      equation
        ...
        annotation(
          experiment(StopTime = 900000, Tolerance = 1e-05, __Dymola_Algorithm = "Dassl"));
